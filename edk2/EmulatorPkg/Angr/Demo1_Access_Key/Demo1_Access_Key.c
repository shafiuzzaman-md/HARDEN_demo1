  ...
  )
{
  ...
  Status = Demo1GenerateAccessKey(TRUE, masterKey);
  if (EFI_ERROR (Status)) {
...
{
  printf("In Demo1GenerateAccessKey function \n");
  EFI_STATUS Status = EFI_SUCCESS;
  UINTN header=0;
  ...
  printf("The value of Access lock %d\n", accessKeyLock);
  ...
  //   return Status;
  // }
    // (UINT8 *)&AccessKeyPtr->access_key_store = rand();
...
int main(){
  ...
  printf("Checked %d\n", Size);
  masterKey = malloc(sizeof(DEMO1_ACCESS_KEY));
  Demo1GenerateAccessKey(TRUE, masterKey);
  DEMO1_ACCESS_KEY *my_access_key= malloc(Size);
  accessKeyLock = FALSE;
  EFI_STATUS retval = Demo1GenerateAccessKey(TRUE, my_access_key);
  printf("Checked %d\n", retval);
  ...
  DEMO1_ACCESS_KEY *my_access_read_key= malloc(Size);
  retval = Demo1GenerateAccessKey(FALSE, my_access_read_key);
  printf("Checked %d\n", retval);
  printf("The read access key header %u\n",my_access_read_key->access_key_store[1]);
  printf("The read access key body %u\n",my_access_read_key->access_key_store[0]);
  BOOLEAN result;
  //Validate the generated keys
  retval = Demo1ValidateAccessKey(my_access_key, TRUE, &result);
  printf("key1 Is my access key valid? %d\n", retval);
  printf("What's the result %d\n", result);
   retval = Demo1ValidateAccessKey(my_access_key, FALSE, &result);
  printf("key1 Is my access key valid? %d\n", retval);
  printf("What's the result %d\n", result);

  retval = Demo1ValidateAccessKey(my_access_read_key, TRUE, &result);
  printf("key2 Is my access key valid? %d\n", retval);
  printf("What's the result %d\n", result);
   retval = Demo1ValidateAccessKey(my_access_read_key, FALSE, &result);
  printf("key2 Is my access key valid? %d\n", retval);
  printf("What's the result %d\n", result);
  
 DEMO1_ACCESS_KEY *bad_access_key= malloc(Size);
 bad_access_key->access_key_store[0]=my_access_read_key->access_key_store[0];
 bad_access_key->access_key_store[1]=my_access_key->access_key_store[1]; 
 retval = Demo1ValidateAccessKey(bad_access_key, TRUE, &result);
  printf("bad Is my access key valid? %d\n", retval);
  printf("What's the result %d\n", result);
  DEMO1_ACCESS_KEY *another_bad_access_key= malloc(Size);
 another_bad_access_key->access_key_store[0]=rand();
 another_bad_access_key->access_key_store[1]=my_access_key->access_key_store[1]; 
 retval = Demo1ValidateAccessKey(another_bad_access_key, TRUE, &result);
  printf("another bad Is my access key valid? %d\n", retval);
  printf("What's the result %d\n", result);
  return 0; 
}