...
@.str.13 = private unnamed_addr constant [16 x i8] c"data == &bobKey\00", align 1
@.str.14 = private unnamed_addr constant [12 x i8] c"Demo1_Bob.c\00", align 1
@__PRETTY_FUNCTION__.read_through_Demo1BobDataProvider = private unnamed_addr constant [41 x i8] c"void read_through_Demo1BobDataProvider()\00", align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define hidden void @read_through_Demo1BobDataProvider() #0 !dbg !1311 {
  %1 = alloca i64, align 8
  %2 = alloca i64, align 8
  %3 = alloca %struct._DEMO1_ACCESS_KEY*, align 8
  call void @llvm.dbg.declare(metadata i64* %1, metadata !1314, metadata !DIExpression()), !dbg !1315
  %4 = bitcast i64* %1 to i8*, !dbg !1316
  call void @klee_make_symbolic(i8* noundef %4, i64 noundef 8, i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str.12, i64 0, i64 0)), !dbg !1317
  ...
  call void @llvm.dbg.declare(metadata %struct._DEMO1_ACCESS_KEY** %3, metadata !1320, metadata !DIExpression()), !dbg !1321
  %5 = call i8* @malloc(i64 noundef 16), !dbg !1322
  %6 = bitcast i8* %5 to %struct._DEMO1_ACCESS_KEY*, !dbg !1322
  store %struct._DEMO1_ACCESS_KEY* %6, %struct._DEMO1_ACCESS_KEY** %3, align 8, !dbg !1321
  %7 = load i64, i64* %1, align 8, !dbg !1323
  %8 = inttoptr i64 %7 to i8*, !dbg !1325
  %9 = bitcast %struct._DEMO1_ACCESS_KEY** %3 to i8**, !dbg !1326
  %10 = load i64, i64* %2, align 8, !dbg !1327
  %11 = call i64 @Demo1BobDataProvider(%struct._Demo1_Bob_PROTOCOL* noundef null, i8* noundef %8, i8** noundef %9, i64 noundef %10), !dbg !1328
  %12 = icmp ne i64 %11, 0, !dbg !1329
  br i1 %12, label %13, label %20, !dbg !1330

13:                                               ; preds = %0
  %14 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %3, align 8, !dbg !1331
  %15 = icmp eq %struct._DEMO1_ACCESS_KEY* %14, @bobKey, !dbg !1331
  br i1 %15, label %16, label %17, !dbg !1331

16:                                               ; preds = %13
  br label %19, !dbg !1331

17:                                               ; preds = %13
  %18 = call i32 (i8*, i8*, i32, i8*, ...) bitcast (i32 (...)* @__assert_fail to i32 (i8*, i8*, i32, i8*, ...)*)(i8* noundef getelementptr inbounds ([16 x i8], [16 x i8]* @.str.13, i64 0, i64 0), i8* noundef getelementptr inbounds ([12 x i8], [12 x i8]* @.str.14, i64 0, i64 0), i32 noundef 386, i8* noundef getelementptr inbounds ([41 x i8], [41 x i8]* @__PRETTY_FUNCTION__.read_through_Demo1BobDataProvider, i64 0, i64 0)), !dbg !1331
  br label %19, !dbg !1331
...
define hidden i32 @main() #0 !dbg !1335 {
  ...
  call void @read_through_Demo1BobDataProvider(), !dbg !1338
  ret i32 0, !dbg !1339
}

; Function Attrs: noinline nounwind uwtable
define dso_local i8* @memcpy(i8* noundef %0, i8* noundef %1, i64 noundef %2) #5 !dbg !1340 {
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
  %6 = alloca i64, align 8
  %7 = alloca i8*, align 8
  %8 = alloca i8*, align 8
  store i8* %0, i8** %4, align 8
  call void @llvm.dbg.declare(metadata i8** %4, metadata !1344, metadata !DIExpression()), !dbg !1345
  store i8* %1, i8** %5, align 8
  call void @llvm.dbg.declare(metadata i8** %5, metadata !1346, metadata !DIExpression()), !dbg !1347
  store i64 %2, i64* %6, align 8
  call void @llvm.dbg.declare(metadata i64* %6, metadata !1348, metadata !DIExpression()), !dbg !1349
  call void @llvm.dbg.declare(metadata i8** %7, metadata !1350, metadata !DIExpression()), !dbg !1353
  %9 = load i8*, i8** %4, align 8, !dbg !1354
  store i8* %9, i8** %7, align 8, !dbg !1353
  call void @llvm.dbg.declare(metadata i8** %8, metadata !1355, metadata !DIExpression()), !dbg !1358
  %10 = load i8*, i8** %5, align 8, !dbg !1359
  store i8* %10, i8** %8, align 8, !dbg !1358
  br label %11, !dbg !1360

11:                                               ; preds = %15, %3
  %12 = load i64, i64* %6, align 8, !dbg !1361
  %13 = add i64 %12, -1, !dbg !1361
  store i64 %13, i64* %6, align 8, !dbg !1361
  %14 = icmp ugt i64 %12, 0, !dbg !1362
  br i1 %14, label %15, label %21, !dbg !1360

15:                                               ; preds = %11
  %16 = load i8*, i8** %8, align 8, !dbg !1363
  %17 = getelementptr inbounds i8, i8* %16, i32 1, !dbg !1363
  store i8* %17, i8** %8, align 8, !dbg !1363
  %18 = load i8, i8* %16, align 1, !dbg !1364
  %19 = load i8*, i8** %7, align 8, !dbg !1365
  %20 = getelementptr inbounds i8, i8* %19, i32 1, !dbg !1365
  store i8* %20, i8** %7, align 8, !dbg !1365
  store i8 %18, i8* %19, align 1, !dbg !1366
  br label %11, !dbg !1360, !llvm.loop !1367

21:                                               ; preds = %11
  %22 = load i8*, i8** %4, align 8, !dbg !1368
  ret i8* %22, !dbg !1369
}
...
!3 = !DIFile(filename: "Demo1_Bob.c", directory: "/home/hira/Research/HARDEN/repositories/HARDEN_demo1/edk2/EmulatorPkg/Demo1_Bob", checksumkind: CSK_MD5, checksum: "d6d87c0987f30fb61dbb30266eb77c08")
!4 = !{!5, !13, !20, !38, !43, !46}
...
!1311 = distinct !DISubprogram(name: "read_through_Demo1BobDataProvider", scope: !3, file: !3, line: 379, type: !1312, scopeLine: 379, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !714)
...
!1318 = !DILocalVariable(name: "size", scope: !1311, file: !3, line: 382, type: !70)
!1319 = !DILocation(line: 382, column: 11, scope: !1311)
!1320 = !DILocalVariable(name: "data", scope: !1311, file: !3, line: 383, type: !310)
!1321 = !DILocation(line: 383, column: 23, scope: !1311)
!1322 = !DILocation(line: 383, column: 29, scope: !1311)
!1323 = !DILocation(line: 385, column: 43, scope: !1324)
!1324 = distinct !DILexicalBlock(scope: !1311, file: !3, line: 385, column: 8)
!1325 = !DILocation(line: 385, column: 35, scope: !1324)
!1326 = !DILocation(line: 385, column: 52, scope: !1324)
!1327 = !DILocation(line: 385, column: 68, scope: !1324)
!1328 = !DILocation(line: 385, column: 8, scope: !1324)
!1329 = !DILocation(line: 385, column: 74, scope: !1324)
!1330 = !DILocation(line: 385, column: 8, scope: !1311)
!1331 = !DILocation(line: 386, column: 7, scope: !1332)
!1332 = distinct !DILexicalBlock(scope: !1324, file: !3, line: 385, column: 89)
!1333 = !DILocation(line: 387, column: 5, scope: !1332)
!1334 = !DILocation(line: 388, column: 1, scope: !1311)
!1335 = distinct !DISubprogram(name: "main", scope: !3, file: !3, line: 390, type: !1336, scopeLine: 391, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !714)
!1336 = !DISubroutineType(types: !1337)
!1337 = !{!196}
!1338 = !DILocation(line: 392, column: 3, scope: !1335)
!1339 = !DILocation(line: 393, column: 3, scope: !1335)
!1340 = distinct !DISubprogram(name: "memcpy", scope: !1341, file: !1341, line: 12, type: !1342, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !703, retainedNodes: !714)
!1341 = !DIFile(filename: "klee/runtime/Freestanding/memcpy.c", directory: "/home/hira/Research", checksumkind: CSK_MD5, checksum: "8fb9a7164e167db005d7d002570068bc")
!1342 = !DISubroutineType(types: !1343)
!1343 = !{!52, !52, !605, !1275}
!1344 = !DILocalVariable(name: "destaddr", arg: 1, scope: !1340, file: !1341, line: 12, type: !52)
!1345 = !DILocation(line: 12, column: 20, scope: !1340)
!1346 = !DILocalVariable(name: "srcaddr", arg: 2, scope: !1340, file: !1341, line: 12, type: !605)
!1347 = !DILocation(line: 12, column: 42, scope: !1340)
!1348 = !DILocalVariable(name: "len", arg: 3, scope: !1340, file: !1341, line: 12, type: !1275)
!1349 = !DILocation(line: 12, column: 58, scope: !1340)
!1350 = !DILocalVariable(name: "dest", scope: !1340, file: !1341, line: 13, type: !1351)
!1351 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1352, size: 64)
!1352 = !DIBasicType(name: "char", size: 8, encoding: DW_ATE_signed_char)
!1353 = !DILocation(line: 13, column: 9, scope: !1340)
!1354 = !DILocation(line: 13, column: 16, scope: !1340)
!1355 = !DILocalVariable(name: "src", scope: !1340, file: !1341, line: 14, type: !1356)
!1356 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1357, size: 64)
!1357 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1352)
!1358 = !DILocation(line: 14, column: 15, scope: !1340)
!1359 = !DILocation(line: 14, column: 21, scope: !1340)
!1360 = !DILocation(line: 16, column: 3, scope: !1340)
!1361 = !DILocation(line: 16, column: 13, scope: !1340)
!1362 = !DILocation(line: 16, column: 16, scope: !1340)
!1363 = !DILocation(line: 17, column: 19, scope: !1340)
!1364 = !DILocation(line: 17, column: 15, scope: !1340)
!1365 = !DILocation(line: 17, column: 10, scope: !1340)
!1366 = !DILocation(line: 17, column: 13, scope: !1340)
!1367 = distinct !{!1367, !1360, !1363, !851}
!1368 = !DILocation(line: 18, column: 10, scope: !1340)
!1369 = !DILocation(line: 18, column: 3, scope: !1340)
