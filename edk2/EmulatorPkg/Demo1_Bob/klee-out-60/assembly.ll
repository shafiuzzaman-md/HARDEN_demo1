...
define hidden i32 @main() #0 !dbg !1265 {
  ...
  br i1 %13, label %14, label %26, !dbg !1282
...
14:                                               ; preds = %0
  ...
  %21 = getelementptr inbounds %struct._DEMO1_ACCESS_KEY, %struct._DEMO1_ACCESS_KEY* %5, i32 0, i32 0, !dbg !1290
  %22 = getelementptr inbounds [2 x i64], [2 x i64]* %21, i64 0, i64 0, !dbg !1291
  %23 = load i64, i64* %22, align 8, !dbg !1291
  %24 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([27 x i8], [27 x i8]* @.str.13, i64 0, i64 0), i8* noundef %20, i64 noundef %23), !dbg !1292
  %25 = call i32 (i8*, i8*, i32, i8*, ...) bitcast (i32 (...)* @__assert_fail to i32 (i8*, i8*, i32, i8*, ...)*)(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str.14, i64 0, i64 0), i8* noundef getelementptr inbounds ([12 x i8], [12 x i8]* @.str.15, i64 0, i64 0), i32 noundef 383, i8* noundef getelementptr inbounds ([11 x i8], [11 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)), !dbg !1293
...
!3 = !DIFile(filename: "Demo1_Bob.c", directory: "/home/hira/Research/HARDEN/repositories/HARDEN_demo1/edk2/EmulatorPkg/Demo1_Bob", checksumkind: CSK_MD5, checksum: "dd723bdf4c56adad519f684fa5932247")
!4 = !{!5, !13, !20, !38, !43, !46}
...
!1295 = !DILocation(line: 387, column: 3, scope: !1265)
