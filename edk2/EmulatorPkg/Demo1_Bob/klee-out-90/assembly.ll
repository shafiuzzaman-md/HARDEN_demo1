...
@.str.12 = private unnamed_addr constant [16 x i8] c"Read value: %p\0A\00", align 1
@.str.13 = private unnamed_addr constant [22 x i8] c"Rand part bobkey: %x\0A\00", align 1
@.str.14 = private unnamed_addr constant [20 x i8] c"bobkey address: %p\0A\00", align 1
@.str.15 = private unnamed_addr constant [22 x i8] c"key magic bobkey: %x\0A\00", align 1
@.str.16 = private unnamed_addr constant [37 x i8] c"Address where bobkey is written: %p\0A\00", align 1
...
define hidden void @read_bobkey_addr_through_Demo1BobDataProvider() #0 !dbg !1311 {
  ...
  store i64 16, i64* %1, align 8, !dbg !1315
  call void @llvm.dbg.declare(metadata %struct._DEMO1_ACCESS_KEY** %2, metadata !1316, metadata !DIExpression()), !dbg !1317
  call void @llvm.dbg.declare(metadata i8** %3, metadata !1318, metadata !DIExpression()), !dbg !1319
  store i8* bitcast (%struct._DEMO1_ACCESS_KEY* @bobKey to i8*), i8** %3, align 8, !dbg !1319
  %4 = bitcast %struct._DEMO1_ACCESS_KEY** %2 to i8**, !dbg !1320
  %5 = load i64, i64* %1, align 8, !dbg !1322
  %6 = call i64 @Demo1BobDataProvider(%struct._Demo1_Bob_PROTOCOL* noundef null, i8* noundef bitcast (%struct._DEMO1_ACCESS_KEY* @bobKey to i8*), i8** noundef %4, i64 noundef %5), !dbg !1323
  %7 = icmp ne i64 %6, 0, !dbg !1324
  br i1 %7, label %8, label %16, !dbg !1325

8:                                                ; preds = %0
  %9 = bitcast %struct._DEMO1_ACCESS_KEY** %2 to i8*, !dbg !1326
  %10 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([16 x i8], [16 x i8]* @.str.12, i64 0, i64 0), i8* noundef %9), !dbg !1328
  %11 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1329
  %12 = getelementptr inbounds %struct._DEMO1_ACCESS_KEY, %struct._DEMO1_ACCESS_KEY* %11, i32 0, i32 0, !dbg !1330
  %13 = getelementptr inbounds [2 x i64], [2 x i64]* %12, i64 0, i64 0, !dbg !1329
  %14 = load i64, i64* %13, align 8, !dbg !1329
  %15 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str.13, i64 0, i64 0), i64 noundef %14), !dbg !1331
...
; Function Attrs: noinline nounwind optnone uwtable
define hidden i32 @main() #0 !dbg !1334 {
  %1 = alloca i32, align 4
  %2 = alloca %struct._DEMO1_ACCESS_KEY*, align 8
  store i32 0, i32* %1, align 4
  call void @llvm.dbg.declare(metadata %struct._DEMO1_ACCESS_KEY** %2, metadata !1337, metadata !DIExpression()), !dbg !1338
  %3 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([20 x i8], [20 x i8]* @.str.14, i64 0, i64 0), %struct._DEMO1_ACCESS_KEY* noundef @bobKey), !dbg !1339
  store %struct._DEMO1_ACCESS_KEY* @bobKey, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1340
  %4 = call i32 (...) @rand(), !dbg !1341
  %5 = sext i32 %4 to i64, !dbg !1341
  %6 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1342
  %7 = getelementptr inbounds %struct._DEMO1_ACCESS_KEY, %struct._DEMO1_ACCESS_KEY* %6, i32 0, i32 0, !dbg !1343
  %8 = getelementptr inbounds [2 x i64], [2 x i64]* %7, i64 0, i64 0, !dbg !1342
  store i64 %5, i64* %8, align 8, !dbg !1344
  %9 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1345
  %10 = getelementptr inbounds %struct._DEMO1_ACCESS_KEY, %struct._DEMO1_ACCESS_KEY* %9, i32 0, i32 0, !dbg !1346
  %11 = getelementptr inbounds [2 x i64], [2 x i64]* %10, i64 0, i64 1, !dbg !1345
  store i64 -2395670108176482799, i64* %11, align 8, !dbg !1347
  %12 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1348
  %13 = getelementptr inbounds %struct._DEMO1_ACCESS_KEY, %struct._DEMO1_ACCESS_KEY* %12, i32 0, i32 0, !dbg !1349
  %14 = getelementptr inbounds [2 x i64], [2 x i64]* %13, i64 0, i64 0, !dbg !1348
  %15 = load i64, i64* %14, align 8, !dbg !1348
  %16 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str.13, i64 0, i64 0), i64 noundef %15), !dbg !1350
  %17 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1351
  %18 = getelementptr inbounds %struct._DEMO1_ACCESS_KEY, %struct._DEMO1_ACCESS_KEY* %17, i32 0, i32 0, !dbg !1352
  %19 = getelementptr inbounds [2 x i64], [2 x i64]* %18, i64 0, i64 1, !dbg !1351
  %20 = load i64, i64* %19, align 8, !dbg !1351
  %21 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str.15, i64 0, i64 0), i64 noundef %20), !dbg !1353
  %22 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1354
  %23 = bitcast %struct._DEMO1_ACCESS_KEY* %22 to i8*, !dbg !1355
  %24 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([37 x i8], [37 x i8]* @.str.16, i64 0, i64 0), i8* noundef %23), !dbg !1356
  call void @read_bobkey_addr_through_Demo1BobDataProvider(), !dbg !1357
  ret i32 0, !dbg !1358
}
...
define dso_local i8* @memcpy(i8* noundef %0, i8* noundef %1, i64 noundef %2) #4 !dbg !1359 {
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
  %6 = alloca i64, align 8
  %7 = alloca i8*, align 8
  ...
  store i64 %2, i64* %6, align 8
  call void @llvm.dbg.declare(metadata i64* %6, metadata !1367, metadata !DIExpression()), !dbg !1368
  call void @llvm.dbg.declare(metadata i8** %7, metadata !1369, metadata !DIExpression()), !dbg !1372
  %9 = load i8*, i8** %4, align 8, !dbg !1373
  store i8* %9, i8** %7, align 8, !dbg !1372
  call void @llvm.dbg.declare(metadata i8** %8, metadata !1374, metadata !DIExpression()), !dbg !1377
  %10 = load i8*, i8** %5, align 8, !dbg !1378
  store i8* %10, i8** %8, align 8, !dbg !1377
  br label %11, !dbg !1379

11:                                               ; preds = %15, %3
  %12 = load i64, i64* %6, align 8, !dbg !1380
  %13 = add i64 %12, -1, !dbg !1380
  store i64 %13, i64* %6, align 8, !dbg !1380
  %14 = icmp ugt i64 %12, 0, !dbg !1381
  br i1 %14, label %15, label %21, !dbg !1379

15:                                               ; preds = %11
  %16 = load i8*, i8** %8, align 8, !dbg !1382
  %17 = getelementptr inbounds i8, i8* %16, i32 1, !dbg !1382
  store i8* %17, i8** %8, align 8, !dbg !1382
  %18 = load i8, i8* %16, align 1, !dbg !1383
  %19 = load i8*, i8** %7, align 8, !dbg !1384
  %20 = getelementptr inbounds i8, i8* %19, i32 1, !dbg !1384
  store i8* %20, i8** %7, align 8, !dbg !1384
  store i8 %18, i8* %19, align 1, !dbg !1385
  br label %11, !dbg !1379, !llvm.loop !1386

21:                                               ; preds = %11
  %22 = load i8*, i8** %4, align 8, !dbg !1387
  ret i8* %22, !dbg !1388
}
...
!3 = !DIFile(filename: "Demo1_Bob.c", directory: "/home/hira/Research/HARDEN/repositories/HARDEN_demo1/edk2/EmulatorPkg/Demo1_Bob", checksumkind: CSK_MD5, checksum: "e01b3f784b0ddc22c4fb79c0862bf8e2")
!4 = !{!5, !13, !20, !38, !43, !46}
...
!1313 = !{null}
!1314 = !DILocalVariable(name: "size", scope: !1311, file: !3, line: 384, type: !70)
!1315 = !DILocation(line: 384, column: 11, scope: !1311)
!1316 = !DILocalVariable(name: "data", scope: !1311, file: !3, line: 387, type: !310)
!1317 = !DILocation(line: 387, column: 23, scope: !1311)
!1318 = !DILocalVariable(name: "searchValue", scope: !1311, file: !3, line: 389, type: !52)
!1319 = !DILocation(line: 389, column: 11, scope: !1311)
!1320 = !DILocation(line: 391, column: 52, scope: !1321)
!1321 = distinct !DILexicalBlock(scope: !1311, file: !3, line: 391, column: 8)
!1322 = !DILocation(line: 391, column: 68, scope: !1321)
!1323 = !DILocation(line: 391, column: 8, scope: !1321)
!1324 = !DILocation(line: 391, column: 74, scope: !1321)
!1325 = !DILocation(line: 391, column: 8, scope: !1311)
!1326 = !DILocation(line: 392, column: 35, scope: !1327)
!1327 = distinct !DILexicalBlock(scope: !1321, file: !3, line: 391, column: 89)
!1328 = !DILocation(line: 392, column: 8, scope: !1327)
!1329 = !DILocation(line: 393, column: 40, scope: !1327)
!1330 = !DILocation(line: 393, column: 46, scope: !1327)
!1331 = !DILocation(line: 393, column: 7, scope: !1327)
!1332 = !DILocation(line: 396, column: 5, scope: !1327)
!1333 = !DILocation(line: 397, column: 1, scope: !1311)
!1334 = distinct !DISubprogram(name: "main", scope: !3, file: !3, line: 399, type: !1335, scopeLine: 400, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !714)
!1335 = !DISubroutineType(types: !1336)
!1336 = !{!196}
!1337 = !DILocalVariable(name: "AccessKeyPtr", scope: !1334, file: !3, line: 401, type: !310)
!1338 = !DILocation(line: 401, column: 23, scope: !1334)
!1339 = !DILocation(line: 402, column: 3, scope: !1334)
!1340 = !DILocation(line: 403, column: 16, scope: !1334)
!1341 = !DILocation(line: 405, column: 37, scope: !1334)
!1342 = !DILocation(line: 405, column: 3, scope: !1334)
!1343 = !DILocation(line: 405, column: 17, scope: !1334)
!1344 = !DILocation(line: 405, column: 36, scope: !1334)
!1345 = !DILocation(line: 406, column: 3, scope: !1334)
!1346 = !DILocation(line: 406, column: 17, scope: !1334)
!1347 = !DILocation(line: 406, column: 37, scope: !1334)
!1348 = !DILocation(line: 407, column: 36, scope: !1334)
!1349 = !DILocation(line: 407, column: 50, scope: !1334)
!1350 = !DILocation(line: 407, column: 3, scope: !1334)
!1351 = !DILocation(line: 408, column: 36, scope: !1334)
!1352 = !DILocation(line: 408, column: 50, scope: !1334)
!1353 = !DILocation(line: 408, column: 3, scope: !1334)
!1354 = !DILocation(line: 410, column: 59, scope: !1334)
!1355 = !DILocation(line: 410, column: 51, scope: !1334)
!1356 = !DILocation(line: 410, column: 3, scope: !1334)
!1357 = !DILocation(line: 411, column: 3, scope: !1334)
!1358 = !DILocation(line: 412, column: 3, scope: !1334)
!1359 = distinct !DISubprogram(name: "memcpy", scope: !1360, file: !1360, line: 12, type: !1361, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !703, retainedNodes: !714)
!1360 = !DIFile(filename: "klee/runtime/Freestanding/memcpy.c", directory: "/home/hira/Research", checksumkind: CSK_MD5, checksum: "8fb9a7164e167db005d7d002570068bc")
!1361 = !DISubroutineType(types: !1362)
!1362 = !{!52, !52, !605, !1275}
!1363 = !DILocalVariable(name: "destaddr", arg: 1, scope: !1359, file: !1360, line: 12, type: !52)
!1364 = !DILocation(line: 12, column: 20, scope: !1359)
!1365 = !DILocalVariable(name: "srcaddr", arg: 2, scope: !1359, file: !1360, line: 12, type: !605)
!1366 = !DILocation(line: 12, column: 42, scope: !1359)
!1367 = !DILocalVariable(name: "len", arg: 3, scope: !1359, file: !1360, line: 12, type: !1275)
!1368 = !DILocation(line: 12, column: 58, scope: !1359)
!1369 = !DILocalVariable(name: "dest", scope: !1359, file: !1360, line: 13, type: !1370)
!1370 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1371, size: 64)
!1371 = !DIBasicType(name: "char", size: 8, encoding: DW_ATE_signed_char)
!1372 = !DILocation(line: 13, column: 9, scope: !1359)
!1373 = !DILocation(line: 13, column: 16, scope: !1359)
!1374 = !DILocalVariable(name: "src", scope: !1359, file: !1360, line: 14, type: !1375)
!1375 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1376, size: 64)
!1376 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1371)
!1377 = !DILocation(line: 14, column: 15, scope: !1359)
!1378 = !DILocation(line: 14, column: 21, scope: !1359)
!1379 = !DILocation(line: 16, column: 3, scope: !1359)
!1380 = !DILocation(line: 16, column: 13, scope: !1359)
!1381 = !DILocation(line: 16, column: 16, scope: !1359)
!1382 = !DILocation(line: 17, column: 19, scope: !1359)
!1383 = !DILocation(line: 17, column: 15, scope: !1359)
!1384 = !DILocation(line: 17, column: 10, scope: !1359)
!1385 = !DILocation(line: 17, column: 13, scope: !1359)
!1386 = distinct !{!1386, !1379, !1382, !851}
!1387 = !DILocation(line: 18, column: 10, scope: !1359)
!1388 = !DILocation(line: 18, column: 3, scope: !1359)
