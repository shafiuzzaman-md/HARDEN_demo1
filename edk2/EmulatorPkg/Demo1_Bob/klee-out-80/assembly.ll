...
@.str.16 = private unnamed_addr constant [21 x i8] c"Pointer address: %p\0A\00", align 1
@.str.17 = private unnamed_addr constant [22 x i8] c"Value pointed to: %d\0A\00", align 1
...
define hidden i32 @main() #0 !dbg !1338 {
  ...
  %3 = load i64, i64* getelementptr inbounds ({ i64, i64 }, { i64, i64 }* bitcast (%struct._DEMO1_ACCESS_KEY* @bobKey to { i64, i64 }*), i32 0, i32 0), align 8, !dbg !1343
  %4 = load i64, i64* getelementptr inbounds ({ i64, i64 }, { i64, i64 }* bitcast (%struct._DEMO1_ACCESS_KEY* @bobKey to { i64, i64 }*), i32 0, i32 1), align 8, !dbg !1343
  %5 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([20 x i8], [20 x i8]* @.str.15, i64 0, i64 0), i64 %3, i64 %4), !dbg !1343
  store %struct._DEMO1_ACCESS_KEY* @bobKey, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1344
  %6 = call i32 (...) @rand(), !dbg !1345
  %7 = sext i32 %6 to i64, !dbg !1345
  %8 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1346
  %9 = getelementptr inbounds %struct._DEMO1_ACCESS_KEY, %struct._DEMO1_ACCESS_KEY* %8, i32 0, i32 0, !dbg !1347
  %10 = getelementptr inbounds [2 x i64], [2 x i64]* %9, i64 0, i64 0, !dbg !1346
  store i64 %7, i64* %10, align 8, !dbg !1348
  %11 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1349
  %12 = getelementptr inbounds %struct._DEMO1_ACCESS_KEY, %struct._DEMO1_ACCESS_KEY* %11, i32 0, i32 0, !dbg !1350
  %13 = getelementptr inbounds [2 x i64], [2 x i64]* %12, i64 0, i64 1, !dbg !1349
  store i64 -2395670108176482799, i64* %13, align 8, !dbg !1351
  %14 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1352
  %15 = bitcast %struct._DEMO1_ACCESS_KEY* %14 to i8*, !dbg !1353
  %16 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([21 x i8], [21 x i8]* @.str.16, i64 0, i64 0), i8* noundef %15), !dbg !1354
  %17 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1355
  %18 = bitcast %struct._DEMO1_ACCESS_KEY* %17 to { i64, i64 }*, !dbg !1356
  %19 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %18, i32 0, i32 0, !dbg !1356
  %20 = load i64, i64* %19, align 8, !dbg !1356
  %21 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %18, i32 0, i32 1, !dbg !1356
  %22 = load i64, i64* %21, align 8, !dbg !1356
  %23 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str.17, i64 0, i64 0), i64 %20, i64 %22), !dbg !1356
...
define dso_local i8* @memcpy(i8* noundef %0, i8* noundef %1, i64 noundef %2) #5 !dbg !1359 {
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
  %6 = alloca i64, align 8
  %7 = alloca i8*, align 8
  ...
  call void @llvm.dbg.declare(metadata i8** %7, metadata !1369, metadata !DIExpression()), !dbg !1371
  %9 = load i8*, i8** %4, align 8, !dbg !1372
  store i8* %9, i8** %7, align 8, !dbg !1371
  call void @llvm.dbg.declare(metadata i8** %8, metadata !1373, metadata !DIExpression()), !dbg !1376
  %10 = load i8*, i8** %5, align 8, !dbg !1377
  store i8* %10, i8** %8, align 8, !dbg !1376
  br label %11, !dbg !1378

11:                                               ; preds = %15, %3
  %12 = load i64, i64* %6, align 8, !dbg !1379
  %13 = add i64 %12, -1, !dbg !1379
  store i64 %13, i64* %6, align 8, !dbg !1379
  %14 = icmp ugt i64 %12, 0, !dbg !1380
  br i1 %14, label %15, label %21, !dbg !1378

15:                                               ; preds = %11
  %16 = load i8*, i8** %8, align 8, !dbg !1381
  %17 = getelementptr inbounds i8, i8* %16, i32 1, !dbg !1381
  store i8* %17, i8** %8, align 8, !dbg !1381
  %18 = load i8, i8* %16, align 1, !dbg !1382
  %19 = load i8*, i8** %7, align 8, !dbg !1383
  %20 = getelementptr inbounds i8, i8* %19, i32 1, !dbg !1383
  store i8* %20, i8** %7, align 8, !dbg !1383
  store i8 %18, i8* %19, align 1, !dbg !1384
  br label %11, !dbg !1378, !llvm.loop !1385

21:                                               ; preds = %11
  %22 = load i8*, i8** %4, align 8, !dbg !1386
  ret i8* %22, !dbg !1387
}
...
!3 = !DIFile(filename: "Demo1_Bob.c", directory: "/home/hira/Research/HARDEN/repositories/HARDEN_demo1/edk2/EmulatorPkg/Demo1_Bob", checksumkind: CSK_MD5, checksum: "33932262d00e34d3d1e9583d182f5448")
!4 = !{!5, !13, !20, !38, !43, !46}
...
!1352 = !DILocation(line: 404, column: 43, scope: !1338)
!1353 = !DILocation(line: 404, column: 35, scope: !1338)
!1354 = !DILocation(line: 404, column: 3, scope: !1338)
!1355 = !DILocation(line: 405, column: 37, scope: !1338)
!1356 = !DILocation(line: 405, column: 3, scope: !1338)
!1357 = !DILocation(line: 406, column: 3, scope: !1338)
!1358 = !DILocation(line: 407, column: 3, scope: !1338)
...
!1370 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1323, size: 64)
!1371 = !DILocation(line: 13, column: 9, scope: !1359)
!1372 = !DILocation(line: 13, column: 16, scope: !1359)
!1373 = !DILocalVariable(name: "src", scope: !1359, file: !1360, line: 14, type: !1374)
!1374 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1375, size: 64)
!1375 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1323)
!1376 = !DILocation(line: 14, column: 15, scope: !1359)
!1377 = !DILocation(line: 14, column: 21, scope: !1359)
!1378 = !DILocation(line: 16, column: 3, scope: !1359)
!1379 = !DILocation(line: 16, column: 13, scope: !1359)
!1380 = !DILocation(line: 16, column: 16, scope: !1359)
!1381 = !DILocation(line: 17, column: 19, scope: !1359)
!1382 = !DILocation(line: 17, column: 15, scope: !1359)
!1383 = !DILocation(line: 17, column: 10, scope: !1359)
!1384 = !DILocation(line: 17, column: 13, scope: !1359)
!1385 = distinct !{!1385, !1378, !1381, !851}
!1386 = !DILocation(line: 18, column: 10, scope: !1359)
!1387 = !DILocation(line: 18, column: 3, scope: !1359)
