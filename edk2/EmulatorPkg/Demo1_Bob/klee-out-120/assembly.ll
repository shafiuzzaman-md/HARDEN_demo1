...
define hidden void @read_bobkey_addr_through_Demo1BobDataProvider() #0 !dbg !1318 {
  ...
  %11 = icmp ne i64 %10, 0, !dbg !1337
  br i1 %11, label %12, label %15, !dbg !1338

12:                                               ; preds = %0
  %13 = bitcast %struct._DEMO1_ACCESS_KEY** %1 to i8*, !dbg !1339
  %14 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([10 x i8], [10 x i8]* @.str.15, i64 0, i64 0), i8* noundef %13), !dbg !1341
...
!3 = !DIFile(filename: "Demo1_Bob.c", directory: "/home/hira/Research/HARDEN/repositories/HARDEN_demo1/edk2/EmulatorPkg/Demo1_Bob", checksumkind: CSK_MD5, checksum: "66918753ba9fbd46074cafa6d80d1cb6")
!4 = !{!5, !13, !20, !38, !43, !46}
