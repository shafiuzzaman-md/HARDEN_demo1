...
define hidden i32 @main() #0 !dbg !1265 {
  ...
  br i1 %12, label %13, label %20, !dbg !1282
...
13:                                               ; preds = %0
  ...
  %18 = inttoptr i64 %17 to i8*, !dbg !1283
  call void (i8*, ...) @klee_print_expr(i8* noundef %18), !dbg !1286
  %19 = call i32 (i8*, i8*, i32, i8*, ...) bitcast (i32 (...)* @__assert_fail to i32 (i8*, i8*, i32, i8*, ...)*)(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str.13, i64 0, i64 0), i8* noundef getelementptr inbounds ([12 x i8], [12 x i8]* @.str.14, i64 0, i64 0), i32 noundef 378, i8* noundef getelementptr inbounds ([11 x i8], [11 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)), !dbg !1287
...
!3 = !DIFile(filename: "Demo1_Bob.c", directory: "/home/hira/Research/HARDEN/repositories/HARDEN_demo1/edk2/EmulatorPkg/Demo1_Bob", checksumkind: CSK_MD5, checksum: "1456ec666b13ffc94227bcc04dc22426")
!4 = !{!5, !13, !20, !38, !43, !46}
...
!1283 = !DILocation(line: 377, column: 23, scope: !1284)
!1284 = distinct !DILexicalBlock(scope: !1278, file: !3, line: 375, column: 89)
!1285 = !DILocation(line: 377, column: 29, scope: !1284)
