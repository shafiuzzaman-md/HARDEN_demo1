...
define hidden void @read_bobkey_addr_through_Demo1BobDataProvider() #0 !dbg !1314 {
  ...
  %5 = bitcast %struct._DEMO1_ACCESS_KEY** %2 to i8**, !dbg !1325
  %6 = load i64, i64* %1, align 8, !dbg !1326
  %7 = call i64 @Demo1BobDataProvider(%struct._Demo1_Bob_PROTOCOL* noundef null, i8* noundef %4, i8** noundef %5, i64 noundef %6), !dbg !1327
  %8 = icmp ne i64 %7, 0, !dbg !1328
  br i1 %8, label %9, label %18, !dbg !1329

9:                                                ; preds = %0
  %10 = bitcast %struct._DEMO1_ACCESS_KEY** %2 to i8*, !dbg !1330
  %11 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([16 x i8], [16 x i8]* @.str.13, i64 0, i64 0), i8* noundef %10), !dbg !1332
  %12 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1333
  %13 = getelementptr inbounds %struct._DEMO1_ACCESS_KEY, %struct._DEMO1_ACCESS_KEY* %12, i32 0, i32 0, !dbg !1334
  %14 = getelementptr inbounds [2 x i64], [2 x i64]* %13, i64 0, i64 0, !dbg !1333
  %15 = load i64, i64* %14, align 8, !dbg !1333
  %16 = inttoptr i64 %15 to i8*, !dbg !1335
  %17 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str.14, i64 0, i64 0), i8* noundef %16), !dbg !1336
...
; Function Attrs: noinline nounwind optnone uwtable
define hidden i32 @main() #0 !dbg !1339 {
  %1 = alloca i32, align 4
  %2 = alloca %struct._DEMO1_ACCESS_KEY*, align 8
  store i32 0, i32* %1, align 4
  call void @llvm.dbg.declare(metadata %struct._DEMO1_ACCESS_KEY** %2, metadata !1342, metadata !DIExpression()), !dbg !1343
  %3 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([20 x i8], [20 x i8]* @.str.15, i64 0, i64 0), %struct._DEMO1_ACCESS_KEY* noundef @bobKey), !dbg !1344
  store %struct._DEMO1_ACCESS_KEY* @bobKey, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1345
  %4 = call i32 (...) @rand(), !dbg !1346
  %5 = sext i32 %4 to i64, !dbg !1346
  %6 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1347
  %7 = getelementptr inbounds %struct._DEMO1_ACCESS_KEY, %struct._DEMO1_ACCESS_KEY* %6, i32 0, i32 0, !dbg !1348
  %8 = getelementptr inbounds [2 x i64], [2 x i64]* %7, i64 0, i64 0, !dbg !1347
  store i64 %5, i64* %8, align 8, !dbg !1349
  %9 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1350
  %10 = getelementptr inbounds %struct._DEMO1_ACCESS_KEY, %struct._DEMO1_ACCESS_KEY* %9, i32 0, i32 0, !dbg !1351
  %11 = getelementptr inbounds [2 x i64], [2 x i64]* %10, i64 0, i64 1, !dbg !1350
  store i64 -2395670108176482799, i64* %11, align 8, !dbg !1352
  %12 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1353
  %13 = getelementptr inbounds %struct._DEMO1_ACCESS_KEY, %struct._DEMO1_ACCESS_KEY* %12, i32 0, i32 0, !dbg !1354
  %14 = getelementptr inbounds [2 x i64], [2 x i64]* %13, i64 0, i64 0, !dbg !1353
  %15 = load i64, i64* %14, align 8, !dbg !1353
  %16 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str.14, i64 0, i64 0), i64 noundef %15), !dbg !1355
  %17 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1356
  %18 = getelementptr inbounds %struct._DEMO1_ACCESS_KEY, %struct._DEMO1_ACCESS_KEY* %17, i32 0, i32 0, !dbg !1357
  %19 = getelementptr inbounds [2 x i64], [2 x i64]* %18, i64 0, i64 1, !dbg !1356
  %20 = load i64, i64* %19, align 8, !dbg !1356
  %21 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str.16, i64 0, i64 0), i64 noundef %20), !dbg !1358
  %22 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1359
  %23 = bitcast %struct._DEMO1_ACCESS_KEY* %22 to i8*, !dbg !1360
  %24 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([24 x i8], [24 x i8]* @.str.17, i64 0, i64 0), i8* noundef %23), !dbg !1361
  %25 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1362
  %26 = bitcast %struct._DEMO1_ACCESS_KEY* %25 to i8*, !dbg !1363
  %27 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([37 x i8], [37 x i8]* @.str.18, i64 0, i64 0), i8* noundef %26), !dbg !1364
  call void @read_bobkey_addr_through_Demo1BobDataProvider(), !dbg !1365
  ret i32 0, !dbg !1366
}
...
define dso_local i8* @memcpy(i8* noundef %0, i8* noundef %1, i64 noundef %2) #4 !dbg !1367 {
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
  %6 = alloca i64, align 8
  %7 = alloca i8*, align 8
  %8 = alloca i8*, align 8
  store i8* %0, i8** %4, align 8
  call void @llvm.dbg.declare(metadata i8** %4, metadata !1371, metadata !DIExpression()), !dbg !1372
  store i8* %1, i8** %5, align 8
  call void @llvm.dbg.declare(metadata i8** %5, metadata !1373, metadata !DIExpression()), !dbg !1374
  store i64 %2, i64* %6, align 8
  call void @llvm.dbg.declare(metadata i64* %6, metadata !1375, metadata !DIExpression()), !dbg !1376
  call void @llvm.dbg.declare(metadata i8** %7, metadata !1377, metadata !DIExpression()), !dbg !1380
...
!3 = !DIFile(filename: "Demo1_Bob.c", directory: "/home/hira/Research/HARDEN/repositories/HARDEN_demo1/edk2/EmulatorPkg/Demo1_Bob", checksumkind: CSK_MD5, checksum: "cc84ba6f9b2e87b3cb96eb446c0e24cc")
!4 = !{!5, !13, !20, !38, !43, !46}
...
!1326 = !DILocation(line: 392, column: 55, scope: !1324)
!1327 = !DILocation(line: 392, column: 8, scope: !1324)
!1328 = !DILocation(line: 392, column: 61, scope: !1324)
!1329 = !DILocation(line: 392, column: 8, scope: !1314)
!1330 = !DILocation(line: 393, column: 35, scope: !1331)
!1331 = distinct !DILexicalBlock(scope: !1324, file: !3, line: 392, column: 76)
!1332 = !DILocation(line: 393, column: 8, scope: !1331)
!1333 = !DILocation(line: 394, column: 49, scope: !1331)
!1334 = !DILocation(line: 394, column: 55, scope: !1331)
!1335 = !DILocation(line: 394, column: 41, scope: !1331)
!1336 = !DILocation(line: 394, column: 8, scope: !1331)
!1337 = !DILocation(line: 397, column: 5, scope: !1331)
!1338 = !DILocation(line: 398, column: 1, scope: !1314)
!1339 = distinct !DISubprogram(name: "main", scope: !3, file: !3, line: 400, type: !1340, scopeLine: 401, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !714)
!1340 = !DISubroutineType(types: !1341)
!1341 = !{!196}
!1342 = !DILocalVariable(name: "AccessKeyPtr", scope: !1339, file: !3, line: 402, type: !310)
!1343 = !DILocation(line: 402, column: 23, scope: !1339)
!1344 = !DILocation(line: 403, column: 3, scope: !1339)
!1345 = !DILocation(line: 404, column: 16, scope: !1339)
!1346 = !DILocation(line: 406, column: 37, scope: !1339)
!1347 = !DILocation(line: 406, column: 3, scope: !1339)
!1348 = !DILocation(line: 406, column: 17, scope: !1339)
!1349 = !DILocation(line: 406, column: 36, scope: !1339)
!1350 = !DILocation(line: 407, column: 3, scope: !1339)
!1351 = !DILocation(line: 407, column: 17, scope: !1339)
!1352 = !DILocation(line: 407, column: 37, scope: !1339)
!1353 = !DILocation(line: 408, column: 36, scope: !1339)
!1354 = !DILocation(line: 408, column: 50, scope: !1339)
!1355 = !DILocation(line: 408, column: 3, scope: !1339)
!1356 = !DILocation(line: 409, column: 36, scope: !1339)
!1357 = !DILocation(line: 409, column: 50, scope: !1339)
!1358 = !DILocation(line: 409, column: 3, scope: !1339)
!1359 = !DILocation(line: 410, column: 46, scope: !1339)
!1360 = !DILocation(line: 410, column: 38, scope: !1339)
!1361 = !DILocation(line: 410, column: 3, scope: !1339)
!1362 = !DILocation(line: 411, column: 59, scope: !1339)
!1363 = !DILocation(line: 411, column: 51, scope: !1339)
!1364 = !DILocation(line: 411, column: 3, scope: !1339)
!1365 = !DILocation(line: 412, column: 3, scope: !1339)
!1366 = !DILocation(line: 413, column: 3, scope: !1339)
!1367 = distinct !DISubprogram(name: "memcpy", scope: !1368, file: !1368, line: 12, type: !1369, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !703, retainedNodes: !714)
!1368 = !DIFile(filename: "klee/runtime/Freestanding/memcpy.c", directory: "/home/hira/Research", checksumkind: CSK_MD5, checksum: "8fb9a7164e167db005d7d002570068bc")
!1369 = !DISubroutineType(types: !1370)
!1370 = !{!52, !52, !605, !1278}
!1371 = !DILocalVariable(name: "destaddr", arg: 1, scope: !1367, file: !1368, line: 12, type: !52)
!1372 = !DILocation(line: 12, column: 20, scope: !1367)
!1373 = !DILocalVariable(name: "srcaddr", arg: 2, scope: !1367, file: !1368, line: 12, type: !605)
!1374 = !DILocation(line: 12, column: 42, scope: !1367)
!1375 = !DILocalVariable(name: "len", arg: 3, scope: !1367, file: !1368, line: 12, type: !1278)
!1376 = !DILocation(line: 12, column: 58, scope: !1367)
!1377 = !DILocalVariable(name: "dest", scope: !1367, file: !1368, line: 13, type: !1378)
!1378 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1379, size: 64)
!1379 = !DIBasicType(name: "char", size: 8, encoding: DW_ATE_signed_char)
!1380 = !DILocation(line: 13, column: 9, scope: !1367)
!1381 = !DILocation(line: 13, column: 16, scope: !1367)
!1382 = !DILocalVariable(name: "src", scope: !1367, file: !1368, line: 14, type: !1383)
!1383 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1384, size: 64)
!1384 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1379)
!1385 = !DILocation(line: 14, column: 15, scope: !1367)
!1386 = !DILocation(line: 14, column: 21, scope: !1367)
!1387 = !DILocation(line: 16, column: 3, scope: !1367)
!1388 = !DILocation(line: 16, column: 13, scope: !1367)
!1389 = !DILocation(line: 16, column: 16, scope: !1367)
!1390 = !DILocation(line: 17, column: 19, scope: !1367)
!1391 = !DILocation(line: 17, column: 15, scope: !1367)
!1392 = !DILocation(line: 17, column: 10, scope: !1367)
!1393 = !DILocation(line: 17, column: 13, scope: !1367)
!1394 = distinct !{!1394, !1387, !1390, !851}
!1395 = !DILocation(line: 18, column: 10, scope: !1367)
!1396 = !DILocation(line: 18, column: 3, scope: !1367)
