...
define hidden i32 @main() #0 !dbg !1265 {
  ...
  store i8* %5, i8** %4, align 8, !dbg !1273
  %6 = load i8*, i8** %4, align 8, !dbg !1275
  call void @klee_make_symbolic(i8* noundef %6, i64 noundef 16, i8* noundef getelementptr inbounds ([5 x i8], [5 x i8]* @.str.12, i64 0, i64 0)), !dbg !1276
  %7 = load i64, i64* %3, align 8, !dbg !1277
  %8 = call i64 @Demo1BobDataProvider(%struct._Demo1_Bob_PROTOCOL* noundef null, i8* noundef bitcast (%struct._DEMO1_ACCESS_KEY* @bobKey to i8*), i8** noundef %4, i64 noundef %7), !dbg !1279
  %9 = icmp eq i64 %8, 0, !dbg !1280
  br i1 %9, label %10, label %12, !dbg !1281

10:                                               ; preds = %0
  %11 = call i32 (i8*, i8*, i32, i8*, ...) bitcast (i32 (...)* @__assert_fail to i32 (i8*, i8*, i32, i8*, ...)*)(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str.13, i64 0, i64 0), i8* noundef getelementptr inbounds ([12 x i8], [12 x i8]* @.str.14, i64 0, i64 0), i32 noundef 380, i8* noundef getelementptr inbounds ([11 x i8], [11 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)), !dbg !1282
  br label %12, !dbg !1284
...
define dso_local i8* @memcpy(i8* noundef %0, i8* noundef %1, i64 noundef %2) #5 !dbg !1286 {
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
  %6 = alloca i64, align 8
  %7 = alloca i8*, align 8
  ...
  call void @llvm.dbg.declare(metadata i8** %7, metadata !1299, metadata !DIExpression()), !dbg !1302
  %9 = load i8*, i8** %4, align 8, !dbg !1303
  store i8* %9, i8** %7, align 8, !dbg !1302
  call void @llvm.dbg.declare(metadata i8** %8, metadata !1304, metadata !DIExpression()), !dbg !1307
  %10 = load i8*, i8** %5, align 8, !dbg !1308
  store i8* %10, i8** %8, align 8, !dbg !1307
  br label %11, !dbg !1309

11:                                               ; preds = %15, %3
  %12 = load i64, i64* %6, align 8, !dbg !1310
  %13 = add i64 %12, -1, !dbg !1310
  store i64 %13, i64* %6, align 8, !dbg !1310
  %14 = icmp ugt i64 %12, 0, !dbg !1311
  br i1 %14, label %15, label %21, !dbg !1309

15:                                               ; preds = %11
  %16 = load i8*, i8** %8, align 8, !dbg !1312
  %17 = getelementptr inbounds i8, i8* %16, i32 1, !dbg !1312
  store i8* %17, i8** %8, align 8, !dbg !1312
  %18 = load i8, i8* %16, align 1, !dbg !1313
  %19 = load i8*, i8** %7, align 8, !dbg !1314
  %20 = getelementptr inbounds i8, i8* %19, i32 1, !dbg !1314
  store i8* %20, i8** %7, align 8, !dbg !1314
  store i8 %18, i8* %19, align 1, !dbg !1315
  br label %11, !dbg !1309, !llvm.loop !1316

21:                                               ; preds = %11
  %22 = load i8*, i8** %4, align 8, !dbg !1317
  ret i8* %22, !dbg !1318
}
...
!3 = !DIFile(filename: "Demo1_Bob.c", directory: "/home/hira/Research/HARDEN/repositories/HARDEN_demo1/edk2/EmulatorPkg/Demo1_Bob", checksumkind: CSK_MD5, checksum: "21ff8854c12efbad25169d6cd0681301")
!4 = !{!5, !13, !20, !38, !43, !46}
...
!1272 = !DILocalVariable(name: "dest", scope: !1265, file: !3, line: 372, type: !52)
!1273 = !DILocation(line: 372, column: 11, scope: !1265)
!1274 = !DILocation(line: 372, column: 17, scope: !1265)
!1275 = !DILocation(line: 373, column: 24, scope: !1265)
!1276 = !DILocation(line: 373, column: 5, scope: !1265)
!1277 = !DILocation(line: 375, column: 68, scope: !1278)
!1278 = distinct !DILexicalBlock(scope: !1265, file: !3, line: 375, column: 8)
!1279 = !DILocation(line: 375, column: 8, scope: !1278)
!1280 = !DILocation(line: 375, column: 74, scope: !1278)
!1281 = !DILocation(line: 375, column: 8, scope: !1265)
!1282 = !DILocation(line: 380, column: 7, scope: !1283)
!1283 = distinct !DILexicalBlock(scope: !1278, file: !3, line: 375, column: 89)
!1284 = !DILocation(line: 381, column: 5, scope: !1283)
!1285 = !DILocation(line: 384, column: 3, scope: !1265)
!1286 = distinct !DISubprogram(name: "memcpy", scope: !1287, file: !1287, line: 12, type: !1288, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !696, retainedNodes: !707)
!1287 = !DIFile(filename: "klee/runtime/Freestanding/memcpy.c", directory: "/home/hira/Research", checksumkind: CSK_MD5, checksum: "8fb9a7164e167db005d7d002570068bc")
...
!1293 = !DILocalVariable(name: "destaddr", arg: 1, scope: !1286, file: !1287, line: 12, type: !52)
!1294 = !DILocation(line: 12, column: 20, scope: !1286)
!1295 = !DILocalVariable(name: "srcaddr", arg: 2, scope: !1286, file: !1287, line: 12, type: !598)
!1296 = !DILocation(line: 12, column: 42, scope: !1286)
!1297 = !DILocalVariable(name: "len", arg: 3, scope: !1286, file: !1287, line: 12, type: !1290)
!1298 = !DILocation(line: 12, column: 58, scope: !1286)
!1299 = !DILocalVariable(name: "dest", scope: !1286, file: !1287, line: 13, type: !1300)
!1300 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1301, size: 64)
!1301 = !DIBasicType(name: "char", size: 8, encoding: DW_ATE_signed_char)
!1302 = !DILocation(line: 13, column: 9, scope: !1286)
!1303 = !DILocation(line: 13, column: 16, scope: !1286)
!1304 = !DILocalVariable(name: "src", scope: !1286, file: !1287, line: 14, type: !1305)
!1305 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1306, size: 64)
!1306 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1301)
!1307 = !DILocation(line: 14, column: 15, scope: !1286)
!1308 = !DILocation(line: 14, column: 21, scope: !1286)
!1309 = !DILocation(line: 16, column: 3, scope: !1286)
!1310 = !DILocation(line: 16, column: 13, scope: !1286)
!1311 = !DILocation(line: 16, column: 16, scope: !1286)
!1312 = !DILocation(line: 17, column: 19, scope: !1286)
!1313 = !DILocation(line: 17, column: 15, scope: !1286)
!1314 = !DILocation(line: 17, column: 10, scope: !1286)
!1315 = !DILocation(line: 17, column: 13, scope: !1286)
!1316 = distinct !{!1316, !1309, !1312, !844}
!1317 = !DILocation(line: 18, column: 10, scope: !1286)
!1318 = !DILocation(line: 18, column: 3, scope: !1286)
