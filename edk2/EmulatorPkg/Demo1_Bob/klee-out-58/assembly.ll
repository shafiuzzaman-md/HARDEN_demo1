...
define hidden i32 @main() #0 !dbg !1265 {
  ...
  br i1 %13, label %14, label %28, !dbg !1282
...
14:                                               ; preds = %0
  ...
  %20 = bitcast %struct._DEMO1_ACCESS_KEY* %19 to i8*, !dbg !1289
  %21 = bitcast %struct._DEMO1_ACCESS_KEY* %5 to { i64, i64 }*, !dbg !1290
  %22 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %21, i32 0, i32 0, !dbg !1290
  %23 = load i64, i64* %22, align 8, !dbg !1290
  %24 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %21, i32 0, i32 1, !dbg !1290
  %25 = load i64, i64* %24, align 8, !dbg !1290
  %26 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([27 x i8], [27 x i8]* @.str.13, i64 0, i64 0), i8* noundef %20, i64 %23, i64 %25), !dbg !1290
  %27 = call i32 (i8*, i8*, i32, i8*, ...) bitcast (i32 (...)* @__assert_fail to i32 (i8*, i8*, i32, i8*, ...)*)(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str.14, i64 0, i64 0), i8* noundef getelementptr inbounds ([12 x i8], [12 x i8]* @.str.15, i64 0, i64 0), i32 noundef 383, i8* noundef getelementptr inbounds ([11 x i8], [11 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)), !dbg !1291
...
define dso_local i8* @memcpy(i8* noundef %0, i8* noundef %1, i64 noundef %2) #5 !dbg !1294 {
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
  %6 = alloca i64, align 8
  %7 = alloca i8*, align 8
  %8 = alloca i8*, align 8
  store i8* %0, i8** %4, align 8
  call void @llvm.dbg.declare(metadata i8** %4, metadata !1301, metadata !DIExpression()), !dbg !1302
  store i8* %1, i8** %5, align 8
  call void @llvm.dbg.declare(metadata i8** %5, metadata !1303, metadata !DIExpression()), !dbg !1304
  store i64 %2, i64* %6, align 8
  call void @llvm.dbg.declare(metadata i64* %6, metadata !1305, metadata !DIExpression()), !dbg !1306
  call void @llvm.dbg.declare(metadata i8** %7, metadata !1307, metadata !DIExpression()), !dbg !1310
  %9 = load i8*, i8** %4, align 8, !dbg !1311
  store i8* %9, i8** %7, align 8, !dbg !1310
  call void @llvm.dbg.declare(metadata i8** %8, metadata !1312, metadata !DIExpression()), !dbg !1315
  %10 = load i8*, i8** %5, align 8, !dbg !1316
  store i8* %10, i8** %8, align 8, !dbg !1315
  br label %11, !dbg !1317

11:                                               ; preds = %15, %3
  %12 = load i64, i64* %6, align 8, !dbg !1318
  %13 = add i64 %12, -1, !dbg !1318
  store i64 %13, i64* %6, align 8, !dbg !1318
  %14 = icmp ugt i64 %12, 0, !dbg !1319
  br i1 %14, label %15, label %21, !dbg !1317

15:                                               ; preds = %11
  %16 = load i8*, i8** %8, align 8, !dbg !1320
  %17 = getelementptr inbounds i8, i8* %16, i32 1, !dbg !1320
  store i8* %17, i8** %8, align 8, !dbg !1320
  %18 = load i8, i8* %16, align 1, !dbg !1321
  %19 = load i8*, i8** %7, align 8, !dbg !1322
  %20 = getelementptr inbounds i8, i8* %19, i32 1, !dbg !1322
  store i8* %20, i8** %7, align 8, !dbg !1322
  store i8 %18, i8* %19, align 1, !dbg !1323
  br label %11, !dbg !1317, !llvm.loop !1324

21:                                               ; preds = %11
  %22 = load i8*, i8** %4, align 8, !dbg !1325
  ret i8* %22, !dbg !1326
}
...
!3 = !DIFile(filename: "Demo1_Bob.c", directory: "/home/hira/Research/HARDEN/repositories/HARDEN_demo1/edk2/EmulatorPkg/Demo1_Bob", checksumkind: CSK_MD5, checksum: "e8a5f6cebe5e0559332682bb701620a1")
!4 = !{!5, !13, !20, !38, !43, !46}
...
!1290 = !DILocation(line: 379, column: 5, scope: !1284)
!1291 = !DILocation(line: 383, column: 7, scope: !1284)
!1292 = !DILocation(line: 384, column: 5, scope: !1284)
!1293 = !DILocation(line: 387, column: 3, scope: !1265)
!1294 = distinct !DISubprogram(name: "memcpy", scope: !1295, file: !1295, line: 12, type: !1296, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !696, retainedNodes: !707)
!1295 = !DIFile(filename: "klee/runtime/Freestanding/memcpy.c", directory: "/home/hira/Research", checksumkind: CSK_MD5, checksum: "8fb9a7164e167db005d7d002570068bc")
!1296 = !DISubroutineType(types: !1297)
!1297 = !{!52, !52, !598, !1298}
!1298 = !DIDerivedType(tag: DW_TAG_typedef, name: "size_t", file: !1299, line: 46, baseType: !1300)
!1299 = !DIFile(filename: "/usr/lib/llvm-14/lib/clang/14.0.6/include/stddef.h", directory: "", checksumkind: CSK_MD5, checksum: "2499dd2361b915724b073282bea3a7bc")
!1300 = !DIBasicType(name: "unsigned long", size: 64, encoding: DW_ATE_unsigned)
!1301 = !DILocalVariable(name: "destaddr", arg: 1, scope: !1294, file: !1295, line: 12, type: !52)
!1302 = !DILocation(line: 12, column: 20, scope: !1294)
!1303 = !DILocalVariable(name: "srcaddr", arg: 2, scope: !1294, file: !1295, line: 12, type: !598)
!1304 = !DILocation(line: 12, column: 42, scope: !1294)
!1305 = !DILocalVariable(name: "len", arg: 3, scope: !1294, file: !1295, line: 12, type: !1298)
!1306 = !DILocation(line: 12, column: 58, scope: !1294)
!1307 = !DILocalVariable(name: "dest", scope: !1294, file: !1295, line: 13, type: !1308)
!1308 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1309, size: 64)
!1309 = !DIBasicType(name: "char", size: 8, encoding: DW_ATE_signed_char)
!1310 = !DILocation(line: 13, column: 9, scope: !1294)
!1311 = !DILocation(line: 13, column: 16, scope: !1294)
!1312 = !DILocalVariable(name: "src", scope: !1294, file: !1295, line: 14, type: !1313)
!1313 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1314, size: 64)
!1314 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1309)
!1315 = !DILocation(line: 14, column: 15, scope: !1294)
!1316 = !DILocation(line: 14, column: 21, scope: !1294)
!1317 = !DILocation(line: 16, column: 3, scope: !1294)
!1318 = !DILocation(line: 16, column: 13, scope: !1294)
!1319 = !DILocation(line: 16, column: 16, scope: !1294)
!1320 = !DILocation(line: 17, column: 19, scope: !1294)
!1321 = !DILocation(line: 17, column: 15, scope: !1294)
!1322 = !DILocation(line: 17, column: 10, scope: !1294)
!1323 = !DILocation(line: 17, column: 13, scope: !1294)
!1324 = distinct !{!1324, !1317, !1320, !844}
!1325 = !DILocation(line: 18, column: 10, scope: !1294)
!1326 = !DILocation(line: 18, column: 3, scope: !1294)
