...
@.str.13 = private unnamed_addr constant [20 x i8] c"bobkey address: %p\0A\00", align 1
...
define hidden void @read_bobkey_addr_through_Demo1BobDataProvider() #0 !dbg !1311 {
  ...
  br i1 %6, label %7, label %10, !dbg !1327

7:                                                ; preds = %0
  %8 = load i8*, i8** %2, align 8, !dbg !1328
  %9 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([16 x i8], [16 x i8]* @.str.12, i64 0, i64 0), i8* noundef %8), !dbg !1330
  br label %10, !dbg !1331
...
; Function Attrs: noinline nounwind optnone uwtable
define hidden i32 @main() #0 !dbg !1333 {
  %1 = alloca i32, align 4
  %2 = alloca %struct._DEMO1_ACCESS_KEY*, align 8
  store i32 0, i32* %1, align 4
  call void @llvm.dbg.declare(metadata %struct._DEMO1_ACCESS_KEY** %2, metadata !1336, metadata !DIExpression()), !dbg !1337
  %3 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([20 x i8], [20 x i8]* @.str.13, i64 0, i64 0), %struct._DEMO1_ACCESS_KEY* noundef @bobKey), !dbg !1338
  store %struct._DEMO1_ACCESS_KEY* @bobKey, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1339
  %4 = call i32 (...) @rand(), !dbg !1340
  %5 = sext i32 %4 to i64, !dbg !1340
  %6 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1341
  %7 = getelementptr inbounds %struct._DEMO1_ACCESS_KEY, %struct._DEMO1_ACCESS_KEY* %6, i32 0, i32 0, !dbg !1342
  %8 = getelementptr inbounds [2 x i64], [2 x i64]* %7, i64 0, i64 0, !dbg !1341
  store i64 %5, i64* %8, align 8, !dbg !1343
  %9 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1344
  %10 = getelementptr inbounds %struct._DEMO1_ACCESS_KEY, %struct._DEMO1_ACCESS_KEY* %9, i32 0, i32 0, !dbg !1345
  %11 = getelementptr inbounds [2 x i64], [2 x i64]* %10, i64 0, i64 1, !dbg !1344
  store i64 -2395670108176482799, i64* %11, align 8, !dbg !1346
  %12 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1347
  %13 = getelementptr inbounds %struct._DEMO1_ACCESS_KEY, %struct._DEMO1_ACCESS_KEY* %12, i32 0, i32 0, !dbg !1348
  %14 = getelementptr inbounds [2 x i64], [2 x i64]* %13, i64 0, i64 0, !dbg !1347
  %15 = load i64, i64* %14, align 8, !dbg !1347
  %16 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str.14, i64 0, i64 0), i64 noundef %15), !dbg !1349
  %17 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1350
  %18 = getelementptr inbounds %struct._DEMO1_ACCESS_KEY, %struct._DEMO1_ACCESS_KEY* %17, i32 0, i32 0, !dbg !1351
  %19 = getelementptr inbounds [2 x i64], [2 x i64]* %18, i64 0, i64 1, !dbg !1350
  %20 = load i64, i64* %19, align 8, !dbg !1350
  %21 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str.15, i64 0, i64 0), i64 noundef %20), !dbg !1352
  %22 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1353
  %23 = bitcast %struct._DEMO1_ACCESS_KEY* %22 to i8*, !dbg !1354
  %24 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([37 x i8], [37 x i8]* @.str.16, i64 0, i64 0), i8* noundef %23), !dbg !1355
  call void @read_bobkey_addr_through_Demo1BobDataProvider(), !dbg !1356
  ret i32 0, !dbg !1357
}
...
define dso_local i8* @memcpy(i8* noundef %0, i8* noundef %1, i64 noundef %2) #4 !dbg !1358 {
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
  %6 = alloca i64, align 8
  %7 = alloca i8*, align 8
  ...
  call void @llvm.dbg.declare(metadata i8** %7, metadata !1368, metadata !DIExpression()), !dbg !1370
  %9 = load i8*, i8** %4, align 8, !dbg !1371
  store i8* %9, i8** %7, align 8, !dbg !1370
  call void @llvm.dbg.declare(metadata i8** %8, metadata !1372, metadata !DIExpression()), !dbg !1375
  %10 = load i8*, i8** %5, align 8, !dbg !1376
  store i8* %10, i8** %8, align 8, !dbg !1375
  br label %11, !dbg !1377

11:                                               ; preds = %15, %3
  %12 = load i64, i64* %6, align 8, !dbg !1378
  %13 = add i64 %12, -1, !dbg !1378
  store i64 %13, i64* %6, align 8, !dbg !1378
  %14 = icmp ugt i64 %12, 0, !dbg !1379
  br i1 %14, label %15, label %21, !dbg !1377

15:                                               ; preds = %11
  %16 = load i8*, i8** %8, align 8, !dbg !1380
  %17 = getelementptr inbounds i8, i8* %16, i32 1, !dbg !1380
  store i8* %17, i8** %8, align 8, !dbg !1380
  %18 = load i8, i8* %16, align 1, !dbg !1381
  %19 = load i8*, i8** %7, align 8, !dbg !1382
  %20 = getelementptr inbounds i8, i8* %19, i32 1, !dbg !1382
  store i8* %20, i8** %7, align 8, !dbg !1382
  store i8 %18, i8* %19, align 1, !dbg !1383
  br label %11, !dbg !1377, !llvm.loop !1384

21:                                               ; preds = %11
  %22 = load i8*, i8** %4, align 8, !dbg !1385
  ret i8* %22, !dbg !1386
}
...
!3 = !DIFile(filename: "Demo1_Bob.c", directory: "/home/hira/Research/HARDEN/repositories/HARDEN_demo1/edk2/EmulatorPkg/Demo1_Bob", checksumkind: CSK_MD5, checksum: "f7eda0b9dff6361ba650b82b8eca12aa")
!4 = !{!5, !13, !20, !38, !43, !46}
...
!1328 = !DILocation(line: 392, column: 43, scope: !1329)
!1329 = distinct !DILexicalBlock(scope: !1324, file: !3, line: 391, column: 89)
!1330 = !DILocation(line: 392, column: 8, scope: !1329)
!1331 = !DILocation(line: 394, column: 5, scope: !1329)
!1332 = !DILocation(line: 395, column: 1, scope: !1311)
!1333 = distinct !DISubprogram(name: "main", scope: !3, file: !3, line: 397, type: !1334, scopeLine: 398, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !714)
!1334 = !DISubroutineType(types: !1335)
!1335 = !{!196}
!1336 = !DILocalVariable(name: "AccessKeyPtr", scope: !1333, file: !3, line: 399, type: !310)
!1337 = !DILocation(line: 399, column: 23, scope: !1333)
!1338 = !DILocation(line: 400, column: 3, scope: !1333)
!1339 = !DILocation(line: 401, column: 16, scope: !1333)
!1340 = !DILocation(line: 403, column: 37, scope: !1333)
!1341 = !DILocation(line: 403, column: 3, scope: !1333)
!1342 = !DILocation(line: 403, column: 17, scope: !1333)
!1343 = !DILocation(line: 403, column: 36, scope: !1333)
!1344 = !DILocation(line: 404, column: 3, scope: !1333)
!1345 = !DILocation(line: 404, column: 17, scope: !1333)
!1346 = !DILocation(line: 404, column: 37, scope: !1333)
!1347 = !DILocation(line: 405, column: 36, scope: !1333)
!1348 = !DILocation(line: 405, column: 50, scope: !1333)
!1349 = !DILocation(line: 405, column: 3, scope: !1333)
!1350 = !DILocation(line: 406, column: 36, scope: !1333)
!1351 = !DILocation(line: 406, column: 50, scope: !1333)
!1352 = !DILocation(line: 406, column: 3, scope: !1333)
!1353 = !DILocation(line: 408, column: 59, scope: !1333)
!1354 = !DILocation(line: 408, column: 51, scope: !1333)
!1355 = !DILocation(line: 408, column: 3, scope: !1333)
!1356 = !DILocation(line: 409, column: 3, scope: !1333)
!1357 = !DILocation(line: 410, column: 3, scope: !1333)
!1358 = distinct !DISubprogram(name: "memcpy", scope: !1359, file: !1359, line: 12, type: !1360, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !703, retainedNodes: !714)
!1359 = !DIFile(filename: "klee/runtime/Freestanding/memcpy.c", directory: "/home/hira/Research", checksumkind: CSK_MD5, checksum: "8fb9a7164e167db005d7d002570068bc")
!1360 = !DISubroutineType(types: !1361)
!1361 = !{!52, !52, !605, !1275}
!1362 = !DILocalVariable(name: "destaddr", arg: 1, scope: !1358, file: !1359, line: 12, type: !52)
!1363 = !DILocation(line: 12, column: 20, scope: !1358)
!1364 = !DILocalVariable(name: "srcaddr", arg: 2, scope: !1358, file: !1359, line: 12, type: !605)
!1365 = !DILocation(line: 12, column: 42, scope: !1358)
!1366 = !DILocalVariable(name: "len", arg: 3, scope: !1358, file: !1359, line: 12, type: !1275)
!1367 = !DILocation(line: 12, column: 58, scope: !1358)
!1368 = !DILocalVariable(name: "dest", scope: !1358, file: !1359, line: 13, type: !1369)
!1369 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1319, size: 64)
!1370 = !DILocation(line: 13, column: 9, scope: !1358)
!1371 = !DILocation(line: 13, column: 16, scope: !1358)
!1372 = !DILocalVariable(name: "src", scope: !1358, file: !1359, line: 14, type: !1373)
!1373 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1374, size: 64)
!1374 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1319)
!1375 = !DILocation(line: 14, column: 15, scope: !1358)
!1376 = !DILocation(line: 14, column: 21, scope: !1358)
!1377 = !DILocation(line: 16, column: 3, scope: !1358)
!1378 = !DILocation(line: 16, column: 13, scope: !1358)
!1379 = !DILocation(line: 16, column: 16, scope: !1358)
!1380 = !DILocation(line: 17, column: 19, scope: !1358)
!1381 = !DILocation(line: 17, column: 15, scope: !1358)
!1382 = !DILocation(line: 17, column: 10, scope: !1358)
!1383 = !DILocation(line: 17, column: 13, scope: !1358)
!1384 = distinct !{!1384, !1377, !1380, !851}
!1385 = !DILocation(line: 18, column: 10, scope: !1358)
!1386 = !DILocation(line: 18, column: 3, scope: !1358)
