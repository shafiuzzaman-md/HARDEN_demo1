...
@.str.13 = private unnamed_addr constant [27 x i8] c"Content at address %p: %d\0A\00", align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define hidden void @read_bobkey_through_Demo1BobDataProvider() #0 !dbg !1265 {
  %1 = alloca i64*, align 8
  %2 = alloca i64, align 8
  %3 = alloca %struct._DEMO1_ACCESS_KEY*, align 8
  %4 = alloca %struct._DEMO1_ACCESS_KEY, align 8
  call void @llvm.dbg.declare(metadata i64** %1, metadata !1268, metadata !DIExpression()), !dbg !1269
  call void @llvm.dbg.declare(metadata i64* %2, metadata !1270, metadata !DIExpression()), !dbg !1271
  store i64 16, i64* %2, align 8, !dbg !1271
  ...
  store %struct._DEMO1_ACCESS_KEY* %6, %struct._DEMO1_ACCESS_KEY** %3, align 8, !dbg !1273
  %7 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %3, align 8, !dbg !1275
  ...
  %9 = bitcast %struct._DEMO1_ACCESS_KEY** %3 to i8**, !dbg !1277
  %10 = load i64, i64* %2, align 8, !dbg !1279
  ...
  br i1 %12, label %13, label %25, !dbg !1282

13:                                               ; preds = %0
  call void @llvm.dbg.declare(metadata %struct._DEMO1_ACCESS_KEY* %4, metadata !1283, metadata !DIExpression()), !dbg !1285
  %14 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %3, align 8, !dbg !1286
  %15 = bitcast %struct._DEMO1_ACCESS_KEY* %4 to i8*, !dbg !1287
  %16 = bitcast %struct._DEMO1_ACCESS_KEY* %14 to i8*, !dbg !1287
  %17 = call i8* @memcpy(i8* %15, i8* %16, i64 16), !dbg !1287
  %18 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %3, align 8, !dbg !1288
  %19 = bitcast %struct._DEMO1_ACCESS_KEY* %18 to i8*, !dbg !1289
  %20 = getelementptr inbounds %struct._DEMO1_ACCESS_KEY, %struct._DEMO1_ACCESS_KEY* %4, i32 0, i32 0, !dbg !1290
  %21 = getelementptr inbounds [2 x i64], [2 x i64]* %20, i64 0, i64 0, !dbg !1291
  %22 = load i64, i64* %21, align 8, !dbg !1291
  %23 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([27 x i8], [27 x i8]* @.str.13, i64 0, i64 0), i8* noundef %19, i64 noundef %22), !dbg !1292
  %24 = call i32 (i8*, i8*, i32, i8*, ...) bitcast (i32 (...)* @__assert_fail to i32 (i8*, i8*, i32, i8*, ...)*)(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str.14, i64 0, i64 0), i8* noundef getelementptr inbounds ([12 x i8], [12 x i8]* @.str.15, i64 0, i64 0), i32 noundef 383, i8* noundef getelementptr inbounds ([48 x i8], [48 x i8]* @__PRETTY_FUNCTION__.read_bobkey_through_Demo1BobDataProvider, i64 0, i64 0)), !dbg !1293
...
; Function Attrs: noinline nounwind optnone uwtable
define hidden i32 @main() #0 !dbg !1296 {
  %1 = alloca i32, align 4
  store i32 0, i32* %1, align 4
  %2 = load %struct._Demo1_Access_Key_PROTOCOL*, %struct._Demo1_Access_Key_PROTOCOL** @AccessKeyProtocol, align 8, !dbg !1299
  %3 = getelementptr inbounds %struct._Demo1_Access_Key_PROTOCOL, %struct._Demo1_Access_Key_PROTOCOL* %2, i32 0, i32 0, !dbg !1300
  %4 = bitcast {}** %3 to i64 (%struct._Demo1_Access_Key_PROTOCOL*, i8*, i8, %struct._DEMO1_ACCESS_KEY*)**, !dbg !1300
  %5 = load i64 (%struct._Demo1_Access_Key_PROTOCOL*, i8*, i8, %struct._DEMO1_ACCESS_KEY*)*, i64 (%struct._Demo1_Access_Key_PROTOCOL*, i8*, i8, %struct._DEMO1_ACCESS_KEY*)** %4, align 8, !dbg !1300
  %6 = call i64 %5(%struct._Demo1_Access_Key_PROTOCOL* noundef null, i8* noundef null, i8 noundef zeroext 0, %struct._DEMO1_ACCESS_KEY* noundef @bobKey), !dbg !1299
  call void @read_bobkey_through_Demo1BobDataProvider(), !dbg !1301
  ret i32 0, !dbg !1302
}

; Function Attrs: noinline nounwind uwtable
define dso_local i8* @memcpy(i8* noundef %0, i8* noundef %1, i64 noundef %2) #5 !dbg !1303 {
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
  %6 = alloca i64, align 8
  %7 = alloca i8*, align 8
  ...
  call void @llvm.dbg.declare(metadata i8** %5, metadata !1312, metadata !DIExpression()), !dbg !1313
  store i64 %2, i64* %6, align 8
  call void @llvm.dbg.declare(metadata i64* %6, metadata !1314, metadata !DIExpression()), !dbg !1315
  call void @llvm.dbg.declare(metadata i8** %7, metadata !1316, metadata !DIExpression()), !dbg !1319
  %9 = load i8*, i8** %4, align 8, !dbg !1320
  store i8* %9, i8** %7, align 8, !dbg !1319
  call void @llvm.dbg.declare(metadata i8** %8, metadata !1321, metadata !DIExpression()), !dbg !1324
  %10 = load i8*, i8** %5, align 8, !dbg !1325
  store i8* %10, i8** %8, align 8, !dbg !1324
  br label %11, !dbg !1326

11:                                               ; preds = %15, %3
  %12 = load i64, i64* %6, align 8, !dbg !1327
  %13 = add i64 %12, -1, !dbg !1327
  store i64 %13, i64* %6, align 8, !dbg !1327
  %14 = icmp ugt i64 %12, 0, !dbg !1328
  br i1 %14, label %15, label %21, !dbg !1326

15:                                               ; preds = %11
  %16 = load i8*, i8** %8, align 8, !dbg !1329
  %17 = getelementptr inbounds i8, i8* %16, i32 1, !dbg !1329
  store i8* %17, i8** %8, align 8, !dbg !1329
  %18 = load i8, i8* %16, align 1, !dbg !1330
  %19 = load i8*, i8** %7, align 8, !dbg !1331
  %20 = getelementptr inbounds i8, i8* %19, i32 1, !dbg !1331
  store i8* %20, i8** %7, align 8, !dbg !1331
  store i8 %18, i8* %19, align 1, !dbg !1332
  br label %11, !dbg !1326, !llvm.loop !1333

21:                                               ; preds = %11
  %22 = load i8*, i8** %4, align 8, !dbg !1334
  ret i8* %22, !dbg !1335
}
...
!3 = !DIFile(filename: "Demo1_Bob.c", directory: "/home/hira/Research/HARDEN/repositories/HARDEN_demo1/edk2/EmulatorPkg/Demo1_Bob", checksumkind: CSK_MD5, checksum: "064ee2e74faa0959e360e76c9ef024a1")
!4 = !{!5, !13, !20, !38, !43, !46}
...
!1265 = distinct !DISubprogram(name: "read_bobkey_through_Demo1BobDataProvider", scope: !3, file: !3, line: 369, type: !1266, scopeLine: 369, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !707)
...
!1283 = !DILocalVariable(name: "content", scope: !1284, file: !3, line: 377, type: !62)
!1284 = distinct !DILexicalBlock(scope: !1278, file: !3, line: 375, column: 89)
!1285 = !DILocation(line: 377, column: 22, scope: !1284)
!1286 = !DILocation(line: 377, column: 33, scope: !1284)
!1287 = !DILocation(line: 377, column: 32, scope: !1284)
!1288 = !DILocation(line: 379, column: 51, scope: !1284)
!1289 = !DILocation(line: 379, column: 43, scope: !1284)
!1290 = !DILocation(line: 379, column: 65, scope: !1284)
!1291 = !DILocation(line: 379, column: 57, scope: !1284)
!1292 = !DILocation(line: 379, column: 5, scope: !1284)
!1293 = !DILocation(line: 383, column: 7, scope: !1284)
!1294 = !DILocation(line: 384, column: 5, scope: !1284)
!1295 = !DILocation(line: 385, column: 1, scope: !1265)
!1296 = distinct !DISubprogram(name: "main", scope: !3, file: !3, line: 387, type: !1297, scopeLine: 388, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !707)
!1297 = !DISubroutineType(types: !1298)
!1298 = !{!189}
!1299 = !DILocation(line: 390, column: 3, scope: !1296)
!1300 = !DILocation(line: 390, column: 22, scope: !1296)
!1301 = !DILocation(line: 391, column: 3, scope: !1296)
!1302 = !DILocation(line: 392, column: 3, scope: !1296)
!1303 = distinct !DISubprogram(name: "memcpy", scope: !1304, file: !1304, line: 12, type: !1305, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !696, retainedNodes: !707)
!1304 = !DIFile(filename: "klee/runtime/Freestanding/memcpy.c", directory: "/home/hira/Research", checksumkind: CSK_MD5, checksum: "8fb9a7164e167db005d7d002570068bc")
!1305 = !DISubroutineType(types: !1306)
!1306 = !{!52, !52, !598, !1307}
!1307 = !DIDerivedType(tag: DW_TAG_typedef, name: "size_t", file: !1308, line: 46, baseType: !1309)
!1308 = !DIFile(filename: "/usr/lib/llvm-14/lib/clang/14.0.6/include/stddef.h", directory: "", checksumkind: CSK_MD5, checksum: "2499dd2361b915724b073282bea3a7bc")
!1309 = !DIBasicType(name: "unsigned long", size: 64, encoding: DW_ATE_unsigned)
!1310 = !DILocalVariable(name: "destaddr", arg: 1, scope: !1303, file: !1304, line: 12, type: !52)
!1311 = !DILocation(line: 12, column: 20, scope: !1303)
!1312 = !DILocalVariable(name: "srcaddr", arg: 2, scope: !1303, file: !1304, line: 12, type: !598)
!1313 = !DILocation(line: 12, column: 42, scope: !1303)
!1314 = !DILocalVariable(name: "len", arg: 3, scope: !1303, file: !1304, line: 12, type: !1307)
!1315 = !DILocation(line: 12, column: 58, scope: !1303)
!1316 = !DILocalVariable(name: "dest", scope: !1303, file: !1304, line: 13, type: !1317)
!1317 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1318, size: 64)
!1318 = !DIBasicType(name: "char", size: 8, encoding: DW_ATE_signed_char)
!1319 = !DILocation(line: 13, column: 9, scope: !1303)
!1320 = !DILocation(line: 13, column: 16, scope: !1303)
!1321 = !DILocalVariable(name: "src", scope: !1303, file: !1304, line: 14, type: !1322)
!1322 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1323, size: 64)
!1323 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1318)
!1324 = !DILocation(line: 14, column: 15, scope: !1303)
!1325 = !DILocation(line: 14, column: 21, scope: !1303)
!1326 = !DILocation(line: 16, column: 3, scope: !1303)
!1327 = !DILocation(line: 16, column: 13, scope: !1303)
!1328 = !DILocation(line: 16, column: 16, scope: !1303)
!1329 = !DILocation(line: 17, column: 19, scope: !1303)
!1330 = !DILocation(line: 17, column: 15, scope: !1303)
!1331 = !DILocation(line: 17, column: 10, scope: !1303)
!1332 = !DILocation(line: 17, column: 13, scope: !1303)
!1333 = distinct !{!1333, !1326, !1329, !844}
!1334 = !DILocation(line: 18, column: 10, scope: !1303)
!1335 = !DILocation(line: 18, column: 3, scope: !1303)
