...
@.str.11 = private unnamed_addr constant [19 x i8] c"Address value: %x\0A\00", align 1
@.str.12 = private unnamed_addr constant [11 x i8] c"gLoadImage\00", align 1
@.str.13 = private unnamed_addr constant [16 x i8] c"Dest value: %x\0A\00", align 1
@.str.14 = private unnamed_addr constant [16 x i8] c"Read value: %p\0A\00", align 1
@.str.15 = private unnamed_addr constant [22 x i8] c"Rand part bobkey: %x\0A\00", align 1
@.str.16 = private unnamed_addr constant [20 x i8] c"bobkey address: %p\0A\00", align 1
@.str.17 = private unnamed_addr constant [22 x i8] c"key magic bobkey: %x\0A\00", align 1
@.str.18 = private unnamed_addr constant [24 x i8] c"value Accesskeyptr: %x\0A\00", align 1
...
define hidden i64 @Demo1BobDataProvider(%struct._Demo1_Bob_PROTOCOL* noundef %0, i8* noundef %1, i8** noundef %2, i64 noundef %3) #0 !dbg !1036 {
  ...
  %14 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([19 x i8], [19 x i8]* @.str.11, i64 0, i64 0), i8* noundef %13), !dbg !1046
  call void @llvm.dbg.declare(metadata i64* %10, metadata !1047, metadata !DIExpression()), !dbg !1048
  %15 = load i8*, i8** %7, align 8, !dbg !1049
  %16 = ptrtoint i8* %15 to i64, !dbg !1050
  store i64 %16, i64* %10, align 8, !dbg !1048
  %17 = call i8* @malloc(i64 noundef 96), !dbg !1051
  %18 = bitcast i8* %17 to %struct.EFI_LOADED_IMAGE_PROTOCOL*, !dbg !1052
  store %struct.EFI_LOADED_IMAGE_PROTOCOL* %18, %struct.EFI_LOADED_IMAGE_PROTOCOL** @gLoadImage, align 8, !dbg !1053
  %19 = load %struct.EFI_LOADED_IMAGE_PROTOCOL*, %struct.EFI_LOADED_IMAGE_PROTOCOL** @gLoadImage, align 8, !dbg !1054
  %20 = bitcast %struct.EFI_LOADED_IMAGE_PROTOCOL* %19 to i8*, !dbg !1054
  call void @klee_make_symbolic(i8* noundef %20, i64 noundef 96, i8* noundef getelementptr inbounds ([11 x i8], [11 x i8]* @.str.12, i64 0, i64 0)), !dbg !1055
  call void @llvm.dbg.declare(metadata i64* %11, metadata !1056, metadata !DIExpression()), !dbg !1057
  %21 = load %struct.EFI_LOADED_IMAGE_PROTOCOL*, %struct.EFI_LOADED_IMAGE_PROTOCOL** @gLoadImage, align 8, !dbg !1058
  %22 = getelementptr inbounds %struct.EFI_LOADED_IMAGE_PROTOCOL, %struct.EFI_LOADED_IMAGE_PROTOCOL* %21, i32 0, i32 8, !dbg !1059
  %23 = load i8*, i8** %22, align 8, !dbg !1059
  %24 = ptrtoint i8* %23 to i64, !dbg !1060
  store i64 %24, i64* %11, align 8, !dbg !1057
  ...
  %25 = load i8**, i8*** %8, align 8, !dbg !1063
  %26 = icmp eq i8** %25, null, !dbg !1065
  br i1 %26, label %27, label %28, !dbg !1066
...
28:                                               ; preds = %4
  %29 = load i64, i64* %10, align 8, !dbg !1069
  %30 = load i64, i64* %11, align 8, !dbg !1071
  %31 = icmp ult i64 %29, %30, !dbg !1072
  br i1 %31, label %32, label %33, !dbg !1073

32:                                               ; preds = %28
  store i64 -9223372036854775793, i64* %5, align 8, !dbg !1074
  br label %59, !dbg !1074

33:                                               ; preds = %28
  %34 = load i64, i64* %11, align 8, !dbg !1076
  %35 = load %struct.EFI_LOADED_IMAGE_PROTOCOL*, %struct.EFI_LOADED_IMAGE_PROTOCOL** @gLoadImage, align 8, !dbg !1078
  %36 = getelementptr inbounds %struct.EFI_LOADED_IMAGE_PROTOCOL, %struct.EFI_LOADED_IMAGE_PROTOCOL* %35, i32 0, i32 9, !dbg !1079
  %37 = load i64, i64* %36, align 8, !dbg !1079
  %38 = add i64 %34, %37, !dbg !1080
  %39 = load i64, i64* %10, align 8, !dbg !1081
  %40 = load i64, i64* %9, align 8, !dbg !1082
  %41 = add i64 %39, %40, !dbg !1083
  %42 = icmp ult i64 %38, %41, !dbg !1084
  br i1 %42, label %43, label %44, !dbg !1085
...
44:                                               ; preds = %33
  %45 = load i64, i64* %9, align 8, !dbg !1088
  %46 = call i8* @malloc(i64 noundef %45), !dbg !1089
  store i8* %46, i8** %12, align 8, !dbg !1090
  %47 = load i8*, i8** %12, align 8, !dbg !1091
  %48 = icmp eq i8* %47, null, !dbg !1093
  br i1 %48, label %49, label %50, !dbg !1094
...
50:                                               ; preds = %44
  %51 = load i8*, i8** %12, align 8, !dbg !1097
  %52 = load i8*, i8** %7, align 8, !dbg !1098
  %53 = load i64, i64* %9, align 8, !dbg !1099
  %54 = call i8* @memcpy(i8* %51, i8* %52, i64 %53), !dbg !1100
  %55 = load i8*, i8** %12, align 8, !dbg !1101
  %56 = load i8**, i8*** %8, align 8, !dbg !1102
  store i8* %55, i8** %56, align 8, !dbg !1103
  %57 = load i8**, i8*** %8, align 8, !dbg !1104
  %58 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([16 x i8], [16 x i8]* @.str.13, i64 0, i64 0), i8** noundef %57), !dbg !1105
  store i64 0, i64* %5, align 8, !dbg !1106
  br label %59, !dbg !1106

59:                                               ; preds = %50, %49, %43, %32, %27
  %60 = load i64, i64* %5, align 8, !dbg !1107
  ret i64 %60, !dbg !1107
}

; Function Attrs: noinline nounwind optnone uwtable
define hidden i64 @Demo1BobInit(i8* noundef %0, %struct.EFI_SYSTEM_TABLE* noundef %1) #0 !dbg !1108 {
  %3 = alloca i64, align 8
  %4 = alloca i8*, align 8
  %5 = alloca %struct.EFI_SYSTEM_TABLE*, align 8
  %6 = alloca i64, align 8
  ...
  store i8* %0, i8** %4, align 8
  call void @llvm.dbg.declare(metadata i8** %4, metadata !1109, metadata !DIExpression()), !dbg !1110
  store %struct.EFI_SYSTEM_TABLE* %1, %struct.EFI_SYSTEM_TABLE** %5, align 8
  call void @llvm.dbg.declare(metadata %struct.EFI_SYSTEM_TABLE** %5, metadata !1111, metadata !DIExpression()), !dbg !1112
  call void @llvm.dbg.declare(metadata i64* %6, metadata !1113, metadata !DIExpression()), !dbg !1114
  call void @llvm.dbg.declare(metadata i64* %7, metadata !1115, metadata !DIExpression()), !dbg !1116
  call void @llvm.dbg.declare(metadata i64* %8, metadata !1117, metadata !DIExpression()), !dbg !1118
  store i64 8, i64* %8, align 8, !dbg !1118
  %9 = load i64, i64* %6, align 8, !dbg !1119
  %10 = icmp slt i64 %9, 0, !dbg !1119
  br i1 %10, label %14, label %11, !dbg !1121

11:                                               ; preds = %2
  %12 = load %struct._Demo1_Access_Key_PROTOCOL*, %struct._Demo1_Access_Key_PROTOCOL** @AccessKeyProtocol, align 8, !dbg !1122
  %13 = icmp eq %struct._Demo1_Access_Key_PROTOCOL* %12, null, !dbg !1123
  br i1 %13, label %14, label %29, !dbg !1124

14:                                               ; preds = %11, %2
  br label %15, !dbg !1125

15:                                               ; preds = %14
  %16 = call zeroext i8 @DebugPrintEnabled(), !dbg !1127
  %17 = icmp ne i8 %16, 0, !dbg !1127
  br i1 %17, label %18, label %26, !dbg !1130

18:                                               ; preds = %15
  br label %19, !dbg !1131

19:                                               ; preds = %18
  %20 = call zeroext i8 @DebugPrintLevelEnabled(i64 noundef 2147483648), !dbg !1133
  %21 = icmp ne i8 %20, 0, !dbg !1133
  br i1 %21, label %22, label %24, !dbg !1136

22:                                               ; preds = %19
  %23 = load i64, i64* %6, align 8, !dbg !1137
  call void (i64, i8*, ...) @DebugPrint(i64 noundef 2147483648, i8* noundef getelementptr inbounds ([55 x i8], [55 x i8]* @.str.3, i64 0, i64 0), i8* noundef getelementptr inbounds ([13 x i8], [13 x i8]* @__FUNCTION__.Demo1BobInit, i64 0, i64 0), i64 noundef %23), !dbg !1137
  br label %24, !dbg !1137

24:                                               ; preds = %22, %19
  br label %25, !dbg !1136

25:                                               ; preds = %24
  br label %26, !dbg !1131

26:                                               ; preds = %25, %15
  br label %27, !dbg !1130

27:                                               ; preds = %26
  %28 = load i64, i64* %6, align 8, !dbg !1139
  store i64 %28, i64* %3, align 8, !dbg !1140
  br label %146, !dbg !1140

29:                                               ; preds = %11
  %30 = load %struct._Demo1_Access_Key_PROTOCOL*, %struct._Demo1_Access_Key_PROTOCOL** @AccessKeyProtocol, align 8, !dbg !1141
  %31 = getelementptr inbounds %struct._Demo1_Access_Key_PROTOCOL, %struct._Demo1_Access_Key_PROTOCOL* %30, i32 0, i32 0, !dbg !1142
  %32 = bitcast {}** %31 to i64 (%struct._Demo1_Access_Key_PROTOCOL*, i8*, i8, %struct._DEMO1_ACCESS_KEY*)**, !dbg !1142
  %33 = load i64 (%struct._Demo1_Access_Key_PROTOCOL*, i8*, i8, %struct._DEMO1_ACCESS_KEY*)*, i64 (%struct._Demo1_Access_Key_PROTOCOL*, i8*, i8, %struct._DEMO1_ACCESS_KEY*)** %32, align 8, !dbg !1142
  %34 = call i64 %33(%struct._Demo1_Access_Key_PROTOCOL* noundef null, i8* noundef null, i8 noundef zeroext 0, %struct._DEMO1_ACCESS_KEY* noundef @bobKey), !dbg !1141
  store i64 %34, i64* %6, align 8, !dbg !1143
  %35 = load i64, i64* %6, align 8, !dbg !1144
  %36 = icmp slt i64 %35, 0, !dbg !1144
  br i1 %36, label %37, label %52, !dbg !1146

37:                                               ; preds = %29
  br label %38, !dbg !1147

38:                                               ; preds = %37
  %39 = call zeroext i8 @DebugPrintEnabled(), !dbg !1149
  %40 = icmp ne i8 %39, 0, !dbg !1149
  br i1 %40, label %41, label %49, !dbg !1152

41:                                               ; preds = %38
  br label %42, !dbg !1153

42:                                               ; preds = %41
  %43 = call zeroext i8 @DebugPrintLevelEnabled(i64 noundef 2147483648), !dbg !1155
  %44 = icmp ne i8 %43, 0, !dbg !1155
  br i1 %44, label %45, label %47, !dbg !1158

45:                                               ; preds = %42
  %46 = load i64, i64* %6, align 8, !dbg !1159
  call void (i64, i8*, ...) @DebugPrint(i64 noundef 2147483648, i8* noundef getelementptr inbounds ([41 x i8], [41 x i8]* @.str.4, i64 0, i64 0), i8* noundef getelementptr inbounds ([13 x i8], [13 x i8]* @__FUNCTION__.Demo1BobInit, i64 0, i64 0), i64 noundef %46), !dbg !1159
  br label %47, !dbg !1159
...
49:                                               ; preds = %48, %38
  br label %50, !dbg !1152

50:                                               ; preds = %49
  %51 = load i64, i64* %6, align 8, !dbg !1161
  store i64 %51, i64* %3, align 8, !dbg !1162
  br label %146, !dbg !1162

52:                                               ; preds = %29
  %53 = load i64, i64* %6, align 8, !dbg !1163
  %54 = icmp slt i64 %53, 0, !dbg !1163
  br i1 %54, label %58, label %55, !dbg !1165

55:                                               ; preds = %52
  %56 = load %struct._Demo1_Alice_PROTOCOL*, %struct._Demo1_Alice_PROTOCOL** @AliceProtocol, align 8, !dbg !1166
  %57 = icmp eq %struct._Demo1_Alice_PROTOCOL* %56, null, !dbg !1167
  br i1 %57, label %58, label %73, !dbg !1168

58:                                               ; preds = %55, %52
  br label %59, !dbg !1169

59:                                               ; preds = %58
  %60 = call zeroext i8 @DebugPrintEnabled(), !dbg !1171
  %61 = icmp ne i8 %60, 0, !dbg !1171
  br i1 %61, label %62, label %70, !dbg !1174

62:                                               ; preds = %59
  br label %63, !dbg !1175

63:                                               ; preds = %62
  %64 = call zeroext i8 @DebugPrintLevelEnabled(i64 noundef 2147483648), !dbg !1177
  %65 = icmp ne i8 %64, 0, !dbg !1177
  br i1 %65, label %66, label %68, !dbg !1180

66:                                               ; preds = %63
  %67 = load i64, i64* %6, align 8, !dbg !1181
  call void (i64, i8*, ...) @DebugPrint(i64 noundef 2147483648, i8* noundef getelementptr inbounds ([50 x i8], [50 x i8]* @.str.5, i64 0, i64 0), i8* noundef getelementptr inbounds ([13 x i8], [13 x i8]* @__FUNCTION__.Demo1BobInit, i64 0, i64 0), i64 noundef %67), !dbg !1181
  br label %68, !dbg !1181

68:                                               ; preds = %66, %63
  br label %69, !dbg !1180

69:                                               ; preds = %68
  br label %70, !dbg !1175

70:                                               ; preds = %69, %59
  br label %71, !dbg !1174

71:                                               ; preds = %70
  %72 = load i64, i64* %6, align 8, !dbg !1183
  store i64 %72, i64* %3, align 8, !dbg !1184
  br label %146, !dbg !1184

73:                                               ; preds = %55
  %74 = load i64, i64* %6, align 8, !dbg !1185
  %75 = icmp slt i64 %74, 0, !dbg !1185
  br i1 %75, label %76, label %90, !dbg !1187

76:                                               ; preds = %73
  br label %77, !dbg !1188

77:                                               ; preds = %76
  %78 = call zeroext i8 @DebugPrintEnabled(), !dbg !1190
  %79 = icmp ne i8 %78, 0, !dbg !1190
  br i1 %79, label %80, label %87, !dbg !1193

80:                                               ; preds = %77
  br label %81, !dbg !1194

81:                                               ; preds = %80
  %82 = call zeroext i8 @DebugPrintLevelEnabled(i64 noundef 2147483648), !dbg !1196
  %83 = icmp ne i8 %82, 0, !dbg !1196
  br i1 %83, label %84, label %85, !dbg !1199

84:                                               ; preds = %81
  call void (i64, i8*, ...) @DebugPrint(i64 noundef 2147483648, i8* noundef getelementptr inbounds ([48 x i8], [48 x i8]* @.str.6, i64 0, i64 0), i8* noundef getelementptr inbounds ([13 x i8], [13 x i8]* @__FUNCTION__.Demo1BobInit, i64 0, i64 0), i32* noundef getelementptr inbounds ([11 x i32], [11 x i32]* @.str.7, i64 0, i64 0)), !dbg !1200
...
87:                                               ; preds = %86, %77
  br label %88, !dbg !1193

88:                                               ; preds = %87
  %89 = load i64, i64* %6, align 8, !dbg !1202
  store i64 %89, i64* %3, align 8, !dbg !1203
  br label %146, !dbg !1203

90:                                               ; preds = %73
  %91 = load i64, i64* %7, align 8, !dbg !1204
  %92 = icmp eq i64 %91, 2, !dbg !1206
  br i1 %92, label %93, label %106, !dbg !1207

93:                                               ; preds = %90
  br label %94, !dbg !1208

94:                                               ; preds = %93
  %95 = call zeroext i8 @DebugPrintEnabled(), !dbg !1210
  %96 = icmp ne i8 %95, 0, !dbg !1210
  br i1 %96, label %97, label %104, !dbg !1213

97:                                               ; preds = %94
  br label %98, !dbg !1214

98:                                               ; preds = %97
  %99 = call zeroext i8 @DebugPrintLevelEnabled(i64 noundef 2147483648), !dbg !1216
  %100 = icmp ne i8 %99, 0, !dbg !1216
  br i1 %100, label %101, label %102, !dbg !1219

101:                                              ; preds = %98
  call void (i64, i8*, ...) @DebugPrint(i64 noundef 2147483648, i8* noundef getelementptr inbounds ([40 x i8], [40 x i8]* @.str.8, i64 0, i64 0), i8* noundef getelementptr inbounds ([13 x i8], [13 x i8]* @__FUNCTION__.Demo1BobInit, i64 0, i64 0)), !dbg !1220
  br label %102, !dbg !1220

102:                                              ; preds = %101, %98
  br label %103, !dbg !1219

103:                                              ; preds = %102
  br label %104, !dbg !1214

104:                                              ; preds = %103, %94
  br label %105, !dbg !1213

105:                                              ; preds = %104
  store i64 -9223372036854775788, i64* %3, align 8, !dbg !1222
  br label %146, !dbg !1222

106:                                              ; preds = %90
  %107 = load i64, i64* %7, align 8, !dbg !1223
  %108 = icmp ne i64 %107, 1, !dbg !1225
  br i1 %108, label %109, label %122, !dbg !1226

109:                                              ; preds = %106
  br label %110, !dbg !1227

110:                                              ; preds = %109
  %111 = call zeroext i8 @DebugPrintEnabled(), !dbg !1229
  %112 = icmp ne i8 %111, 0, !dbg !1229
  br i1 %112, label %113, label %120, !dbg !1232

113:                                              ; preds = %110
  br label %114, !dbg !1233

114:                                              ; preds = %113
  %115 = call zeroext i8 @DebugPrintLevelEnabled(i64 noundef 2147483648), !dbg !1235
  %116 = icmp ne i8 %115, 0, !dbg !1235
  br i1 %116, label %117, label %118, !dbg !1238

117:                                              ; preds = %114
  call void (i64, i8*, ...) @DebugPrint(i64 noundef 2147483648, i8* noundef getelementptr inbounds ([43 x i8], [43 x i8]* @.str.9, i64 0, i64 0), i8* noundef getelementptr inbounds ([13 x i8], [13 x i8]* @__FUNCTION__.Demo1BobInit, i64 0, i64 0)), !dbg !1239
  br label %118, !dbg !1239

118:                                              ; preds = %117, %114
  br label %119, !dbg !1238

119:                                              ; preds = %118
  br label %120, !dbg !1233

120:                                              ; preds = %119, %110
  br label %121, !dbg !1232

121:                                              ; preds = %120
  store i64 -9223372036854775805, i64* %3, align 8, !dbg !1241
  br label %146, !dbg !1241

122:                                              ; preds = %106
  %123 = load i64, i64* %6, align 8, !dbg !1242
  %124 = icmp slt i64 %123, 0, !dbg !1242
  br i1 %124, label %125, label %140, !dbg !1244

125:                                              ; preds = %122
  br label %126, !dbg !1245

126:                                              ; preds = %125
  %127 = call zeroext i8 @DebugPrintEnabled(), !dbg !1247
  %128 = icmp ne i8 %127, 0, !dbg !1247
  br i1 %128, label %129, label %137, !dbg !1250

129:                                              ; preds = %126
  br label %130, !dbg !1251

130:                                              ; preds = %129
  %131 = call zeroext i8 @DebugPrintLevelEnabled(i64 noundef 2147483648), !dbg !1253
  %132 = icmp ne i8 %131, 0, !dbg !1253
  br i1 %132, label %133, label %135, !dbg !1256

133:                                              ; preds = %130
  %134 = load i64, i64* %6, align 8, !dbg !1257
  call void (i64, i8*, ...) @DebugPrint(i64 noundef 2147483648, i8* noundef getelementptr inbounds ([47 x i8], [47 x i8]* @.str.10, i64 0, i64 0), i8* noundef getelementptr inbounds ([13 x i8], [13 x i8]* @__FUNCTION__.Demo1BobInit, i64 0, i64 0), i64 noundef %134), !dbg !1257
  br label %135, !dbg !1257
...
137:                                              ; preds = %136, %126
  br label %138, !dbg !1250

138:                                              ; preds = %137
  %139 = load i64, i64* %6, align 8, !dbg !1259
  store i64 %139, i64* %3, align 8, !dbg !1260
  br label %146, !dbg !1260

140:                                              ; preds = %122
  %141 = load i64, i64* %6, align 8, !dbg !1261
  %142 = icmp slt i64 %141, 0, !dbg !1261
  br i1 %142, label %143, label %145, !dbg !1263

143:                                              ; preds = %140
  %144 = load i64, i64* %6, align 8, !dbg !1264
  store i64 %144, i64* %3, align 8, !dbg !1266
  br label %146, !dbg !1266

145:                                              ; preds = %140
  store i64 0, i64* %3, align 8, !dbg !1267
  br label %146, !dbg !1267

146:                                              ; preds = %145, %143, %138, %121, %105, %88, %71, %50, %27
  %147 = load i64, i64* %3, align 8, !dbg !1268
  ret i64 %147, !dbg !1268
}
...
; Function Attrs: noinline nounwind optnone uwtable
define hidden i64 @Demo1BobUnload(i8* noundef %0) #0 !dbg !1269 {
  %2 = alloca i8*, align 8
  %3 = alloca i64, align 8
  store i8* %0, i8** %2, align 8
  call void @llvm.dbg.declare(metadata i8** %2, metadata !1270, metadata !DIExpression()), !dbg !1271
  call void @llvm.dbg.declare(metadata i64* %3, metadata !1272, metadata !DIExpression()), !dbg !1273
  store i64 0, i64* %3, align 8, !dbg !1273
  %4 = load i64, i64* %3, align 8, !dbg !1274
  ret i64 %4, !dbg !1275
}

; Function Attrs: noinline nounwind optnone uwtable
define hidden void @CopyMem_c(i8* noundef %0, i8* noundef %1, i64 noundef %2) #0 !dbg !1276 {
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
  %6 = alloca i64, align 8
  %7 = alloca i8*, align 8
  ...
  %9 = alloca i64, align 8
  store i8* %0, i8** %4, align 8
  call void @llvm.dbg.declare(metadata i8** %4, metadata !1282, metadata !DIExpression()), !dbg !1283
  store i8* %1, i8** %5, align 8
  call void @llvm.dbg.declare(metadata i8** %5, metadata !1284, metadata !DIExpression()), !dbg !1285
  store i64 %2, i64* %6, align 8
  call void @llvm.dbg.declare(metadata i64* %6, metadata !1286, metadata !DIExpression()), !dbg !1287
  call void @llvm.dbg.declare(metadata i8** %7, metadata !1288, metadata !DIExpression()), !dbg !1289
  %10 = load i8*, i8** %4, align 8, !dbg !1290
  store i8* %10, i8** %7, align 8, !dbg !1289
  call void @llvm.dbg.declare(metadata i8** %8, metadata !1291, metadata !DIExpression()), !dbg !1292
  %11 = load i8*, i8** %5, align 8, !dbg !1293
  store i8* %11, i8** %8, align 8, !dbg !1292
  call void @llvm.dbg.declare(metadata i64* %9, metadata !1294, metadata !DIExpression()), !dbg !1296
  store i64 0, i64* %9, align 8, !dbg !1296
  br label %12, !dbg !1297

12:                                               ; preds = %24, %3
  %13 = load i64, i64* %9, align 8, !dbg !1298
  %14 = load i64, i64* %6, align 8, !dbg !1300
  %15 = icmp ult i64 %13, %14, !dbg !1301
  br i1 %15, label %16, label %27, !dbg !1302

16:                                               ; preds = %12
  %17 = load i8*, i8** %8, align 8, !dbg !1303
  %18 = load i64, i64* %9, align 8, !dbg !1305
  %19 = getelementptr inbounds i8, i8* %17, i64 %18, !dbg !1303
  %20 = load i8, i8* %19, align 1, !dbg !1303
  %21 = load i8*, i8** %7, align 8, !dbg !1306
  %22 = load i64, i64* %9, align 8, !dbg !1307
  %23 = getelementptr inbounds i8, i8* %21, i64 %22, !dbg !1306
  store i8 %20, i8* %23, align 1, !dbg !1308
  br label %24, !dbg !1309

24:                                               ; preds = %16
  %25 = load i64, i64* %9, align 8, !dbg !1310
  %26 = add i64 %25, 1, !dbg !1310
  store i64 %26, i64* %9, align 8, !dbg !1310
  br label %12, !dbg !1311, !llvm.loop !1312
...
; Function Attrs: noinline nounwind optnone uwtable
define hidden void @read_bobkey_addr_through_Demo1BobDataProvider() #0 !dbg !1315 {
  %1 = alloca i64, align 8
  %2 = alloca %struct._DEMO1_ACCESS_KEY*, align 8
  %3 = alloca i8*, align 8
  %4 = alloca i8, align 1
  call void @llvm.dbg.declare(metadata i64* %1, metadata !1318, metadata !DIExpression()), !dbg !1319
  store i64 16, i64* %1, align 8, !dbg !1319
  call void @llvm.dbg.declare(metadata %struct._DEMO1_ACCESS_KEY** %2, metadata !1320, metadata !DIExpression()), !dbg !1321
  call void @llvm.dbg.declare(metadata i8** %3, metadata !1322, metadata !DIExpression()), !dbg !1323
  store i8* bitcast (%struct._DEMO1_ACCESS_KEY* @bobKey to i8*), i8** %3, align 8, !dbg !1323
  call void @llvm.dbg.declare(metadata i8* %4, metadata !1324, metadata !DIExpression()), !dbg !1327
  %5 = load i8*, i8** %3, align 8, !dbg !1328
  %6 = bitcast %struct._DEMO1_ACCESS_KEY** %2 to i8**, !dbg !1330
  %7 = load i64, i64* %1, align 8, !dbg !1331
  %8 = call i64 @Demo1BobDataProvider(%struct._Demo1_Bob_PROTOCOL* noundef null, i8* noundef %5, i8** noundef %6, i64 noundef %7), !dbg !1332
  %9 = icmp ne i64 %8, 0, !dbg !1333
  br i1 %9, label %10, label %22, !dbg !1334

10:                                               ; preds = %0
  %11 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1335
  %12 = getelementptr inbounds %struct._DEMO1_ACCESS_KEY, %struct._DEMO1_ACCESS_KEY* %11, i32 0, i32 0, !dbg !1337
  %13 = getelementptr inbounds [2 x i64], [2 x i64]* %12, i64 0, i64 0, !dbg !1335
  %14 = load i64, i64* %13, align 8, !dbg !1335
  %15 = inttoptr i64 %14 to i8*, !dbg !1338
  %16 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([16 x i8], [16 x i8]* @.str.14, i64 0, i64 0), i8* noundef %15), !dbg !1339
  %17 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1340
  %18 = getelementptr inbounds %struct._DEMO1_ACCESS_KEY, %struct._DEMO1_ACCESS_KEY* %17, i32 0, i32 0, !dbg !1341
  %19 = getelementptr inbounds [2 x i64], [2 x i64]* %18, i64 0, i64 0, !dbg !1340
  %20 = load i64, i64* %19, align 8, !dbg !1340
  %21 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str.15, i64 0, i64 0), i64 noundef %20), !dbg !1342
  br label %22, !dbg !1343
...
; Function Attrs: noinline nounwind optnone uwtable
define hidden i32 @main() #0 !dbg !1345 {
  %1 = alloca i32, align 4
  %2 = alloca %struct._DEMO1_ACCESS_KEY*, align 8
  store i32 0, i32* %1, align 4
  call void @llvm.dbg.declare(metadata %struct._DEMO1_ACCESS_KEY** %2, metadata !1348, metadata !DIExpression()), !dbg !1349
  %3 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([20 x i8], [20 x i8]* @.str.16, i64 0, i64 0), %struct._DEMO1_ACCESS_KEY* noundef @bobKey), !dbg !1350
  store %struct._DEMO1_ACCESS_KEY* @bobKey, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1351
  %4 = call i32 (...) @rand(), !dbg !1352
  %5 = sext i32 %4 to i64, !dbg !1352
  %6 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1353
  %7 = getelementptr inbounds %struct._DEMO1_ACCESS_KEY, %struct._DEMO1_ACCESS_KEY* %6, i32 0, i32 0, !dbg !1354
  %8 = getelementptr inbounds [2 x i64], [2 x i64]* %7, i64 0, i64 0, !dbg !1353
  store i64 %5, i64* %8, align 8, !dbg !1355
  %9 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1356
  %10 = getelementptr inbounds %struct._DEMO1_ACCESS_KEY, %struct._DEMO1_ACCESS_KEY* %9, i32 0, i32 0, !dbg !1357
  %11 = getelementptr inbounds [2 x i64], [2 x i64]* %10, i64 0, i64 1, !dbg !1356
  store i64 -2395670108176482799, i64* %11, align 8, !dbg !1358
  %12 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1359
  %13 = getelementptr inbounds %struct._DEMO1_ACCESS_KEY, %struct._DEMO1_ACCESS_KEY* %12, i32 0, i32 0, !dbg !1360
  %14 = getelementptr inbounds [2 x i64], [2 x i64]* %13, i64 0, i64 0, !dbg !1359
  %15 = load i64, i64* %14, align 8, !dbg !1359
  %16 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str.15, i64 0, i64 0), i64 noundef %15), !dbg !1361
  %17 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1362
  %18 = getelementptr inbounds %struct._DEMO1_ACCESS_KEY, %struct._DEMO1_ACCESS_KEY* %17, i32 0, i32 0, !dbg !1363
  %19 = getelementptr inbounds [2 x i64], [2 x i64]* %18, i64 0, i64 1, !dbg !1362
  %20 = load i64, i64* %19, align 8, !dbg !1362
  %21 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str.17, i64 0, i64 0), i64 noundef %20), !dbg !1364
  %22 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1365
  %23 = bitcast %struct._DEMO1_ACCESS_KEY* %22 to i8*, !dbg !1366
  %24 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([24 x i8], [24 x i8]* @.str.18, i64 0, i64 0), i8* noundef %23), !dbg !1367
  %25 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1368
  %26 = bitcast %struct._DEMO1_ACCESS_KEY* %25 to i8*, !dbg !1369
  %27 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([37 x i8], [37 x i8]* @.str.19, i64 0, i64 0), i8* noundef %26), !dbg !1370
  call void @read_bobkey_addr_through_Demo1BobDataProvider(), !dbg !1371
  ret i32 0, !dbg !1372
}
...
define dso_local i8* @memcpy(i8* noundef %0, i8* noundef %1, i64 noundef %2) #4 !dbg !1373 {
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
  %6 = alloca i64, align 8
  %7 = alloca i8*, align 8
  %8 = alloca i8*, align 8
  store i8* %0, i8** %4, align 8
  call void @llvm.dbg.declare(metadata i8** %4, metadata !1377, metadata !DIExpression()), !dbg !1378
  store i8* %1, i8** %5, align 8
  call void @llvm.dbg.declare(metadata i8** %5, metadata !1379, metadata !DIExpression()), !dbg !1380
  store i64 %2, i64* %6, align 8
  call void @llvm.dbg.declare(metadata i64* %6, metadata !1381, metadata !DIExpression()), !dbg !1382
  call void @llvm.dbg.declare(metadata i8** %7, metadata !1383, metadata !DIExpression()), !dbg !1385
  %9 = load i8*, i8** %4, align 8, !dbg !1386
  store i8* %9, i8** %7, align 8, !dbg !1385
  call void @llvm.dbg.declare(metadata i8** %8, metadata !1387, metadata !DIExpression()), !dbg !1390
  %10 = load i8*, i8** %5, align 8, !dbg !1391
  store i8* %10, i8** %8, align 8, !dbg !1390
  br label %11, !dbg !1392

11:                                               ; preds = %15, %3
  %12 = load i64, i64* %6, align 8, !dbg !1393
  %13 = add i64 %12, -1, !dbg !1393
  store i64 %13, i64* %6, align 8, !dbg !1393
  %14 = icmp ugt i64 %12, 0, !dbg !1394
  br i1 %14, label %15, label %21, !dbg !1392

15:                                               ; preds = %11
  %16 = load i8*, i8** %8, align 8, !dbg !1395
  %17 = getelementptr inbounds i8, i8* %16, i32 1, !dbg !1395
  store i8* %17, i8** %8, align 8, !dbg !1395
  %18 = load i8, i8* %16, align 1, !dbg !1396
  %19 = load i8*, i8** %7, align 8, !dbg !1397
  %20 = getelementptr inbounds i8, i8* %19, i32 1, !dbg !1397
  store i8* %20, i8** %7, align 8, !dbg !1397
  store i8 %18, i8* %19, align 1, !dbg !1398
  br label %11, !dbg !1392, !llvm.loop !1399

21:                                               ; preds = %11
  %22 = load i8*, i8** %4, align 8, !dbg !1400
  ret i8* %22, !dbg !1401
}
...
!3 = !DIFile(filename: "Demo1_Bob.c", directory: "/home/hira/Research/HARDEN/repositories/HARDEN_demo1/edk2/EmulatorPkg/Demo1_Bob", checksumkind: CSK_MD5, checksum: "ffd23202bc7903e70d03149fcf8a342d")
!4 = !{!5, !13, !20, !38, !43, !46}
...
!1045 = !DILocation(line: 342, column: 34, scope: !1036)
!1046 = !DILocation(line: 342, column: 4, scope: !1036)
!1047 = !DILocalVariable(name: "IAddress", scope: !1036, file: !3, line: 344, type: !70)
!1048 = !DILocation(line: 344, column: 9, scope: !1036)
!1049 = !DILocation(line: 344, column: 27, scope: !1036)
!1050 = !DILocation(line: 344, column: 20, scope: !1036)
!1051 = !DILocation(line: 346, column: 44, scope: !1036)
!1052 = !DILocation(line: 346, column: 16, scope: !1036)
!1053 = !DILocation(line: 346, column: 14, scope: !1036)
!1054 = !DILocation(line: 347, column: 22, scope: !1036)
!1055 = !DILocation(line: 347, column: 3, scope: !1036)
!1056 = !DILocalVariable(name: "IBase", scope: !1036, file: !3, line: 349, type: !70)
!1057 = !DILocation(line: 349, column: 9, scope: !1036)
!1058 = !DILocation(line: 349, column: 24, scope: !1036)
!1059 = !DILocation(line: 349, column: 36, scope: !1036)
!1060 = !DILocation(line: 349, column: 17, scope: !1036)
!1061 = !DILocalVariable(name: "Storage", scope: !1036, file: !3, line: 350, type: !52)
!1062 = !DILocation(line: 350, column: 9, scope: !1036)
!1063 = !DILocation(line: 352, column: 7, scope: !1064)
!1064 = distinct !DILexicalBlock(scope: !1036, file: !3, line: 352, column: 7)
!1065 = !DILocation(line: 352, column: 12, scope: !1064)
!1066 = !DILocation(line: 352, column: 7, scope: !1036)
...
!1070 = distinct !DILexicalBlock(scope: !1036, file: !3, line: 356, column: 8)
!1071 = !DILocation(line: 356, column: 19, scope: !1070)
!1072 = !DILocation(line: 356, column: 17, scope: !1070)
!1073 = !DILocation(line: 356, column: 8, scope: !1036)
...
!1077 = distinct !DILexicalBlock(scope: !1036, file: !3, line: 361, column: 8)
...
!1085 = !DILocation(line: 361, column: 8, scope: !1036)
!1086 = !DILocation(line: 362, column: 5, scope: !1087)
!1087 = distinct !DILexicalBlock(scope: !1077, file: !3, line: 361, column: 58)
!1088 = !DILocation(line: 365, column: 27, scope: !1036)
!1089 = !DILocation(line: 365, column: 20, scope: !1036)
!1090 = !DILocation(line: 365, column: 11, scope: !1036)
!1091 = !DILocation(line: 367, column: 8, scope: !1092)
!1092 = distinct !DILexicalBlock(scope: !1036, file: !3, line: 367, column: 8)
!1093 = !DILocation(line: 367, column: 16, scope: !1092)
!1094 = !DILocation(line: 367, column: 8, scope: !1036)
!1095 = !DILocation(line: 368, column: 5, scope: !1096)
!1096 = distinct !DILexicalBlock(scope: !1092, file: !3, line: 367, column: 26)
!1097 = !DILocation(line: 371, column: 11, scope: !1036)
!1098 = !DILocation(line: 371, column: 20, scope: !1036)
!1099 = !DILocation(line: 371, column: 29, scope: !1036)
!1100 = !DILocation(line: 371, column: 3, scope: !1036)
!1101 = !DILocation(line: 373, column: 11, scope: !1036)
!1102 = !DILocation(line: 373, column: 4, scope: !1036)
!1103 = !DILocation(line: 373, column: 9, scope: !1036)
!1104 = !DILocation(line: 374, column: 35, scope: !1036)
!1105 = !DILocation(line: 374, column: 8, scope: !1036)
!1106 = !DILocation(line: 376, column: 3, scope: !1036)
!1107 = !DILocation(line: 377, column: 1, scope: !1036)
!1108 = distinct !DISubprogram(name: "Demo1BobInit", scope: !3, file: !3, line: 165, type: !991, scopeLine: 169, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !714)
!1109 = !DILocalVariable(name: "ImageHandle", arg: 1, scope: !1108, file: !3, line: 166, type: !98)
!1110 = !DILocation(line: 166, column: 24, scope: !1108)
!1111 = !DILocalVariable(name: "SystemTable", arg: 2, scope: !1108, file: !3, line: 167, type: !100)
!1112 = !DILocation(line: 167, column: 25, scope: !1108)
!1113 = !DILocalVariable(name: "Status", scope: !1108, file: !3, line: 170, type: !130)
!1114 = !DILocation(line: 170, column: 21, scope: !1108)
!1115 = !DILocalVariable(name: "Mode", scope: !1108, file: !3, line: 171, type: !70)
!1116 = !DILocation(line: 171, column: 21, scope: !1108)
!1117 = !DILocalVariable(name: "BufferSize", scope: !1108, file: !3, line: 172, type: !70)
!1118 = !DILocation(line: 172, column: 21, scope: !1108)
!1119 = !DILocation(line: 188, column: 7, scope: !1120)
!1120 = distinct !DILexicalBlock(scope: !1108, file: !3, line: 188, column: 7)
!1121 = !DILocation(line: 188, column: 26, scope: !1120)
!1122 = !DILocation(line: 188, column: 30, scope: !1120)
!1123 = !DILocation(line: 188, column: 48, scope: !1120)
!1124 = !DILocation(line: 188, column: 7, scope: !1108)
!1125 = !DILocation(line: 189, column: 5, scope: !1126)
!1126 = distinct !DILexicalBlock(scope: !1120, file: !3, line: 188, column: 58)
!1127 = !DILocation(line: 189, column: 5, scope: !1128)
!1128 = distinct !DILexicalBlock(scope: !1129, file: !3, line: 189, column: 5)
!1129 = distinct !DILexicalBlock(scope: !1126, file: !3, line: 189, column: 5)
!1130 = !DILocation(line: 189, column: 5, scope: !1129)
!1131 = !DILocation(line: 189, column: 5, scope: !1132)
!1132 = distinct !DILexicalBlock(scope: !1128, file: !3, line: 189, column: 5)
!1133 = !DILocation(line: 189, column: 5, scope: !1134)
!1134 = distinct !DILexicalBlock(scope: !1135, file: !3, line: 189, column: 5)
!1135 = distinct !DILexicalBlock(scope: !1132, file: !3, line: 189, column: 5)
!1136 = !DILocation(line: 189, column: 5, scope: !1135)
!1137 = !DILocation(line: 189, column: 5, scope: !1138)
!1138 = distinct !DILexicalBlock(scope: !1134, file: !3, line: 189, column: 5)
!1139 = !DILocation(line: 191, column: 12, scope: !1126)
!1140 = !DILocation(line: 191, column: 5, scope: !1126)
!1141 = !DILocation(line: 197, column: 12, scope: !1108)
!1142 = !DILocation(line: 197, column: 31, scope: !1108)
!1143 = !DILocation(line: 197, column: 10, scope: !1108)
!1144 = !DILocation(line: 198, column: 7, scope: !1145)
!1145 = distinct !DILexicalBlock(scope: !1108, file: !3, line: 198, column: 7)
!1146 = !DILocation(line: 198, column: 7, scope: !1108)
!1147 = !DILocation(line: 199, column: 5, scope: !1148)
!1148 = distinct !DILexicalBlock(scope: !1145, file: !3, line: 198, column: 27)
!1149 = !DILocation(line: 199, column: 5, scope: !1150)
!1150 = distinct !DILexicalBlock(scope: !1151, file: !3, line: 199, column: 5)
!1151 = distinct !DILexicalBlock(scope: !1148, file: !3, line: 199, column: 5)
!1152 = !DILocation(line: 199, column: 5, scope: !1151)
!1153 = !DILocation(line: 199, column: 5, scope: !1154)
!1154 = distinct !DILexicalBlock(scope: !1150, file: !3, line: 199, column: 5)
!1155 = !DILocation(line: 199, column: 5, scope: !1156)
!1156 = distinct !DILexicalBlock(scope: !1157, file: !3, line: 199, column: 5)
!1157 = distinct !DILexicalBlock(scope: !1154, file: !3, line: 199, column: 5)
!1158 = !DILocation(line: 199, column: 5, scope: !1157)
!1159 = !DILocation(line: 199, column: 5, scope: !1160)
!1160 = distinct !DILexicalBlock(scope: !1156, file: !3, line: 199, column: 5)
!1161 = !DILocation(line: 201, column: 12, scope: !1148)
!1162 = !DILocation(line: 201, column: 5, scope: !1148)
!1163 = !DILocation(line: 208, column: 7, scope: !1164)
!1164 = distinct !DILexicalBlock(scope: !1108, file: !3, line: 208, column: 7)
!1165 = !DILocation(line: 208, column: 26, scope: !1164)
!1166 = !DILocation(line: 208, column: 30, scope: !1164)
!1167 = !DILocation(line: 208, column: 44, scope: !1164)
!1168 = !DILocation(line: 208, column: 7, scope: !1108)
!1169 = !DILocation(line: 209, column: 5, scope: !1170)
!1170 = distinct !DILexicalBlock(scope: !1164, file: !3, line: 208, column: 54)
!1171 = !DILocation(line: 209, column: 5, scope: !1172)
!1172 = distinct !DILexicalBlock(scope: !1173, file: !3, line: 209, column: 5)
!1173 = distinct !DILexicalBlock(scope: !1170, file: !3, line: 209, column: 5)
!1174 = !DILocation(line: 209, column: 5, scope: !1173)
!1175 = !DILocation(line: 209, column: 5, scope: !1176)
!1176 = distinct !DILexicalBlock(scope: !1172, file: !3, line: 209, column: 5)
!1177 = !DILocation(line: 209, column: 5, scope: !1178)
!1178 = distinct !DILexicalBlock(scope: !1179, file: !3, line: 209, column: 5)
!1179 = distinct !DILexicalBlock(scope: !1176, file: !3, line: 209, column: 5)
!1180 = !DILocation(line: 209, column: 5, scope: !1179)
!1181 = !DILocation(line: 209, column: 5, scope: !1182)
!1182 = distinct !DILexicalBlock(scope: !1178, file: !3, line: 209, column: 5)
!1183 = !DILocation(line: 211, column: 12, scope: !1170)
!1184 = !DILocation(line: 211, column: 5, scope: !1170)
!1185 = !DILocation(line: 225, column: 7, scope: !1186)
!1186 = distinct !DILexicalBlock(scope: !1108, file: !3, line: 225, column: 7)
!1187 = !DILocation(line: 225, column: 7, scope: !1108)
!1188 = !DILocation(line: 226, column: 5, scope: !1189)
!1189 = distinct !DILexicalBlock(scope: !1186, file: !3, line: 225, column: 27)
!1190 = !DILocation(line: 226, column: 5, scope: !1191)
!1191 = distinct !DILexicalBlock(scope: !1192, file: !3, line: 226, column: 5)
!1192 = distinct !DILexicalBlock(scope: !1189, file: !3, line: 226, column: 5)
!1193 = !DILocation(line: 226, column: 5, scope: !1192)
!1194 = !DILocation(line: 226, column: 5, scope: !1195)
!1195 = distinct !DILexicalBlock(scope: !1191, file: !3, line: 226, column: 5)
!1196 = !DILocation(line: 226, column: 5, scope: !1197)
!1197 = distinct !DILexicalBlock(scope: !1198, file: !3, line: 226, column: 5)
!1198 = distinct !DILexicalBlock(scope: !1195, file: !3, line: 226, column: 5)
!1199 = !DILocation(line: 226, column: 5, scope: !1198)
!1200 = !DILocation(line: 226, column: 5, scope: !1201)
!1201 = distinct !DILexicalBlock(scope: !1197, file: !3, line: 226, column: 5)
!1202 = !DILocation(line: 228, column: 12, scope: !1189)
!1203 = !DILocation(line: 228, column: 5, scope: !1189)
!1204 = !DILocation(line: 234, column: 7, scope: !1205)
!1205 = distinct !DILexicalBlock(scope: !1108, file: !3, line: 234, column: 7)
!1206 = !DILocation(line: 234, column: 12, scope: !1205)
!1207 = !DILocation(line: 234, column: 7, scope: !1108)
!1208 = !DILocation(line: 235, column: 5, scope: !1209)
!1209 = distinct !DILexicalBlock(scope: !1205, file: !3, line: 234, column: 25)
!1210 = !DILocation(line: 235, column: 5, scope: !1211)
!1211 = distinct !DILexicalBlock(scope: !1212, file: !3, line: 235, column: 5)
!1212 = distinct !DILexicalBlock(scope: !1209, file: !3, line: 235, column: 5)
!1213 = !DILocation(line: 235, column: 5, scope: !1212)
!1214 = !DILocation(line: 235, column: 5, scope: !1215)
!1215 = distinct !DILexicalBlock(scope: !1211, file: !3, line: 235, column: 5)
!1216 = !DILocation(line: 235, column: 5, scope: !1217)
!1217 = distinct !DILexicalBlock(scope: !1218, file: !3, line: 235, column: 5)
!1218 = distinct !DILexicalBlock(scope: !1215, file: !3, line: 235, column: 5)
!1219 = !DILocation(line: 235, column: 5, scope: !1218)
!1220 = !DILocation(line: 235, column: 5, scope: !1221)
!1221 = distinct !DILexicalBlock(scope: !1217, file: !3, line: 235, column: 5)
!1222 = !DILocation(line: 237, column: 5, scope: !1209)
!1223 = !DILocation(line: 239, column: 7, scope: !1224)
!1224 = distinct !DILexicalBlock(scope: !1108, file: !3, line: 239, column: 7)
!1225 = !DILocation(line: 239, column: 12, scope: !1224)
!1226 = !DILocation(line: 239, column: 7, scope: !1108)
!1227 = !DILocation(line: 240, column: 5, scope: !1228)
!1228 = distinct !DILexicalBlock(scope: !1224, file: !3, line: 239, column: 26)
!1229 = !DILocation(line: 240, column: 5, scope: !1230)
!1230 = distinct !DILexicalBlock(scope: !1231, file: !3, line: 240, column: 5)
!1231 = distinct !DILexicalBlock(scope: !1228, file: !3, line: 240, column: 5)
!1232 = !DILocation(line: 240, column: 5, scope: !1231)
!1233 = !DILocation(line: 240, column: 5, scope: !1234)
!1234 = distinct !DILexicalBlock(scope: !1230, file: !3, line: 240, column: 5)
!1235 = !DILocation(line: 240, column: 5, scope: !1236)
!1236 = distinct !DILexicalBlock(scope: !1237, file: !3, line: 240, column: 5)
!1237 = distinct !DILexicalBlock(scope: !1234, file: !3, line: 240, column: 5)
!1238 = !DILocation(line: 240, column: 5, scope: !1237)
!1239 = !DILocation(line: 240, column: 5, scope: !1240)
!1240 = distinct !DILexicalBlock(scope: !1236, file: !3, line: 240, column: 5)
!1241 = !DILocation(line: 242, column: 5, scope: !1228)
!1242 = !DILocation(line: 256, column: 7, scope: !1243)
!1243 = distinct !DILexicalBlock(scope: !1108, file: !3, line: 256, column: 7)
!1244 = !DILocation(line: 256, column: 7, scope: !1108)
!1245 = !DILocation(line: 257, column: 5, scope: !1246)
!1246 = distinct !DILexicalBlock(scope: !1243, file: !3, line: 256, column: 27)
!1247 = !DILocation(line: 257, column: 5, scope: !1248)
!1248 = distinct !DILexicalBlock(scope: !1249, file: !3, line: 257, column: 5)
!1249 = distinct !DILexicalBlock(scope: !1246, file: !3, line: 257, column: 5)
!1250 = !DILocation(line: 257, column: 5, scope: !1249)
!1251 = !DILocation(line: 257, column: 5, scope: !1252)
!1252 = distinct !DILexicalBlock(scope: !1248, file: !3, line: 257, column: 5)
!1253 = !DILocation(line: 257, column: 5, scope: !1254)
!1254 = distinct !DILexicalBlock(scope: !1255, file: !3, line: 257, column: 5)
!1255 = distinct !DILexicalBlock(scope: !1252, file: !3, line: 257, column: 5)
!1256 = !DILocation(line: 257, column: 5, scope: !1255)
!1257 = !DILocation(line: 257, column: 5, scope: !1258)
!1258 = distinct !DILexicalBlock(scope: !1254, file: !3, line: 257, column: 5)
!1259 = !DILocation(line: 259, column: 12, scope: !1246)
!1260 = !DILocation(line: 259, column: 5, scope: !1246)
!1261 = !DILocation(line: 282, column: 7, scope: !1262)
!1262 = distinct !DILexicalBlock(scope: !1108, file: !3, line: 282, column: 7)
!1263 = !DILocation(line: 282, column: 7, scope: !1108)
!1264 = !DILocation(line: 283, column: 12, scope: !1265)
!1265 = distinct !DILexicalBlock(scope: !1262, file: !3, line: 282, column: 27)
!1266 = !DILocation(line: 283, column: 5, scope: !1265)
!1267 = !DILocation(line: 286, column: 3, scope: !1108)
!1268 = !DILocation(line: 287, column: 1, scope: !1108)
!1269 = distinct !DISubprogram(name: "Demo1BobUnload", scope: !3, file: !3, line: 299, type: !501, scopeLine: 302, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !714)
!1270 = !DILocalVariable(name: "ImageHandle", arg: 1, scope: !1269, file: !3, line: 300, type: !98)
!1271 = !DILocation(line: 300, column: 18, scope: !1269)
!1272 = !DILocalVariable(name: "Status", scope: !1269, file: !3, line: 303, type: !130)
!1273 = !DILocation(line: 303, column: 14, scope: !1269)
!1274 = !DILocation(line: 309, column: 10, scope: !1269)
!1275 = !DILocation(line: 309, column: 3, scope: !1269)
!1276 = distinct !DISubprogram(name: "CopyMem_c", scope: !3, file: !3, line: 312, type: !1277, scopeLine: 312, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !714)
!1277 = !DISubroutineType(types: !1278)
!1278 = !{null, !52, !605, !1279}
!1279 = !DIDerivedType(tag: DW_TAG_typedef, name: "size_t", file: !1280, line: 46, baseType: !1281)
!1280 = !DIFile(filename: "/usr/lib/llvm-14/lib/clang/14.0.6/include/stddef.h", directory: "", checksumkind: CSK_MD5, checksum: "2499dd2361b915724b073282bea3a7bc")
!1281 = !DIBasicType(name: "unsigned long", size: 64, encoding: DW_ATE_unsigned)
!1282 = !DILocalVariable(name: "Destination", arg: 1, scope: !1276, file: !3, line: 312, type: !52)
!1283 = !DILocation(line: 312, column: 22, scope: !1276)
!1284 = !DILocalVariable(name: "Source", arg: 2, scope: !1276, file: !3, line: 312, type: !605)
!1285 = !DILocation(line: 312, column: 47, scope: !1276)
!1286 = !DILocalVariable(name: "Length", arg: 3, scope: !1276, file: !3, line: 312, type: !1279)
!1287 = !DILocation(line: 312, column: 62, scope: !1276)
!1288 = !DILocalVariable(name: "dest", scope: !1276, file: !3, line: 313, type: !83)
!1289 = !DILocation(line: 313, column: 14, scope: !1276)
!1290 = !DILocation(line: 313, column: 32, scope: !1276)
!1291 = !DILocalVariable(name: "src", scope: !1276, file: !3, line: 314, type: !88)
!1292 = !DILocation(line: 314, column: 20, scope: !1276)
!1293 = !DILocation(line: 314, column: 43, scope: !1276)
!1294 = !DILocalVariable(name: "i", scope: !1295, file: !3, line: 316, type: !1279)
!1295 = distinct !DILexicalBlock(scope: !1276, file: !3, line: 316, column: 5)
!1296 = !DILocation(line: 316, column: 17, scope: !1295)
!1297 = !DILocation(line: 316, column: 10, scope: !1295)
!1298 = !DILocation(line: 316, column: 24, scope: !1299)
!1299 = distinct !DILexicalBlock(scope: !1295, file: !3, line: 316, column: 5)
!1300 = !DILocation(line: 316, column: 28, scope: !1299)
!1301 = !DILocation(line: 316, column: 26, scope: !1299)
!1302 = !DILocation(line: 316, column: 5, scope: !1295)
!1303 = !DILocation(line: 317, column: 19, scope: !1304)
!1304 = distinct !DILexicalBlock(scope: !1299, file: !3, line: 316, column: 41)
!1305 = !DILocation(line: 317, column: 23, scope: !1304)
!1306 = !DILocation(line: 317, column: 9, scope: !1304)
!1307 = !DILocation(line: 317, column: 14, scope: !1304)
!1308 = !DILocation(line: 317, column: 17, scope: !1304)
!1309 = !DILocation(line: 318, column: 5, scope: !1304)
!1310 = !DILocation(line: 316, column: 37, scope: !1299)
!1311 = !DILocation(line: 316, column: 5, scope: !1299)
!1312 = distinct !{!1312, !1302, !1313, !851}
!1313 = !DILocation(line: 318, column: 5, scope: !1295)
!1314 = !DILocation(line: 319, column: 1, scope: !1276)
!1315 = distinct !DISubprogram(name: "read_bobkey_addr_through_Demo1BobDataProvider", scope: !3, file: !3, line: 379, type: !1316, scopeLine: 379, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !714)
!1316 = !DISubroutineType(types: !1317)
!1317 = !{null}
!1318 = !DILocalVariable(name: "size", scope: !1315, file: !3, line: 385, type: !70)
!1319 = !DILocation(line: 385, column: 11, scope: !1315)
!1320 = !DILocalVariable(name: "data", scope: !1315, file: !3, line: 388, type: !310)
!1321 = !DILocation(line: 388, column: 23, scope: !1315)
!1322 = !DILocalVariable(name: "searchValue", scope: !1315, file: !3, line: 390, type: !52)
!1323 = !DILocation(line: 390, column: 11, scope: !1315)
!1324 = !DILocalVariable(name: "readValue", scope: !1315, file: !3, line: 391, type: !1325)
!1325 = !DIDerivedType(tag: DW_TAG_typedef, name: "CHAR8", file: !54, line: 218, baseType: !1326)
!1326 = !DIBasicType(name: "char", size: 8, encoding: DW_ATE_signed_char)
!1327 = !DILocation(line: 391, column: 12, scope: !1315)
!1328 = !DILocation(line: 393, column: 35, scope: !1329)
!1329 = distinct !DILexicalBlock(scope: !1315, file: !3, line: 393, column: 8)
!1330 = !DILocation(line: 393, column: 48, scope: !1329)
!1331 = !DILocation(line: 393, column: 64, scope: !1329)
!1332 = !DILocation(line: 393, column: 8, scope: !1329)
!1333 = !DILocation(line: 393, column: 70, scope: !1329)
!1334 = !DILocation(line: 393, column: 8, scope: !1315)
!1335 = !DILocation(line: 395, column: 43, scope: !1336)
!1336 = distinct !DILexicalBlock(scope: !1329, file: !3, line: 393, column: 85)
!1337 = !DILocation(line: 395, column: 49, scope: !1336)
!1338 = !DILocation(line: 395, column: 35, scope: !1336)
!1339 = !DILocation(line: 395, column: 8, scope: !1336)
!1340 = !DILocation(line: 396, column: 41, scope: !1336)
!1341 = !DILocation(line: 396, column: 47, scope: !1336)
!1342 = !DILocation(line: 396, column: 8, scope: !1336)
!1343 = !DILocation(line: 399, column: 5, scope: !1336)
!1344 = !DILocation(line: 400, column: 1, scope: !1315)
!1345 = distinct !DISubprogram(name: "main", scope: !3, file: !3, line: 402, type: !1346, scopeLine: 403, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !714)
!1346 = !DISubroutineType(types: !1347)
!1347 = !{!196}
!1348 = !DILocalVariable(name: "AccessKeyPtr", scope: !1345, file: !3, line: 404, type: !310)
!1349 = !DILocation(line: 404, column: 23, scope: !1345)
!1350 = !DILocation(line: 405, column: 3, scope: !1345)
!1351 = !DILocation(line: 406, column: 16, scope: !1345)
!1352 = !DILocation(line: 408, column: 37, scope: !1345)
!1353 = !DILocation(line: 408, column: 3, scope: !1345)
!1354 = !DILocation(line: 408, column: 17, scope: !1345)
!1355 = !DILocation(line: 408, column: 36, scope: !1345)
!1356 = !DILocation(line: 409, column: 3, scope: !1345)
!1357 = !DILocation(line: 409, column: 17, scope: !1345)
!1358 = !DILocation(line: 409, column: 37, scope: !1345)
!1359 = !DILocation(line: 410, column: 36, scope: !1345)
!1360 = !DILocation(line: 410, column: 50, scope: !1345)
!1361 = !DILocation(line: 410, column: 3, scope: !1345)
!1362 = !DILocation(line: 411, column: 36, scope: !1345)
!1363 = !DILocation(line: 411, column: 50, scope: !1345)
!1364 = !DILocation(line: 411, column: 3, scope: !1345)
!1365 = !DILocation(line: 412, column: 46, scope: !1345)
!1366 = !DILocation(line: 412, column: 38, scope: !1345)
!1367 = !DILocation(line: 412, column: 3, scope: !1345)
!1368 = !DILocation(line: 413, column: 59, scope: !1345)
!1369 = !DILocation(line: 413, column: 51, scope: !1345)
!1370 = !DILocation(line: 413, column: 3, scope: !1345)
!1371 = !DILocation(line: 414, column: 3, scope: !1345)
!1372 = !DILocation(line: 415, column: 3, scope: !1345)
!1373 = distinct !DISubprogram(name: "memcpy", scope: !1374, file: !1374, line: 12, type: !1375, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !703, retainedNodes: !714)
!1374 = !DIFile(filename: "klee/runtime/Freestanding/memcpy.c", directory: "/home/hira/Research", checksumkind: CSK_MD5, checksum: "8fb9a7164e167db005d7d002570068bc")
!1375 = !DISubroutineType(types: !1376)
!1376 = !{!52, !52, !605, !1279}
!1377 = !DILocalVariable(name: "destaddr", arg: 1, scope: !1373, file: !1374, line: 12, type: !52)
!1378 = !DILocation(line: 12, column: 20, scope: !1373)
!1379 = !DILocalVariable(name: "srcaddr", arg: 2, scope: !1373, file: !1374, line: 12, type: !605)
!1380 = !DILocation(line: 12, column: 42, scope: !1373)
!1381 = !DILocalVariable(name: "len", arg: 3, scope: !1373, file: !1374, line: 12, type: !1279)
!1382 = !DILocation(line: 12, column: 58, scope: !1373)
!1383 = !DILocalVariable(name: "dest", scope: !1373, file: !1374, line: 13, type: !1384)
!1384 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1326, size: 64)
!1385 = !DILocation(line: 13, column: 9, scope: !1373)
!1386 = !DILocation(line: 13, column: 16, scope: !1373)
!1387 = !DILocalVariable(name: "src", scope: !1373, file: !1374, line: 14, type: !1388)
!1388 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1389, size: 64)
!1389 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1326)
!1390 = !DILocation(line: 14, column: 15, scope: !1373)
!1391 = !DILocation(line: 14, column: 21, scope: !1373)
!1392 = !DILocation(line: 16, column: 3, scope: !1373)
!1393 = !DILocation(line: 16, column: 13, scope: !1373)
!1394 = !DILocation(line: 16, column: 16, scope: !1373)
!1395 = !DILocation(line: 17, column: 19, scope: !1373)
!1396 = !DILocation(line: 17, column: 15, scope: !1373)
!1397 = !DILocation(line: 17, column: 10, scope: !1373)
!1398 = !DILocation(line: 17, column: 13, scope: !1373)
!1399 = distinct !{!1399, !1392, !1395, !851}
!1400 = !DILocation(line: 18, column: 10, scope: !1373)
!1401 = !DILocation(line: 18, column: 3, scope: !1373)
