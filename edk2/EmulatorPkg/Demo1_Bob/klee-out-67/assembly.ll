...
define hidden void @read_through_Demo1BobDataProvider(i8* noundef %0) #0 !dbg !1265 {
  ...
  %10 = load i64, i64* %3, align 8, !dbg !1277
  %11 = call i64 @Demo1BobDataProvider(%struct._Demo1_Bob_PROTOCOL* noundef null, i8* noundef bitcast (%struct._DEMO1_ACCESS_KEY* @bobKey to i8*), i8** noundef %9, i64 noundef %10), !dbg !1277
  %12 = icmp ne i64 %11, 0, !dbg !1277
  br i1 %12, label %13, label %14, !dbg !1277

13:                                               ; preds = %1
  br label %16, !dbg !1277

14:                                               ; preds = %1
  %15 = call i32 (i8*, i8*, i32, i8*, ...) bitcast (i32 (...)* @__assert_fail to i32 (i8*, i8*, i32, i8*, ...)*)(i8* noundef getelementptr inbounds ([81 x i8], [81 x i8]* @.str.13, i64 0, i64 0), i8* noundef getelementptr inbounds ([12 x i8], [12 x i8]* @.str.14, i64 0, i64 0), i32 noundef 373, i8* noundef getelementptr inbounds ([47 x i8], [47 x i8]* @__PRETTY_FUNCTION__.read_through_Demo1BobDataProvider, i64 0, i64 0)), !dbg !1277
  br label %16, !dbg !1277
...
; Function Attrs: noinline nounwind optnone uwtable
define hidden i32 @main() #0 !dbg !1279 {
  %1 = alloca i32, align 4
  %2 = alloca i8*, align 8
  store i32 0, i32* %1, align 4
  call void @llvm.dbg.declare(metadata i8** %2, metadata !1282, metadata !DIExpression()), !dbg !1283
  store i8* bitcast (%struct._DEMO1_ACCESS_KEY* @bobKey to i8*), i8** %2, align 8, !dbg !1283
  %3 = load i8*, i8** %2, align 8, !dbg !1284
  call void @read_through_Demo1BobDataProvider(i8* noundef %3), !dbg !1285
  ret i32 0, !dbg !1286
}

; Function Attrs: noinline nounwind uwtable
define dso_local i8* @memcpy(i8* noundef %0, i8* noundef %1, i64 noundef %2) #5 !dbg !1287 {
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
  %6 = alloca i64, align 8
  %7 = alloca i8*, align 8
  %8 = alloca i8*, align 8
  store i8* %0, i8** %4, align 8
  call void @llvm.dbg.declare(metadata i8** %4, metadata !1294, metadata !DIExpression()), !dbg !1295
  store i8* %1, i8** %5, align 8
  call void @llvm.dbg.declare(metadata i8** %5, metadata !1296, metadata !DIExpression()), !dbg !1297
  store i64 %2, i64* %6, align 8
  call void @llvm.dbg.declare(metadata i64* %6, metadata !1298, metadata !DIExpression()), !dbg !1299
  call void @llvm.dbg.declare(metadata i8** %7, metadata !1300, metadata !DIExpression()), !dbg !1303
  %9 = load i8*, i8** %4, align 8, !dbg !1304
  store i8* %9, i8** %7, align 8, !dbg !1303
  call void @llvm.dbg.declare(metadata i8** %8, metadata !1305, metadata !DIExpression()), !dbg !1308
  %10 = load i8*, i8** %5, align 8, !dbg !1309
  store i8* %10, i8** %8, align 8, !dbg !1308
  br label %11, !dbg !1310

11:                                               ; preds = %15, %3
  %12 = load i64, i64* %6, align 8, !dbg !1311
  %13 = add i64 %12, -1, !dbg !1311
  store i64 %13, i64* %6, align 8, !dbg !1311
  %14 = icmp ugt i64 %12, 0, !dbg !1312
  br i1 %14, label %15, label %21, !dbg !1310

15:                                               ; preds = %11
  %16 = load i8*, i8** %8, align 8, !dbg !1313
  %17 = getelementptr inbounds i8, i8* %16, i32 1, !dbg !1313
  store i8* %17, i8** %8, align 8, !dbg !1313
  %18 = load i8, i8* %16, align 1, !dbg !1314
  %19 = load i8*, i8** %7, align 8, !dbg !1315
  %20 = getelementptr inbounds i8, i8* %19, i32 1, !dbg !1315
  store i8* %20, i8** %7, align 8, !dbg !1315
  store i8 %18, i8* %19, align 1, !dbg !1316
  br label %11, !dbg !1310, !llvm.loop !1317

21:                                               ; preds = %11
  %22 = load i8*, i8** %4, align 8, !dbg !1318
  ret i8* %22, !dbg !1319
}
...
!3 = !DIFile(filename: "Demo1_Bob.c", directory: "/home/hira/Research/HARDEN/repositories/HARDEN_demo1/edk2/EmulatorPkg/Demo1_Bob", checksumkind: CSK_MD5, checksum: "bd358ed46c418a3b8df6f917cb008d3b")
!4 = !{!5, !13, !20, !38, !43, !46}
...
!1270 = !DILocalVariable(name: "size", scope: !1265, file: !3, line: 370, type: !70)
!1271 = !DILocation(line: 370, column: 11, scope: !1265)
!1272 = !DILocalVariable(name: "dest", scope: !1265, file: !3, line: 371, type: !303)
!1273 = !DILocation(line: 371, column: 23, scope: !1265)
!1274 = !DILocation(line: 371, column: 29, scope: !1265)
!1275 = !DILocation(line: 372, column: 24, scope: !1265)
!1276 = !DILocation(line: 372, column: 5, scope: !1265)
!1277 = !DILocation(line: 373, column: 5, scope: !1265)
!1278 = !DILocation(line: 374, column: 1, scope: !1265)
!1279 = distinct !DISubprogram(name: "main", scope: !3, file: !3, line: 376, type: !1280, scopeLine: 377, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !707)
!1280 = !DISubroutineType(types: !1281)
!1281 = !{!189}
!1282 = !DILocalVariable(name: "search_address", scope: !1279, file: !3, line: 378, type: !52)
!1283 = !DILocation(line: 378, column: 9, scope: !1279)
!1284 = !DILocation(line: 379, column: 37, scope: !1279)
!1285 = !DILocation(line: 379, column: 3, scope: !1279)
!1286 = !DILocation(line: 380, column: 3, scope: !1279)
!1287 = distinct !DISubprogram(name: "memcpy", scope: !1288, file: !1288, line: 12, type: !1289, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !696, retainedNodes: !707)
!1288 = !DIFile(filename: "klee/runtime/Freestanding/memcpy.c", directory: "/home/hira/Research", checksumkind: CSK_MD5, checksum: "8fb9a7164e167db005d7d002570068bc")
!1289 = !DISubroutineType(types: !1290)
!1290 = !{!52, !52, !598, !1291}
!1291 = !DIDerivedType(tag: DW_TAG_typedef, name: "size_t", file: !1292, line: 46, baseType: !1293)
!1292 = !DIFile(filename: "/usr/lib/llvm-14/lib/clang/14.0.6/include/stddef.h", directory: "", checksumkind: CSK_MD5, checksum: "2499dd2361b915724b073282bea3a7bc")
!1293 = !DIBasicType(name: "unsigned long", size: 64, encoding: DW_ATE_unsigned)
!1294 = !DILocalVariable(name: "destaddr", arg: 1, scope: !1287, file: !1288, line: 12, type: !52)
!1295 = !DILocation(line: 12, column: 20, scope: !1287)
!1296 = !DILocalVariable(name: "srcaddr", arg: 2, scope: !1287, file: !1288, line: 12, type: !598)
!1297 = !DILocation(line: 12, column: 42, scope: !1287)
!1298 = !DILocalVariable(name: "len", arg: 3, scope: !1287, file: !1288, line: 12, type: !1291)
!1299 = !DILocation(line: 12, column: 58, scope: !1287)
!1300 = !DILocalVariable(name: "dest", scope: !1287, file: !1288, line: 13, type: !1301)
!1301 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1302, size: 64)
!1302 = !DIBasicType(name: "char", size: 8, encoding: DW_ATE_signed_char)
!1303 = !DILocation(line: 13, column: 9, scope: !1287)
!1304 = !DILocation(line: 13, column: 16, scope: !1287)
!1305 = !DILocalVariable(name: "src", scope: !1287, file: !1288, line: 14, type: !1306)
!1306 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1307, size: 64)
!1307 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1302)
!1308 = !DILocation(line: 14, column: 15, scope: !1287)
!1309 = !DILocation(line: 14, column: 21, scope: !1287)
!1310 = !DILocation(line: 16, column: 3, scope: !1287)
!1311 = !DILocation(line: 16, column: 13, scope: !1287)
!1312 = !DILocation(line: 16, column: 16, scope: !1287)
!1313 = !DILocation(line: 17, column: 19, scope: !1287)
!1314 = !DILocation(line: 17, column: 15, scope: !1287)
!1315 = !DILocation(line: 17, column: 10, scope: !1287)
!1316 = !DILocation(line: 17, column: 13, scope: !1287)
!1317 = distinct !{!1317, !1310, !1313, !844}
!1318 = !DILocation(line: 18, column: 10, scope: !1287)
!1319 = !DILocation(line: 18, column: 3, scope: !1287)
