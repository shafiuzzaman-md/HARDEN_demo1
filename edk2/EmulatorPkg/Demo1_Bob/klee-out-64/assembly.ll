...
define hidden i32 @main() #0 !dbg !1296 {
  ...
  %2 = call i64 @Demo1GenerateAccessKey(%struct._Demo1_Access_Key_PROTOCOL* noundef null, i8* noundef null, i8 noundef zeroext 0, %struct._DEMO1_ACCESS_KEY* noundef @bobKey), !dbg !1299
  call void @read_bobkey_through_Demo1BobDataProvider(), !dbg !1300
  ret i32 0, !dbg !1301
}

; Function Attrs: noinline nounwind uwtable
define dso_local i8* @memcpy(i8* noundef %0, i8* noundef %1, i64 noundef %2) #5 !dbg !1302 {
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
  %6 = alloca i64, align 8
  %7 = alloca i8*, align 8
  %8 = alloca i8*, align 8
  store i8* %0, i8** %4, align 8
  call void @llvm.dbg.declare(metadata i8** %4, metadata !1309, metadata !DIExpression()), !dbg !1310
  store i8* %1, i8** %5, align 8
  call void @llvm.dbg.declare(metadata i8** %5, metadata !1311, metadata !DIExpression()), !dbg !1312
  store i64 %2, i64* %6, align 8
  call void @llvm.dbg.declare(metadata i64* %6, metadata !1313, metadata !DIExpression()), !dbg !1314
  call void @llvm.dbg.declare(metadata i8** %7, metadata !1315, metadata !DIExpression()), !dbg !1318
  %9 = load i8*, i8** %4, align 8, !dbg !1319
  store i8* %9, i8** %7, align 8, !dbg !1318
  call void @llvm.dbg.declare(metadata i8** %8, metadata !1320, metadata !DIExpression()), !dbg !1323
  %10 = load i8*, i8** %5, align 8, !dbg !1324
  store i8* %10, i8** %8, align 8, !dbg !1323
  br label %11, !dbg !1325

11:                                               ; preds = %15, %3
  %12 = load i64, i64* %6, align 8, !dbg !1326
  %13 = add i64 %12, -1, !dbg !1326
  store i64 %13, i64* %6, align 8, !dbg !1326
  %14 = icmp ugt i64 %12, 0, !dbg !1327
  br i1 %14, label %15, label %21, !dbg !1325

15:                                               ; preds = %11
  %16 = load i8*, i8** %8, align 8, !dbg !1328
  %17 = getelementptr inbounds i8, i8* %16, i32 1, !dbg !1328
  store i8* %17, i8** %8, align 8, !dbg !1328
  %18 = load i8, i8* %16, align 1, !dbg !1329
  %19 = load i8*, i8** %7, align 8, !dbg !1330
  %20 = getelementptr inbounds i8, i8* %19, i32 1, !dbg !1330
  store i8* %20, i8** %7, align 8, !dbg !1330
  store i8 %18, i8* %19, align 1, !dbg !1331
  br label %11, !dbg !1325, !llvm.loop !1332

21:                                               ; preds = %11
  %22 = load i8*, i8** %4, align 8, !dbg !1333
  ret i8* %22, !dbg !1334
}
...
!3 = !DIFile(filename: "Demo1_Bob.c", directory: "/home/hira/Research/HARDEN/repositories/HARDEN_demo1/edk2/EmulatorPkg/Demo1_Bob", checksumkind: CSK_MD5, checksum: "2296f35e8a0a8137020f8d8c64f17990")
!4 = !{!5, !13, !20, !38, !43, !46}
...
!1300 = !DILocation(line: 391, column: 3, scope: !1296)
!1301 = !DILocation(line: 392, column: 3, scope: !1296)
!1302 = distinct !DISubprogram(name: "memcpy", scope: !1303, file: !1303, line: 12, type: !1304, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !696, retainedNodes: !707)
!1303 = !DIFile(filename: "klee/runtime/Freestanding/memcpy.c", directory: "/home/hira/Research", checksumkind: CSK_MD5, checksum: "8fb9a7164e167db005d7d002570068bc")
!1304 = !DISubroutineType(types: !1305)
!1305 = !{!52, !52, !598, !1306}
!1306 = !DIDerivedType(tag: DW_TAG_typedef, name: "size_t", file: !1307, line: 46, baseType: !1308)
!1307 = !DIFile(filename: "/usr/lib/llvm-14/lib/clang/14.0.6/include/stddef.h", directory: "", checksumkind: CSK_MD5, checksum: "2499dd2361b915724b073282bea3a7bc")
!1308 = !DIBasicType(name: "unsigned long", size: 64, encoding: DW_ATE_unsigned)
!1309 = !DILocalVariable(name: "destaddr", arg: 1, scope: !1302, file: !1303, line: 12, type: !52)
!1310 = !DILocation(line: 12, column: 20, scope: !1302)
!1311 = !DILocalVariable(name: "srcaddr", arg: 2, scope: !1302, file: !1303, line: 12, type: !598)
!1312 = !DILocation(line: 12, column: 42, scope: !1302)
!1313 = !DILocalVariable(name: "len", arg: 3, scope: !1302, file: !1303, line: 12, type: !1306)
!1314 = !DILocation(line: 12, column: 58, scope: !1302)
!1315 = !DILocalVariable(name: "dest", scope: !1302, file: !1303, line: 13, type: !1316)
!1316 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1317, size: 64)
!1317 = !DIBasicType(name: "char", size: 8, encoding: DW_ATE_signed_char)
!1318 = !DILocation(line: 13, column: 9, scope: !1302)
!1319 = !DILocation(line: 13, column: 16, scope: !1302)
!1320 = !DILocalVariable(name: "src", scope: !1302, file: !1303, line: 14, type: !1321)
!1321 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1322, size: 64)
!1322 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1317)
!1323 = !DILocation(line: 14, column: 15, scope: !1302)
!1324 = !DILocation(line: 14, column: 21, scope: !1302)
!1325 = !DILocation(line: 16, column: 3, scope: !1302)
!1326 = !DILocation(line: 16, column: 13, scope: !1302)
!1327 = !DILocation(line: 16, column: 16, scope: !1302)
!1328 = !DILocation(line: 17, column: 19, scope: !1302)
!1329 = !DILocation(line: 17, column: 15, scope: !1302)
!1330 = !DILocation(line: 17, column: 10, scope: !1302)
!1331 = !DILocation(line: 17, column: 13, scope: !1302)
!1332 = distinct !{!1332, !1325, !1328, !844}
!1333 = !DILocation(line: 18, column: 10, scope: !1302)
!1334 = !DILocation(line: 18, column: 3, scope: !1302)
