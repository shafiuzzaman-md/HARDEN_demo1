...
define hidden void @read_through_Demo1BobDataProvider(i8* noundef %0) #0 !dbg !1309 {
  ...
  %6 = bitcast i64* %3 to i8*, !dbg !1316
  call void @klee_make_symbolic(i8* noundef %6, i64 noundef 8, i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str.12, i64 0, i64 0)), !dbg !1317
  call void @llvm.dbg.declare(metadata i64* %4, metadata !1318, metadata !DIExpression()), !dbg !1319
  store i64 16, i64* %4, align 8, !dbg !1319
  call void @llvm.dbg.declare(metadata %struct._DEMO1_ACCESS_KEY** %5, metadata !1320, metadata !DIExpression()), !dbg !1321
  %7 = call i8* @malloc(i64 noundef 16), !dbg !1322
  %8 = bitcast i8* %7 to %struct._DEMO1_ACCESS_KEY*, !dbg !1322
  store %struct._DEMO1_ACCESS_KEY* %8, %struct._DEMO1_ACCESS_KEY** %5, align 8, !dbg !1321
  %9 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %5, align 8, !dbg !1323
  %10 = bitcast %struct._DEMO1_ACCESS_KEY* %9 to i8*, !dbg !1323
  call void @klee_make_symbolic(i8* noundef %10, i64 noundef 16, i8* noundef getelementptr inbounds ([5 x i8], [5 x i8]* @.str.13, i64 0, i64 0)), !dbg !1324
  %11 = load i64, i64* %3, align 8, !dbg !1325
  %12 = inttoptr i64 %11 to i8*, !dbg !1325
  %13 = bitcast %struct._DEMO1_ACCESS_KEY** %5 to i8**, !dbg !1325
  %14 = load i64, i64* %4, align 8, !dbg !1325
  %15 = call i64 @Demo1BobDataProvider(%struct._Demo1_Bob_PROTOCOL* noundef null, i8* noundef %12, i8** noundef %13, i64 noundef %14), !dbg !1325
  %16 = icmp ne i64 %15, 0, !dbg !1325
...
18:                                               ; preds = %1
  %19 = call i32 (i8*, i8*, i32, i8*, ...) bitcast (i32 (...)* @__assert_fail to i32 (i8*, i8*, i32, i8*, ...)*)(i8* noundef getelementptr inbounds ([81 x i8], [81 x i8]* @.str.14, i64 0, i64 0), i8* noundef getelementptr inbounds ([12 x i8], [12 x i8]* @.str.15, i64 0, i64 0), i32 noundef 384, i8* noundef getelementptr inbounds ([47 x i8], [47 x i8]* @__PRETTY_FUNCTION__.read_through_Demo1BobDataProvider, i64 0, i64 0)), !dbg !1325
  br label %20, !dbg !1325
...
; Function Attrs: noinline nounwind optnone uwtable
define hidden i32 @main() #0 !dbg !1327 {
  ...
  %3 = load i8*, i8** %2, align 8, !dbg !1332
  call void @read_through_Demo1BobDataProvider(i8* noundef %3), !dbg !1333
  ret i32 0, !dbg !1334
}
...
!3 = !DIFile(filename: "Demo1_Bob.c", directory: "/home/hira/Research/HARDEN/repositories/HARDEN_demo1/edk2/EmulatorPkg/Demo1_Bob", checksumkind: CSK_MD5, checksum: "811638dbdbf5153b789cd5c3b00d0fb9")
!4 = !{!5, !13, !20, !38, !43, !46}
...
!1316 = !DILocation(line: 380, column: 24, scope: !1309)
!1317 = !DILocation(line: 380, column: 5, scope: !1309)
!1318 = !DILocalVariable(name: "size", scope: !1309, file: !3, line: 381, type: !70)
!1319 = !DILocation(line: 381, column: 11, scope: !1309)
!1320 = !DILocalVariable(name: "dest", scope: !1309, file: !3, line: 382, type: !310)
!1321 = !DILocation(line: 382, column: 23, scope: !1309)
!1322 = !DILocation(line: 382, column: 29, scope: !1309)
!1323 = !DILocation(line: 383, column: 24, scope: !1309)
!1324 = !DILocation(line: 383, column: 5, scope: !1309)
!1325 = !DILocation(line: 384, column: 5, scope: !1309)
!1326 = !DILocation(line: 385, column: 1, scope: !1309)
!1327 = distinct !DISubprogram(name: "main", scope: !3, file: !3, line: 387, type: !1328, scopeLine: 388, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !712)
!1328 = !DISubroutineType(types: !1329)
!1329 = !{!196}
!1330 = !DILocalVariable(name: "search_address", scope: !1327, file: !3, line: 389, type: !52)
!1331 = !DILocation(line: 389, column: 9, scope: !1327)
!1332 = !DILocation(line: 390, column: 37, scope: !1327)
!1333 = !DILocation(line: 390, column: 3, scope: !1327)
!1334 = !DILocation(line: 391, column: 3, scope: !1327)
