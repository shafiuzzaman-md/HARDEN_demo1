...
define hidden void @read_bobkey_addr_through_Demo1BobDataProvider() #0 !dbg !1318 {
  ...
  br i1 %9, label %10, label %18, !dbg !1337

10:                                               ; preds = %0
  %11 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %1, align 8, !dbg !1338
  %12 = bitcast %struct._DEMO1_ACCESS_KEY* %11 to { i64, i64 }*, !dbg !1340
  %13 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %12, i32 0, i32 0, !dbg !1340
  %14 = load i64, i64* %13, align 8, !dbg !1340
  %15 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %12, i32 0, i32 1, !dbg !1340
  %16 = load i64, i64* %15, align 8, !dbg !1340
  %17 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str.15, i64 0, i64 0), i64 %14, i64 %16), !dbg !1340
...
define hidden i32 @main() #0 !dbg !1343 {
  ...
  %16 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str.15, i64 0, i64 0), i64 noundef %15), !dbg !1359
  ...
  %21 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str.17, i64 0, i64 0), i64 noundef %20), !dbg !1362
  ...
  %24 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([24 x i8], [24 x i8]* @.str.18, i64 0, i64 0), i8* noundef %23), !dbg !1365
  ...
  %27 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([37 x i8], [37 x i8]* @.str.19, i64 0, i64 0), i8* noundef %26), !dbg !1368
...
!3 = !DIFile(filename: "Demo1_Bob.c", directory: "/home/hira/Research/HARDEN/repositories/HARDEN_demo1/edk2/EmulatorPkg/Demo1_Bob", checksumkind: CSK_MD5, checksum: "fbe4a45b5296844d59ee7b66533bfe03")
!4 = !{!5, !13, !20, !38, !43, !46}
...
!1338 = !DILocation(line: 398, column: 42, scope: !1339)
