...
@.str.15 = private unnamed_addr constant [21 x i8] c"Pointer address: %p\0A\00", align 1
@.str.16 = private unnamed_addr constant [22 x i8] c"Value pointed to: %d\0A\00", align 1
...
define hidden i32 @main() #0 !dbg !1338 {
  ...
  store %struct._DEMO1_ACCESS_KEY* @bobKey, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1343
  %3 = call i32 (...) @rand(), !dbg !1344
  %4 = sext i32 %3 to i64, !dbg !1344
  %5 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1345
  %6 = getelementptr inbounds %struct._DEMO1_ACCESS_KEY, %struct._DEMO1_ACCESS_KEY* %5, i32 0, i32 0, !dbg !1346
  %7 = getelementptr inbounds [2 x i64], [2 x i64]* %6, i64 0, i64 0, !dbg !1345
  store i64 %4, i64* %7, align 8, !dbg !1347
  %8 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1348
  %9 = getelementptr inbounds %struct._DEMO1_ACCESS_KEY, %struct._DEMO1_ACCESS_KEY* %8, i32 0, i32 0, !dbg !1349
  %10 = getelementptr inbounds [2 x i64], [2 x i64]* %9, i64 0, i64 1, !dbg !1348
  store i64 -2395670108176482799, i64* %10, align 8, !dbg !1350
  %11 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1351
  %12 = bitcast %struct._DEMO1_ACCESS_KEY* %11 to i8*, !dbg !1352
  %13 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([21 x i8], [21 x i8]* @.str.15, i64 0, i64 0), i8* noundef %12), !dbg !1353
  %14 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1354
  %15 = bitcast %struct._DEMO1_ACCESS_KEY* %14 to { i64, i64 }*, !dbg !1355
  %16 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %15, i32 0, i32 0, !dbg !1355
  %17 = load i64, i64* %16, align 8, !dbg !1355
  %18 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %15, i32 0, i32 1, !dbg !1355
  %19 = load i64, i64* %18, align 8, !dbg !1355
  %20 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str.16, i64 0, i64 0), i64 %17, i64 %19), !dbg !1355
...
define dso_local i8* @memcpy(i8* noundef %0, i8* noundef %1, i64 noundef %2) #5 !dbg !1358 {
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
  %6 = alloca i64, align 8
  %7 = alloca i8*, align 8
...
!3 = !DIFile(filename: "Demo1_Bob.c", directory: "/home/hira/Research/HARDEN/repositories/HARDEN_demo1/edk2/EmulatorPkg/Demo1_Bob", checksumkind: CSK_MD5, checksum: "e42097acda974cefa2ce608dc0ca62cc")
!4 = !{!5, !13, !20, !38, !43, !46}
...
!1343 = !DILocation(line: 400, column: 16, scope: !1338)
!1344 = !DILocation(line: 402, column: 37, scope: !1338)
!1345 = !DILocation(line: 402, column: 3, scope: !1338)
!1346 = !DILocation(line: 402, column: 17, scope: !1338)
!1347 = !DILocation(line: 402, column: 36, scope: !1338)
!1348 = !DILocation(line: 403, column: 3, scope: !1338)
!1349 = !DILocation(line: 403, column: 17, scope: !1338)
!1350 = !DILocation(line: 403, column: 37, scope: !1338)
!1351 = !DILocation(line: 404, column: 43, scope: !1338)
!1352 = !DILocation(line: 404, column: 35, scope: !1338)
!1353 = !DILocation(line: 404, column: 3, scope: !1338)
!1354 = !DILocation(line: 405, column: 37, scope: !1338)
!1355 = !DILocation(line: 405, column: 3, scope: !1338)
!1356 = !DILocation(line: 406, column: 3, scope: !1338)
!1357 = !DILocation(line: 407, column: 3, scope: !1338)
...
!1369 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1323, size: 64)
...
!1374 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1323)
