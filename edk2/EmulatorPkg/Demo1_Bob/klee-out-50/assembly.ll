...
define hidden i32 @main() #0 !dbg !1265 {
  ...
  br i1 %12, label %13, label %19, !dbg !1282
...
13:                                               ; preds = %0
  ...
  %16 = getelementptr inbounds [2 x i64], [2 x i64]* %15, i64 0, i64 0, !dbg !1283
  %17 = load i64, i64* %16, align 8, !dbg !1283
  call void (i8*, ...) @klee_print_expr(i8* noundef getelementptr inbounds ([10 x i8], [10 x i8]* @.str.13, i64 0, i64 0), i64 noundef %17), !dbg !1286
  %18 = call i32 (i8*, i8*, i32, i8*, ...) bitcast (i32 (...)* @__assert_fail to i32 (i8*, i8*, i32, i8*, ...)*)(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str.14, i64 0, i64 0), i8* noundef getelementptr inbounds ([12 x i8], [12 x i8]* @.str.15, i64 0, i64 0), i32 noundef 378, i8* noundef getelementptr inbounds ([11 x i8], [11 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)), !dbg !1287
...
!3 = !DIFile(filename: "Demo1_Bob.c", directory: "/home/hira/Research/HARDEN/repositories/HARDEN_demo1/edk2/EmulatorPkg/Demo1_Bob", checksumkind: CSK_MD5, checksum: "b97ea4c970af10d6b961b7ccc224d600")
!4 = !{!5, !13, !20, !38, !43, !46}
...
!1283 = !DILocation(line: 377, column: 36, scope: !1284)
!1284 = distinct !DILexicalBlock(scope: !1278, file: !3, line: 375, column: 89)
!1285 = !DILocation(line: 377, column: 42, scope: !1284)
!1286 = !DILocation(line: 377, column: 7, scope: !1284)
!1287 = !DILocation(line: 378, column: 7, scope: !1284)
!1288 = !DILocation(line: 379, column: 5, scope: !1284)
!1289 = !DILocation(line: 382, column: 3, scope: !1265)
