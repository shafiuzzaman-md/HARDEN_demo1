...
define hidden void @read_bobkey_through_Demo1BobDataProvider() #0 !dbg !1265 {
  ...
  store i64 16, i64* %3, align 8, !dbg !1273
  call void @llvm.dbg.declare(metadata i8** %4, metadata !1274, metadata !DIExpression()), !dbg !1275
  %5 = call i8* @malloc(i64 noundef 1), !dbg !1276
  store i8* %5, i8** %4, align 8, !dbg !1275
  %6 = load i8*, i8** %4, align 8, !dbg !1277
  call void @klee_make_symbolic(i8* noundef %6, i64 noundef 1, i8* noundef getelementptr inbounds ([5 x i8], [5 x i8]* @.str.12, i64 0, i64 0)), !dbg !1278
  %7 = load %struct._Demo1_Bob_PROTOCOL*, %struct._Demo1_Bob_PROTOCOL** %1, align 8, !dbg !1279
  %8 = bitcast i8** %4 to i8*, !dbg !1281
  %9 = load i64, i64* %3, align 8, !dbg !1282
  %10 = call i64 @Demo1BobDataProvider(%struct._Demo1_Bob_PROTOCOL* noundef %7, i8* noundef %8, i8** noundef %2, i64 noundef %9), !dbg !1283
  %11 = icmp eq i64 %10, 0, !dbg !1284
  br i1 %11, label %12, label %19, !dbg !1285

12:                                               ; preds = %0
  %13 = load i8*, i8** %2, align 8, !dbg !1286
  %14 = icmp ne i8* %13, bitcast (%struct._DEMO1_ACCESS_KEY* @bobKey to i8*), !dbg !1286
  br i1 %14, label %15, label %16, !dbg !1286

15:                                               ; preds = %12
  br label %18, !dbg !1286

16:                                               ; preds = %12
  %17 = call i32 (i8*, i8*, i32, i8*, ...) bitcast (i32 (...)* @__assert_fail to i32 (i8*, i8*, i32, i8*, ...)*)(i8* noundef getelementptr inbounds ([16 x i8], [16 x i8]* @.str.13, i64 0, i64 0), i8* noundef getelementptr inbounds ([12 x i8], [12 x i8]* @.str.14, i64 0, i64 0), i32 noundef 380, i8* noundef getelementptr inbounds ([48 x i8], [48 x i8]* @__PRETTY_FUNCTION__.read_bobkey_through_Demo1BobDataProvider, i64 0, i64 0)), !dbg !1286
  br label %18, !dbg !1286
...
; Function Attrs: noinline nounwind optnone uwtable
define hidden i32 @main() #0 !dbg !1290 {
  %1 = alloca i32, align 4
  store i32 0, i32* %1, align 4
  call void @read_bobkey_through_Demo1BobDataProvider(), !dbg !1293
  ret i32 0, !dbg !1294
}

; Function Attrs: noinline nounwind uwtable
define dso_local i8* @memcpy(i8* noundef %0, i8* noundef %1, i64 noundef %2) #5 !dbg !1295 {
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
  %6 = alloca i64, align 8
  %7 = alloca i8*, align 8
  ...
  call void @llvm.dbg.declare(metadata i64* %6, metadata !1306, metadata !DIExpression()), !dbg !1307
  call void @llvm.dbg.declare(metadata i8** %7, metadata !1308, metadata !DIExpression()), !dbg !1311
  %9 = load i8*, i8** %4, align 8, !dbg !1312
  store i8* %9, i8** %7, align 8, !dbg !1311
  call void @llvm.dbg.declare(metadata i8** %8, metadata !1313, metadata !DIExpression()), !dbg !1316
  %10 = load i8*, i8** %5, align 8, !dbg !1317
  store i8* %10, i8** %8, align 8, !dbg !1316
  br label %11, !dbg !1318

11:                                               ; preds = %15, %3
  %12 = load i64, i64* %6, align 8, !dbg !1319
  %13 = add i64 %12, -1, !dbg !1319
  store i64 %13, i64* %6, align 8, !dbg !1319
  %14 = icmp ugt i64 %12, 0, !dbg !1320
  br i1 %14, label %15, label %21, !dbg !1318

15:                                               ; preds = %11
  %16 = load i8*, i8** %8, align 8, !dbg !1321
  %17 = getelementptr inbounds i8, i8* %16, i32 1, !dbg !1321
  store i8* %17, i8** %8, align 8, !dbg !1321
  %18 = load i8, i8* %16, align 1, !dbg !1322
  %19 = load i8*, i8** %7, align 8, !dbg !1323
  %20 = getelementptr inbounds i8, i8* %19, i32 1, !dbg !1323
  store i8* %20, i8** %7, align 8, !dbg !1323
  store i8 %18, i8* %19, align 1, !dbg !1324
  br label %11, !dbg !1318, !llvm.loop !1325

21:                                               ; preds = %11
  %22 = load i8*, i8** %4, align 8, !dbg !1326
  ret i8* %22, !dbg !1327
}
...
!3 = !DIFile(filename: "Demo1_Bob.c", directory: "/home/hira/Research/HARDEN/repositories/HARDEN_demo1/edk2/EmulatorPkg/Demo1_Bob", checksumkind: CSK_MD5, checksum: "9e3b1724f9f07ceebcc878e197f7a39f")
!4 = !{!5, !13, !20, !38, !43, !46}
...
!1270 = !DILocalVariable(name: "dest", scope: !1265, file: !3, line: 371, type: !52)
!1271 = !DILocation(line: 371, column: 9, scope: !1265)
!1272 = !DILocalVariable(name: "size", scope: !1265, file: !3, line: 372, type: !70)
!1273 = !DILocation(line: 372, column: 9, scope: !1265)
!1274 = !DILocalVariable(name: "addr", scope: !1265, file: !3, line: 373, type: !52)
!1275 = !DILocation(line: 373, column: 9, scope: !1265)
!1276 = !DILocation(line: 373, column: 15, scope: !1265)
!1277 = !DILocation(line: 374, column: 22, scope: !1265)
!1278 = !DILocation(line: 374, column: 3, scope: !1265)
!1279 = !DILocation(line: 379, column: 27, scope: !1280)
!1280 = distinct !DILexicalBlock(scope: !1265, file: !3, line: 379, column: 6)
!1281 = !DILocation(line: 379, column: 40, scope: !1280)
!1282 = !DILocation(line: 379, column: 71, scope: !1280)
!1283 = !DILocation(line: 379, column: 6, scope: !1280)
!1284 = !DILocation(line: 379, column: 77, scope: !1280)
!1285 = !DILocation(line: 379, column: 6, scope: !1265)
!1286 = !DILocation(line: 380, column: 5, scope: !1287)
!1287 = distinct !DILexicalBlock(scope: !1280, file: !3, line: 379, column: 92)
!1288 = !DILocation(line: 381, column: 3, scope: !1287)
!1289 = !DILocation(line: 382, column: 1, scope: !1265)
!1290 = distinct !DISubprogram(name: "main", scope: !3, file: !3, line: 385, type: !1291, scopeLine: 385, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !707)
!1291 = !DISubroutineType(types: !1292)
!1292 = !{!189}
!1293 = !DILocation(line: 386, column: 3, scope: !1290)
!1294 = !DILocation(line: 387, column: 3, scope: !1290)
!1295 = distinct !DISubprogram(name: "memcpy", scope: !1296, file: !1296, line: 12, type: !1297, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !696, retainedNodes: !707)
!1296 = !DIFile(filename: "klee/runtime/Freestanding/memcpy.c", directory: "/home/hira/Research", checksumkind: CSK_MD5, checksum: "8fb9a7164e167db005d7d002570068bc")
!1297 = !DISubroutineType(types: !1298)
!1298 = !{!52, !52, !598, !1299}
!1299 = !DIDerivedType(tag: DW_TAG_typedef, name: "size_t", file: !1300, line: 46, baseType: !1301)
!1300 = !DIFile(filename: "/usr/lib/llvm-14/lib/clang/14.0.6/include/stddef.h", directory: "", checksumkind: CSK_MD5, checksum: "2499dd2361b915724b073282bea3a7bc")
!1301 = !DIBasicType(name: "unsigned long", size: 64, encoding: DW_ATE_unsigned)
!1302 = !DILocalVariable(name: "destaddr", arg: 1, scope: !1295, file: !1296, line: 12, type: !52)
!1303 = !DILocation(line: 12, column: 20, scope: !1295)
!1304 = !DILocalVariable(name: "srcaddr", arg: 2, scope: !1295, file: !1296, line: 12, type: !598)
!1305 = !DILocation(line: 12, column: 42, scope: !1295)
!1306 = !DILocalVariable(name: "len", arg: 3, scope: !1295, file: !1296, line: 12, type: !1299)
!1307 = !DILocation(line: 12, column: 58, scope: !1295)
!1308 = !DILocalVariable(name: "dest", scope: !1295, file: !1296, line: 13, type: !1309)
!1309 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1310, size: 64)
!1310 = !DIBasicType(name: "char", size: 8, encoding: DW_ATE_signed_char)
!1311 = !DILocation(line: 13, column: 9, scope: !1295)
!1312 = !DILocation(line: 13, column: 16, scope: !1295)
!1313 = !DILocalVariable(name: "src", scope: !1295, file: !1296, line: 14, type: !1314)
!1314 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1315, size: 64)
!1315 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1310)
!1316 = !DILocation(line: 14, column: 15, scope: !1295)
!1317 = !DILocation(line: 14, column: 21, scope: !1295)
!1318 = !DILocation(line: 16, column: 3, scope: !1295)
!1319 = !DILocation(line: 16, column: 13, scope: !1295)
!1320 = !DILocation(line: 16, column: 16, scope: !1295)
!1321 = !DILocation(line: 17, column: 19, scope: !1295)
!1322 = !DILocation(line: 17, column: 15, scope: !1295)
!1323 = !DILocation(line: 17, column: 10, scope: !1295)
!1324 = !DILocation(line: 17, column: 13, scope: !1295)
!1325 = distinct !{!1325, !1318, !1321, !844}
!1326 = !DILocation(line: 18, column: 10, scope: !1295)
!1327 = !DILocation(line: 18, column: 3, scope: !1295)
