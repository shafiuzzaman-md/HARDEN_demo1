...
@.str.14 = private unnamed_addr constant [81 x i8] c"Demo1BobDataProvider(NULL, (VOID *)address, (VOID **)&dest, size) != EFI_SUCCESS\00", align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define hidden void @read_through_Demo1BobDataProvider(i8* noundef %0) #0 !dbg !1311 {
  %2 = alloca i8*, align 8
  %3 = alloca i64, align 8
  %4 = alloca i64, align 8
  %5 = alloca %struct._DEMO1_ACCESS_KEY*, align 8
  store i8* %0, i8** %2, align 8
  call void @llvm.dbg.declare(metadata i8** %2, metadata !1314, metadata !DIExpression()), !dbg !1315
  call void @llvm.dbg.declare(metadata i64* %3, metadata !1316, metadata !DIExpression()), !dbg !1317
  %6 = bitcast i64* %3 to i8*, !dbg !1318
  call void @klee_make_symbolic(i8* noundef %6, i64 noundef 8, i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str.12, i64 0, i64 0)), !dbg !1319
  call void @llvm.dbg.declare(metadata i64* %4, metadata !1320, metadata !DIExpression()), !dbg !1321
  store i64 16, i64* %4, align 8, !dbg !1321
  call void @llvm.dbg.declare(metadata %struct._DEMO1_ACCESS_KEY** %5, metadata !1322, metadata !DIExpression()), !dbg !1323
  %7 = call i8* @malloc(i64 noundef 16), !dbg !1324
  %8 = bitcast i8* %7 to %struct._DEMO1_ACCESS_KEY*, !dbg !1324
  store %struct._DEMO1_ACCESS_KEY* %8, %struct._DEMO1_ACCESS_KEY** %5, align 8, !dbg !1323
  %9 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %5, align 8, !dbg !1325
  %10 = bitcast %struct._DEMO1_ACCESS_KEY* %9 to i8*, !dbg !1325
  call void @klee_make_symbolic(i8* noundef %10, i64 noundef 16, i8* noundef getelementptr inbounds ([5 x i8], [5 x i8]* @.str.13, i64 0, i64 0)), !dbg !1326
  %11 = load i64, i64* %3, align 8, !dbg !1327
  %12 = inttoptr i64 %11 to i8*, !dbg !1327
  %13 = bitcast %struct._DEMO1_ACCESS_KEY** %5 to i8**, !dbg !1327
  %14 = load i64, i64* %4, align 8, !dbg !1327
  %15 = call i64 @Demo1BobDataProvider(%struct._Demo1_Bob_PROTOCOL* noundef null, i8* noundef %12, i8** noundef %13, i64 noundef %14), !dbg !1327
  %16 = icmp ne i64 %15, 0, !dbg !1327
  br i1 %16, label %17, label %18, !dbg !1327

17:                                               ; preds = %1
  br label %20, !dbg !1327

18:                                               ; preds = %1
  %19 = call i32 (i8*, i8*, i32, i8*, ...) bitcast (i32 (...)* @__assert_fail to i32 (i8*, i8*, i32, i8*, ...)*)(i8* noundef getelementptr inbounds ([81 x i8], [81 x i8]* @.str.14, i64 0, i64 0), i8* noundef getelementptr inbounds ([12 x i8], [12 x i8]* @.str.15, i64 0, i64 0), i32 noundef 385, i8* noundef getelementptr inbounds ([47 x i8], [47 x i8]* @__PRETTY_FUNCTION__.read_through_Demo1BobDataProvider, i64 0, i64 0)), !dbg !1327
  br label %20, !dbg !1327
...
; Function Attrs: noinline nounwind optnone uwtable
define hidden i32 @main() #0 !dbg !1329 {
  ...
  %3 = load i8*, i8** %2, align 8, !dbg !1334
  call void @read_through_Demo1BobDataProvider(i8* noundef %3), !dbg !1335
  ret i32 0, !dbg !1336
}

; Function Attrs: noinline nounwind uwtable
define dso_local i8* @memcpy(i8* noundef %0, i8* noundef %1, i64 noundef %2) #5 !dbg !1337 {
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
  %6 = alloca i64, align 8
  %7 = alloca i8*, align 8
  %8 = alloca i8*, align 8
  store i8* %0, i8** %4, align 8
  call void @llvm.dbg.declare(metadata i8** %4, metadata !1341, metadata !DIExpression()), !dbg !1342
  store i8* %1, i8** %5, align 8
  call void @llvm.dbg.declare(metadata i8** %5, metadata !1343, metadata !DIExpression()), !dbg !1344
  store i64 %2, i64* %6, align 8
  call void @llvm.dbg.declare(metadata i64* %6, metadata !1345, metadata !DIExpression()), !dbg !1346
  call void @llvm.dbg.declare(metadata i8** %7, metadata !1347, metadata !DIExpression()), !dbg !1350
  %9 = load i8*, i8** %4, align 8, !dbg !1351
  store i8* %9, i8** %7, align 8, !dbg !1350
  call void @llvm.dbg.declare(metadata i8** %8, metadata !1352, metadata !DIExpression()), !dbg !1355
  %10 = load i8*, i8** %5, align 8, !dbg !1356
  store i8* %10, i8** %8, align 8, !dbg !1355
  br label %11, !dbg !1357

11:                                               ; preds = %15, %3
  %12 = load i64, i64* %6, align 8, !dbg !1358
  %13 = add i64 %12, -1, !dbg !1358
  store i64 %13, i64* %6, align 8, !dbg !1358
  %14 = icmp ugt i64 %12, 0, !dbg !1359
  br i1 %14, label %15, label %21, !dbg !1357

15:                                               ; preds = %11
  %16 = load i8*, i8** %8, align 8, !dbg !1360
  %17 = getelementptr inbounds i8, i8* %16, i32 1, !dbg !1360
  store i8* %17, i8** %8, align 8, !dbg !1360
  %18 = load i8, i8* %16, align 1, !dbg !1361
  %19 = load i8*, i8** %7, align 8, !dbg !1362
  %20 = getelementptr inbounds i8, i8* %19, i32 1, !dbg !1362
  store i8* %20, i8** %7, align 8, !dbg !1362
  store i8 %18, i8* %19, align 1, !dbg !1363
  br label %11, !dbg !1357, !llvm.loop !1364

21:                                               ; preds = %11
  %22 = load i8*, i8** %4, align 8, !dbg !1365
  ret i8* %22, !dbg !1366
}
...
!3 = !DIFile(filename: "Demo1_Bob.c", directory: "/home/hira/Research/HARDEN/repositories/HARDEN_demo1/edk2/EmulatorPkg/Demo1_Bob", checksumkind: CSK_MD5, checksum: "c7e1447afa403f17611592937a71d5e1")
!4 = !{!5, !13, !20, !38, !43, !46}
...
!1311 = distinct !DISubprogram(name: "read_through_Demo1BobDataProvider", scope: !3, file: !3, line: 379, type: !1312, scopeLine: 379, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !714)
!1312 = !DISubroutineType(types: !1313)
!1313 = !{null, !52}
!1314 = !DILocalVariable(name: "search_address", arg: 1, scope: !1311, file: !3, line: 379, type: !52)
!1315 = !DILocation(line: 379, column: 46, scope: !1311)
!1316 = !DILocalVariable(name: "address", scope: !1311, file: !3, line: 380, type: !70)
!1317 = !DILocation(line: 380, column: 11, scope: !1311)
!1318 = !DILocation(line: 381, column: 24, scope: !1311)
!1319 = !DILocation(line: 381, column: 5, scope: !1311)
!1320 = !DILocalVariable(name: "size", scope: !1311, file: !3, line: 382, type: !70)
!1321 = !DILocation(line: 382, column: 11, scope: !1311)
!1322 = !DILocalVariable(name: "dest", scope: !1311, file: !3, line: 383, type: !310)
!1323 = !DILocation(line: 383, column: 23, scope: !1311)
!1324 = !DILocation(line: 383, column: 29, scope: !1311)
!1325 = !DILocation(line: 384, column: 24, scope: !1311)
!1326 = !DILocation(line: 384, column: 5, scope: !1311)
!1327 = !DILocation(line: 385, column: 5, scope: !1311)
!1328 = !DILocation(line: 386, column: 1, scope: !1311)
!1329 = distinct !DISubprogram(name: "main", scope: !3, file: !3, line: 388, type: !1330, scopeLine: 389, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !714)
!1330 = !DISubroutineType(types: !1331)
!1331 = !{!196}
!1332 = !DILocalVariable(name: "search_address", scope: !1329, file: !3, line: 390, type: !52)
!1333 = !DILocation(line: 390, column: 9, scope: !1329)
!1334 = !DILocation(line: 391, column: 37, scope: !1329)
!1335 = !DILocation(line: 391, column: 3, scope: !1329)
!1336 = !DILocation(line: 392, column: 3, scope: !1329)
!1337 = distinct !DISubprogram(name: "memcpy", scope: !1338, file: !1338, line: 12, type: !1339, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !703, retainedNodes: !714)
!1338 = !DIFile(filename: "klee/runtime/Freestanding/memcpy.c", directory: "/home/hira/Research", checksumkind: CSK_MD5, checksum: "8fb9a7164e167db005d7d002570068bc")
!1339 = !DISubroutineType(types: !1340)
!1340 = !{!52, !52, !605, !1275}
!1341 = !DILocalVariable(name: "destaddr", arg: 1, scope: !1337, file: !1338, line: 12, type: !52)
!1342 = !DILocation(line: 12, column: 20, scope: !1337)
!1343 = !DILocalVariable(name: "srcaddr", arg: 2, scope: !1337, file: !1338, line: 12, type: !605)
!1344 = !DILocation(line: 12, column: 42, scope: !1337)
!1345 = !DILocalVariable(name: "len", arg: 3, scope: !1337, file: !1338, line: 12, type: !1275)
!1346 = !DILocation(line: 12, column: 58, scope: !1337)
!1347 = !DILocalVariable(name: "dest", scope: !1337, file: !1338, line: 13, type: !1348)
!1348 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1349, size: 64)
!1349 = !DIBasicType(name: "char", size: 8, encoding: DW_ATE_signed_char)
!1350 = !DILocation(line: 13, column: 9, scope: !1337)
!1351 = !DILocation(line: 13, column: 16, scope: !1337)
!1352 = !DILocalVariable(name: "src", scope: !1337, file: !1338, line: 14, type: !1353)
!1353 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1354, size: 64)
!1354 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1349)
!1355 = !DILocation(line: 14, column: 15, scope: !1337)
!1356 = !DILocation(line: 14, column: 21, scope: !1337)
!1357 = !DILocation(line: 16, column: 3, scope: !1337)
!1358 = !DILocation(line: 16, column: 13, scope: !1337)
!1359 = !DILocation(line: 16, column: 16, scope: !1337)
!1360 = !DILocation(line: 17, column: 19, scope: !1337)
!1361 = !DILocation(line: 17, column: 15, scope: !1337)
!1362 = !DILocation(line: 17, column: 10, scope: !1337)
!1363 = !DILocation(line: 17, column: 13, scope: !1337)
!1364 = distinct !{!1364, !1357, !1360, !851}
!1365 = !DILocation(line: 18, column: 10, scope: !1337)
!1366 = !DILocation(line: 18, column: 3, scope: !1337)
