...
@.str.13 = private unnamed_addr constant [81 x i8] c"Demo1BobDataProvider(NULL, (VOID *)&bobKey, (VOID **)&dest, size) != EFI_SUCCESS\00", align 1
...
define hidden void @read_bobkey_through_Demo1BobDataProvider() #0 !dbg !1265 {
  ...
  store i64 16, i64* %1, align 8, !dbg !1269
  call void @llvm.dbg.declare(metadata %struct._DEMO1_ACCESS_KEY** %2, metadata !1270, metadata !DIExpression()), !dbg !1271
  %3 = call i8* @malloc(i64 noundef 16), !dbg !1272
  %4 = bitcast i8* %3 to %struct._DEMO1_ACCESS_KEY*, !dbg !1272
  store %struct._DEMO1_ACCESS_KEY* %4, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1271
  %5 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1273
  %6 = bitcast %struct._DEMO1_ACCESS_KEY* %5 to i8*, !dbg !1273
  call void @klee_make_symbolic(i8* noundef %6, i64 noundef 16, i8* noundef getelementptr inbounds ([5 x i8], [5 x i8]* @.str.12, i64 0, i64 0)), !dbg !1274
  %7 = bitcast %struct._DEMO1_ACCESS_KEY** %2 to i8**, !dbg !1275
  %8 = load i64, i64* %1, align 8, !dbg !1275
  %9 = call i64 @Demo1BobDataProvider(%struct._Demo1_Bob_PROTOCOL* noundef null, i8* noundef bitcast (%struct._DEMO1_ACCESS_KEY* @bobKey to i8*), i8** noundef %7, i64 noundef %8), !dbg !1275
  %10 = icmp ne i64 %9, 0, !dbg !1275
  br i1 %10, label %11, label %12, !dbg !1275

11:                                               ; preds = %0
  br label %14, !dbg !1275

12:                                               ; preds = %0
  %13 = call i32 (i8*, i8*, i32, i8*, ...) bitcast (i32 (...)* @__assert_fail to i32 (i8*, i8*, i32, i8*, ...)*)(i8* noundef getelementptr inbounds ([81 x i8], [81 x i8]* @.str.13, i64 0, i64 0), i8* noundef getelementptr inbounds ([12 x i8], [12 x i8]* @.str.14, i64 0, i64 0), i32 noundef 373, i8* noundef getelementptr inbounds ([48 x i8], [48 x i8]* @__PRETTY_FUNCTION__.read_bobkey_through_Demo1BobDataProvider, i64 0, i64 0)), !dbg !1275
  br label %14, !dbg !1275
...
; Function Attrs: noinline nounwind optnone uwtable
define hidden i32 @main() #0 !dbg !1277 {
  %1 = alloca i32, align 4
  store i32 0, i32* %1, align 4
  call void @read_bobkey_through_Demo1BobDataProvider(), !dbg !1280
  ret i32 0, !dbg !1281
}

; Function Attrs: noinline nounwind uwtable
define dso_local i8* @memcpy(i8* noundef %0, i8* noundef %1, i64 noundef %2) #5 !dbg !1282 {
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
  %6 = alloca i64, align 8
  %7 = alloca i8*, align 8
  ...
  call void @llvm.dbg.declare(metadata i8** %7, metadata !1295, metadata !DIExpression()), !dbg !1298
  %9 = load i8*, i8** %4, align 8, !dbg !1299
  store i8* %9, i8** %7, align 8, !dbg !1298
  call void @llvm.dbg.declare(metadata i8** %8, metadata !1300, metadata !DIExpression()), !dbg !1303
  %10 = load i8*, i8** %5, align 8, !dbg !1304
  store i8* %10, i8** %8, align 8, !dbg !1303
  br label %11, !dbg !1305

11:                                               ; preds = %15, %3
  %12 = load i64, i64* %6, align 8, !dbg !1306
  %13 = add i64 %12, -1, !dbg !1306
  store i64 %13, i64* %6, align 8, !dbg !1306
  %14 = icmp ugt i64 %12, 0, !dbg !1307
  br i1 %14, label %15, label %21, !dbg !1305

15:                                               ; preds = %11
  %16 = load i8*, i8** %8, align 8, !dbg !1308
  %17 = getelementptr inbounds i8, i8* %16, i32 1, !dbg !1308
  store i8* %17, i8** %8, align 8, !dbg !1308
  %18 = load i8, i8* %16, align 1, !dbg !1309
  %19 = load i8*, i8** %7, align 8, !dbg !1310
  %20 = getelementptr inbounds i8, i8* %19, i32 1, !dbg !1310
  store i8* %20, i8** %7, align 8, !dbg !1310
  store i8 %18, i8* %19, align 1, !dbg !1311
  br label %11, !dbg !1305, !llvm.loop !1312

21:                                               ; preds = %11
  %22 = load i8*, i8** %4, align 8, !dbg !1313
  ret i8* %22, !dbg !1314
}
...
!3 = !DIFile(filename: "Demo1_Bob.c", directory: "/home/hira/Research/HARDEN/repositories/HARDEN_demo1/edk2/EmulatorPkg/Demo1_Bob", checksumkind: CSK_MD5, checksum: "cbd99a099a7ac657631be0804f98739e")
!4 = !{!5, !13, !20, !38, !43, !46}
...
!1267 = !{null}
!1268 = !DILocalVariable(name: "size", scope: !1265, file: !3, line: 370, type: !70)
!1269 = !DILocation(line: 370, column: 11, scope: !1265)
!1270 = !DILocalVariable(name: "dest", scope: !1265, file: !3, line: 371, type: !303)
!1271 = !DILocation(line: 371, column: 23, scope: !1265)
!1272 = !DILocation(line: 371, column: 29, scope: !1265)
!1273 = !DILocation(line: 372, column: 24, scope: !1265)
!1274 = !DILocation(line: 372, column: 5, scope: !1265)
!1275 = !DILocation(line: 373, column: 5, scope: !1265)
!1276 = !DILocation(line: 374, column: 1, scope: !1265)
!1277 = distinct !DISubprogram(name: "main", scope: !3, file: !3, line: 376, type: !1278, scopeLine: 377, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !707)
!1278 = !DISubroutineType(types: !1279)
!1279 = !{!189}
!1280 = !DILocation(line: 378, column: 3, scope: !1277)
!1281 = !DILocation(line: 379, column: 3, scope: !1277)
!1282 = distinct !DISubprogram(name: "memcpy", scope: !1283, file: !1283, line: 12, type: !1284, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !696, retainedNodes: !707)
!1283 = !DIFile(filename: "klee/runtime/Freestanding/memcpy.c", directory: "/home/hira/Research", checksumkind: CSK_MD5, checksum: "8fb9a7164e167db005d7d002570068bc")
...
!1289 = !DILocalVariable(name: "destaddr", arg: 1, scope: !1282, file: !1283, line: 12, type: !52)
!1290 = !DILocation(line: 12, column: 20, scope: !1282)
!1291 = !DILocalVariable(name: "srcaddr", arg: 2, scope: !1282, file: !1283, line: 12, type: !598)
!1292 = !DILocation(line: 12, column: 42, scope: !1282)
!1293 = !DILocalVariable(name: "len", arg: 3, scope: !1282, file: !1283, line: 12, type: !1286)
!1294 = !DILocation(line: 12, column: 58, scope: !1282)
!1295 = !DILocalVariable(name: "dest", scope: !1282, file: !1283, line: 13, type: !1296)
!1296 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1297, size: 64)
!1297 = !DIBasicType(name: "char", size: 8, encoding: DW_ATE_signed_char)
!1298 = !DILocation(line: 13, column: 9, scope: !1282)
!1299 = !DILocation(line: 13, column: 16, scope: !1282)
!1300 = !DILocalVariable(name: "src", scope: !1282, file: !1283, line: 14, type: !1301)
!1301 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1302, size: 64)
!1302 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1297)
!1303 = !DILocation(line: 14, column: 15, scope: !1282)
!1304 = !DILocation(line: 14, column: 21, scope: !1282)
!1305 = !DILocation(line: 16, column: 3, scope: !1282)
!1306 = !DILocation(line: 16, column: 13, scope: !1282)
!1307 = !DILocation(line: 16, column: 16, scope: !1282)
!1308 = !DILocation(line: 17, column: 19, scope: !1282)
!1309 = !DILocation(line: 17, column: 15, scope: !1282)
!1310 = !DILocation(line: 17, column: 10, scope: !1282)
!1311 = !DILocation(line: 17, column: 13, scope: !1282)
!1312 = distinct !{!1312, !1305, !1308, !844}
!1313 = !DILocation(line: 18, column: 10, scope: !1282)
!1314 = !DILocation(line: 18, column: 3, scope: !1282)
