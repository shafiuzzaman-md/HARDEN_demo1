...
8:                                                ; preds = %0
  ...
  %10 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([16 x i8], [16 x i8]* @.str.12, i64 0, i64 0), i8* noundef %9), !dbg !1331
...
define hidden i32 @main() #0 !dbg !1334 {
  ...
  %3 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([20 x i8], [20 x i8]* @.str.13, i64 0, i64 0), %struct._DEMO1_ACCESS_KEY* noundef @bobKey), !dbg !1339
  ...
  %16 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str.14, i64 0, i64 0), i64 noundef %15), !dbg !1350
...
!3 = !DIFile(filename: "Demo1_Bob.c", directory: "/home/hira/Research/HARDEN/repositories/HARDEN_demo1/edk2/EmulatorPkg/Demo1_Bob", checksumkind: CSK_MD5, checksum: "a84ef079024afce2e4d83edc10dd2200")
!4 = !{!5, !13, !20, !38, !43, !46}
...
!1354 = !DILocation(line: 411, column: 59, scope: !1334)
!1355 = !DILocation(line: 411, column: 51, scope: !1334)
!1356 = !DILocation(line: 411, column: 3, scope: !1334)
!1357 = !DILocation(line: 412, column: 3, scope: !1334)
!1358 = !DILocation(line: 413, column: 3, scope: !1334)
...
!1367 = !DILocalVariable(name: "len", arg: 3, scope: !1359, file: !1360, line: 12, type: !1278)
