...
@.str.12 = private unnamed_addr constant [16 x i8] c"Dest value: %p\0A\00", align 1
...
define hidden i32 @main() #0 !dbg !1334 {
  ...
  %24 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([37 x i8], [37 x i8]* @.str.17, i64 0, i64 0), i8* noundef %23), !dbg !1356
...
!3 = !DIFile(filename: "Demo1_Bob.c", directory: "/home/hira/Research/HARDEN/repositories/HARDEN_demo1/edk2/EmulatorPkg/Demo1_Bob", checksumkind: CSK_MD5, checksum: "dd1a074e824de7ea52da8e9de1a91f8f")
!4 = !{!5, !13, !20, !38, !43, !46}
