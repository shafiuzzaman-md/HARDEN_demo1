...
13:                                               ; preds = %0
  ...
  call void (i8*, ...) @klee_print_expr(i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str.13, i64 0, i64 0), i64 noundef %17), !dbg !1286
  %18 = call i32 (i8*, i8*, i32, i8*, ...) bitcast (i32 (...)* @__assert_fail to i32 (i8*, i8*, i32, i8*, ...)*)(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str.14, i64 0, i64 0), i8* noundef getelementptr inbounds ([12 x i8], [12 x i8]* @.str.15, i64 0, i64 0), i32 noundef 379, i8* noundef getelementptr inbounds ([11 x i8], [11 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)), !dbg !1287
...
!3 = !DIFile(filename: "Demo1_Bob.c", directory: "/home/hira/Research/HARDEN/repositories/HARDEN_demo1/edk2/EmulatorPkg/Demo1_Bob", checksumkind: CSK_MD5, checksum: "5c007545f71079cce48c5a7f64e9eebf")
!4 = !{!5, !13, !20, !38, !43, !46}
...
!1285 = !DILocation(line: 376, column: 40, scope: !1284)
!1286 = !DILocation(line: 376, column: 7, scope: !1284)
!1287 = !DILocation(line: 379, column: 7, scope: !1284)
!1288 = !DILocation(line: 380, column: 5, scope: !1284)
!1289 = !DILocation(line: 383, column: 3, scope: !1265)
