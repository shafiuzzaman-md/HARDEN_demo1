...
@.str.12 = private unnamed_addr constant [19 x i8] c"Address value: %x\0A\00", align 1
@.str.13 = private unnamed_addr constant [19 x i8] c"Storage value: %x\0A\00", align 1
@.str.14 = private unnamed_addr constant [16 x i8] c"Dest value: %x\0A\00", align 1
@.str.15 = private unnamed_addr constant [10 x i8] c"data: %x\0A\00", align 1
@.str.16 = private unnamed_addr constant [20 x i8] c"bobkey address: %p\0A\00", align 1
@.str.17 = private unnamed_addr constant [22 x i8] c"Rand part bobkey: %x\0A\00", align 1
@.str.18 = private unnamed_addr constant [22 x i8] c"key magic bobkey: %x\0A\00", align 1
@.str.19 = private unnamed_addr constant [24 x i8] c"value Accesskeyptr: %x\0A\00", align 1
@.str.20 = private unnamed_addr constant [37 x i8] c"Address where bobkey is written: %p\0A\00", align 1
...
41:                                               ; preds = %31
  ...
  br label %60, !dbg !1084

42:                                               ; preds = %31
  %43 = load i8*, i8** %12, align 8, !dbg !1086
  %44 = icmp eq i8* %43, null, !dbg !1088
  br i1 %44, label %45, label %46, !dbg !1089

45:                                               ; preds = %42
  store i64 -9223372036854775806, i64* %5, align 8, !dbg !1090
  br label %60, !dbg !1090

46:                                               ; preds = %42
  %47 = load i8*, i8** %7, align 8, !dbg !1092
  %48 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([19 x i8], [19 x i8]* @.str.12, i64 0, i64 0), i8* noundef %47), !dbg !1093
  %49 = load i8*, i8** %12, align 8, !dbg !1094
  %50 = load i8*, i8** %7, align 8, !dbg !1095
  %51 = load i64, i64* %9, align 8, !dbg !1096
  %52 = call i8* @memcpy(i8* %49, i8* %50, i64 %51), !dbg !1097
  %53 = load i8*, i8** %12, align 8, !dbg !1098
  %54 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([19 x i8], [19 x i8]* @.str.13, i64 0, i64 0), i8* noundef %53), !dbg !1099
  %55 = load i8*, i8** %7, align 8, !dbg !1100
  %56 = load i8**, i8*** %8, align 8, !dbg !1101
  store i8* %55, i8** %56, align 8, !dbg !1102
  %57 = load i8**, i8*** %8, align 8, !dbg !1103
  %58 = load i8*, i8** %57, align 8, !dbg !1104
  %59 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([16 x i8], [16 x i8]* @.str.14, i64 0, i64 0), i8* noundef %58), !dbg !1105
  store i64 0, i64* %5, align 8, !dbg !1106
  br label %60, !dbg !1106

60:                                               ; preds = %46, %45, %41, %30, %25
  %61 = load i64, i64* %5, align 8, !dbg !1107
  ret i64 %61, !dbg !1107
}
...
define hidden void @read_bobkey_addr_through_Demo1BobDataProvider() #0 !dbg !1315 {
  ...
  %5 = call i8* @malloc(i64 noundef 16), !dbg !1320
  %6 = bitcast i8* %5 to %struct._DEMO1_ACCESS_KEY*, !dbg !1320
  store %struct._DEMO1_ACCESS_KEY* %6, %struct._DEMO1_ACCESS_KEY** %1, align 8, !dbg !1319
  call void @llvm.dbg.declare(metadata i8** %2, metadata !1321, metadata !DIExpression()), !dbg !1322
  store i8* bitcast (%struct._DEMO1_ACCESS_KEY* @bobKey to i8*), i8** %2, align 8, !dbg !1322
  call void @llvm.dbg.declare(metadata i8* %3, metadata !1323, metadata !DIExpression()), !dbg !1326
  call void @llvm.dbg.declare(metadata i64* %4, metadata !1327, metadata !DIExpression()), !dbg !1328
  store i64 8, i64* %4, align 8, !dbg !1328
  %7 = load i8*, i8** %2, align 8, !dbg !1329
  %8 = bitcast %struct._DEMO1_ACCESS_KEY** %1 to i8**, !dbg !1331
  %9 = load i64, i64* %4, align 8, !dbg !1332
  %10 = call i64 @Demo1BobDataProvider(%struct._Demo1_Bob_PROTOCOL* noundef null, i8* noundef %7, i8** noundef %8, i64 noundef %9), !dbg !1333
  %11 = icmp ne i64 %10, 0, !dbg !1334
  br i1 %11, label %12, label %15, !dbg !1335

12:                                               ; preds = %0
  %13 = bitcast %struct._DEMO1_ACCESS_KEY** %1 to i8*, !dbg !1336
  %14 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([10 x i8], [10 x i8]* @.str.15, i64 0, i64 0), i8* noundef %13), !dbg !1338
  br label %15, !dbg !1339
...
; Function Attrs: noinline nounwind optnone uwtable
define hidden i32 @main() #0 !dbg !1341 {
  %1 = alloca i32, align 4
  %2 = alloca %struct._DEMO1_ACCESS_KEY*, align 8
  store i32 0, i32* %1, align 4
  call void @llvm.dbg.declare(metadata %struct._DEMO1_ACCESS_KEY** %2, metadata !1344, metadata !DIExpression()), !dbg !1345
  %3 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([20 x i8], [20 x i8]* @.str.16, i64 0, i64 0), %struct._DEMO1_ACCESS_KEY* noundef @bobKey), !dbg !1346
  store %struct._DEMO1_ACCESS_KEY* @bobKey, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1347
  %4 = call i32 (...) @rand(), !dbg !1348
  %5 = sext i32 %4 to i64, !dbg !1348
  %6 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1349
  %7 = getelementptr inbounds %struct._DEMO1_ACCESS_KEY, %struct._DEMO1_ACCESS_KEY* %6, i32 0, i32 0, !dbg !1350
  %8 = getelementptr inbounds [2 x i64], [2 x i64]* %7, i64 0, i64 0, !dbg !1349
  store i64 %5, i64* %8, align 8, !dbg !1351
  %9 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1352
  %10 = getelementptr inbounds %struct._DEMO1_ACCESS_KEY, %struct._DEMO1_ACCESS_KEY* %9, i32 0, i32 0, !dbg !1353
  %11 = getelementptr inbounds [2 x i64], [2 x i64]* %10, i64 0, i64 1, !dbg !1352
  store i64 -2395670108176482799, i64* %11, align 8, !dbg !1354
  %12 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1355
  %13 = getelementptr inbounds %struct._DEMO1_ACCESS_KEY, %struct._DEMO1_ACCESS_KEY* %12, i32 0, i32 0, !dbg !1356
  %14 = getelementptr inbounds [2 x i64], [2 x i64]* %13, i64 0, i64 0, !dbg !1355
  %15 = load i64, i64* %14, align 8, !dbg !1355
  %16 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str.17, i64 0, i64 0), i64 noundef %15), !dbg !1357
  %17 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1358
  %18 = getelementptr inbounds %struct._DEMO1_ACCESS_KEY, %struct._DEMO1_ACCESS_KEY* %17, i32 0, i32 0, !dbg !1359
  %19 = getelementptr inbounds [2 x i64], [2 x i64]* %18, i64 0, i64 1, !dbg !1358
  %20 = load i64, i64* %19, align 8, !dbg !1358
  %21 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str.18, i64 0, i64 0), i64 noundef %20), !dbg !1360
  %22 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1361
  %23 = bitcast %struct._DEMO1_ACCESS_KEY* %22 to i8*, !dbg !1362
  %24 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([24 x i8], [24 x i8]* @.str.19, i64 0, i64 0), i8* noundef %23), !dbg !1363
  %25 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1364
  %26 = bitcast %struct._DEMO1_ACCESS_KEY* %25 to i8*, !dbg !1365
  %27 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([37 x i8], [37 x i8]* @.str.20, i64 0, i64 0), i8* noundef %26), !dbg !1366
  call void @read_bobkey_addr_through_Demo1BobDataProvider(), !dbg !1367
  ret i32 0, !dbg !1368
}
...
define dso_local i8* @memcpy(i8* noundef %0, i8* noundef %1, i64 noundef %2) #4 !dbg !1369 {
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
  %6 = alloca i64, align 8
  %7 = alloca i8*, align 8
  %8 = alloca i8*, align 8
  store i8* %0, i8** %4, align 8
  call void @llvm.dbg.declare(metadata i8** %4, metadata !1373, metadata !DIExpression()), !dbg !1374
  store i8* %1, i8** %5, align 8
  call void @llvm.dbg.declare(metadata i8** %5, metadata !1375, metadata !DIExpression()), !dbg !1376
  store i64 %2, i64* %6, align 8
  call void @llvm.dbg.declare(metadata i64* %6, metadata !1377, metadata !DIExpression()), !dbg !1378
  call void @llvm.dbg.declare(metadata i8** %7, metadata !1379, metadata !DIExpression()), !dbg !1381
  %9 = load i8*, i8** %4, align 8, !dbg !1382
  store i8* %9, i8** %7, align 8, !dbg !1381
  call void @llvm.dbg.declare(metadata i8** %8, metadata !1383, metadata !DIExpression()), !dbg !1386
  %10 = load i8*, i8** %5, align 8, !dbg !1387
  store i8* %10, i8** %8, align 8, !dbg !1386
  br label %11, !dbg !1388

11:                                               ; preds = %15, %3
  %12 = load i64, i64* %6, align 8, !dbg !1389
  %13 = add i64 %12, -1, !dbg !1389
  store i64 %13, i64* %6, align 8, !dbg !1389
  %14 = icmp ugt i64 %12, 0, !dbg !1390
  br i1 %14, label %15, label %21, !dbg !1388

15:                                               ; preds = %11
  %16 = load i8*, i8** %8, align 8, !dbg !1391
  %17 = getelementptr inbounds i8, i8* %16, i32 1, !dbg !1391
  store i8* %17, i8** %8, align 8, !dbg !1391
  %18 = load i8, i8* %16, align 1, !dbg !1392
  %19 = load i8*, i8** %7, align 8, !dbg !1393
  %20 = getelementptr inbounds i8, i8* %19, i32 1, !dbg !1393
  store i8* %20, i8** %7, align 8, !dbg !1393
  store i8 %18, i8* %19, align 1, !dbg !1394
  br label %11, !dbg !1388, !llvm.loop !1395

21:                                               ; preds = %11
  %22 = load i8*, i8** %4, align 8, !dbg !1396
  ret i8* %22, !dbg !1397
}
...
!3 = !DIFile(filename: "Demo1_Bob.c", directory: "/home/hira/Research/HARDEN/repositories/HARDEN_demo1/edk2/EmulatorPkg/Demo1_Bob", checksumkind: CSK_MD5, checksum: "4b4736c04eabb4e59866e9428e9ea0d5")
!4 = !{!5, !13, !20, !38, !43, !46}
...
!1086 = !DILocation(line: 367, column: 8, scope: !1087)
!1087 = distinct !DILexicalBlock(scope: !1036, file: !3, line: 367, column: 8)
!1088 = !DILocation(line: 367, column: 16, scope: !1087)
!1089 = !DILocation(line: 367, column: 8, scope: !1036)
!1090 = !DILocation(line: 368, column: 5, scope: !1091)
!1091 = distinct !DILexicalBlock(scope: !1087, file: !3, line: 367, column: 26)
!1092 = !DILocation(line: 371, column: 35, scope: !1036)
!1093 = !DILocation(line: 371, column: 5, scope: !1036)
!1094 = !DILocation(line: 372, column: 11, scope: !1036)
!1095 = !DILocation(line: 372, column: 20, scope: !1036)
!1096 = !DILocation(line: 372, column: 29, scope: !1036)
!1097 = !DILocation(line: 372, column: 3, scope: !1036)
!1098 = !DILocation(line: 373, column: 34, scope: !1036)
!1099 = !DILocation(line: 373, column: 4, scope: !1036)
!1100 = !DILocation(line: 374, column: 11, scope: !1036)
!1101 = !DILocation(line: 374, column: 4, scope: !1036)
!1102 = !DILocation(line: 374, column: 9, scope: !1036)
!1103 = !DILocation(line: 375, column: 36, scope: !1036)
!1104 = !DILocation(line: 375, column: 35, scope: !1036)
!1105 = !DILocation(line: 375, column: 8, scope: !1036)
!1106 = !DILocation(line: 377, column: 3, scope: !1036)
!1107 = !DILocation(line: 378, column: 1, scope: !1036)
...
!1315 = distinct !DISubprogram(name: "read_bobkey_addr_through_Demo1BobDataProvider", scope: !3, file: !3, line: 380, type: !1316, scopeLine: 380, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !714)
!1316 = !DISubroutineType(types: !1317)
!1317 = !{null}
!1318 = !DILocalVariable(name: "data", scope: !1315, file: !3, line: 389, type: !310)
!1319 = !DILocation(line: 389, column: 23, scope: !1315)
!1320 = !DILocation(line: 389, column: 30, scope: !1315)
!1321 = !DILocalVariable(name: "searchValue", scope: !1315, file: !3, line: 391, type: !52)
!1322 = !DILocation(line: 391, column: 11, scope: !1315)
!1323 = !DILocalVariable(name: "readValue", scope: !1315, file: !3, line: 392, type: !1324)
!1324 = !DIDerivedType(tag: DW_TAG_typedef, name: "CHAR8", file: !54, line: 218, baseType: !1325)
!1325 = !DIBasicType(name: "char", size: 8, encoding: DW_ATE_signed_char)
!1326 = !DILocation(line: 392, column: 12, scope: !1315)
!1327 = !DILocalVariable(name: "size", scope: !1315, file: !3, line: 394, type: !70)
!1328 = !DILocation(line: 394, column: 11, scope: !1315)
!1329 = !DILocation(line: 395, column: 35, scope: !1330)
!1330 = distinct !DILexicalBlock(scope: !1315, file: !3, line: 395, column: 8)
!1331 = !DILocation(line: 395, column: 48, scope: !1330)
!1332 = !DILocation(line: 395, column: 64, scope: !1330)
!1333 = !DILocation(line: 395, column: 8, scope: !1330)
!1334 = !DILocation(line: 395, column: 70, scope: !1330)
!1335 = !DILocation(line: 395, column: 8, scope: !1315)
!1336 = !DILocation(line: 398, column: 29, scope: !1337)
!1337 = distinct !DILexicalBlock(scope: !1330, file: !3, line: 395, column: 85)
!1338 = !DILocation(line: 398, column: 8, scope: !1337)
!1339 = !DILocation(line: 401, column: 5, scope: !1337)
!1340 = !DILocation(line: 402, column: 1, scope: !1315)
!1341 = distinct !DISubprogram(name: "main", scope: !3, file: !3, line: 404, type: !1342, scopeLine: 405, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !714)
!1342 = !DISubroutineType(types: !1343)
!1343 = !{!196}
!1344 = !DILocalVariable(name: "AccessKeyPtr", scope: !1341, file: !3, line: 406, type: !310)
!1345 = !DILocation(line: 406, column: 23, scope: !1341)
!1346 = !DILocation(line: 407, column: 3, scope: !1341)
!1347 = !DILocation(line: 408, column: 16, scope: !1341)
!1348 = !DILocation(line: 410, column: 37, scope: !1341)
!1349 = !DILocation(line: 410, column: 3, scope: !1341)
!1350 = !DILocation(line: 410, column: 17, scope: !1341)
!1351 = !DILocation(line: 410, column: 36, scope: !1341)
!1352 = !DILocation(line: 411, column: 3, scope: !1341)
!1353 = !DILocation(line: 411, column: 17, scope: !1341)
!1354 = !DILocation(line: 411, column: 37, scope: !1341)
!1355 = !DILocation(line: 412, column: 36, scope: !1341)
!1356 = !DILocation(line: 412, column: 50, scope: !1341)
!1357 = !DILocation(line: 412, column: 3, scope: !1341)
!1358 = !DILocation(line: 413, column: 36, scope: !1341)
!1359 = !DILocation(line: 413, column: 50, scope: !1341)
!1360 = !DILocation(line: 413, column: 3, scope: !1341)
!1361 = !DILocation(line: 414, column: 46, scope: !1341)
!1362 = !DILocation(line: 414, column: 38, scope: !1341)
!1363 = !DILocation(line: 414, column: 3, scope: !1341)
!1364 = !DILocation(line: 415, column: 59, scope: !1341)
!1365 = !DILocation(line: 415, column: 51, scope: !1341)
!1366 = !DILocation(line: 415, column: 3, scope: !1341)
!1367 = !DILocation(line: 416, column: 3, scope: !1341)
!1368 = !DILocation(line: 417, column: 3, scope: !1341)
!1369 = distinct !DISubprogram(name: "memcpy", scope: !1370, file: !1370, line: 12, type: !1371, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !703, retainedNodes: !714)
!1370 = !DIFile(filename: "klee/runtime/Freestanding/memcpy.c", directory: "/home/hira/Research", checksumkind: CSK_MD5, checksum: "8fb9a7164e167db005d7d002570068bc")
!1371 = !DISubroutineType(types: !1372)
!1372 = !{!52, !52, !605, !1279}
!1373 = !DILocalVariable(name: "destaddr", arg: 1, scope: !1369, file: !1370, line: 12, type: !52)
!1374 = !DILocation(line: 12, column: 20, scope: !1369)
!1375 = !DILocalVariable(name: "srcaddr", arg: 2, scope: !1369, file: !1370, line: 12, type: !605)
!1376 = !DILocation(line: 12, column: 42, scope: !1369)
!1377 = !DILocalVariable(name: "len", arg: 3, scope: !1369, file: !1370, line: 12, type: !1279)
!1378 = !DILocation(line: 12, column: 58, scope: !1369)
!1379 = !DILocalVariable(name: "dest", scope: !1369, file: !1370, line: 13, type: !1380)
!1380 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1325, size: 64)
!1381 = !DILocation(line: 13, column: 9, scope: !1369)
!1382 = !DILocation(line: 13, column: 16, scope: !1369)
!1383 = !DILocalVariable(name: "src", scope: !1369, file: !1370, line: 14, type: !1384)
!1384 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1385, size: 64)
!1385 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1325)
!1386 = !DILocation(line: 14, column: 15, scope: !1369)
!1387 = !DILocation(line: 14, column: 21, scope: !1369)
!1388 = !DILocation(line: 16, column: 3, scope: !1369)
!1389 = !DILocation(line: 16, column: 13, scope: !1369)
!1390 = !DILocation(line: 16, column: 16, scope: !1369)
!1391 = !DILocation(line: 17, column: 19, scope: !1369)
!1392 = !DILocation(line: 17, column: 15, scope: !1369)
!1393 = !DILocation(line: 17, column: 10, scope: !1369)
!1394 = !DILocation(line: 17, column: 13, scope: !1369)
!1395 = distinct !{!1395, !1388, !1391, !851}
!1396 = !DILocation(line: 18, column: 10, scope: !1369)
!1397 = !DILocation(line: 18, column: 3, scope: !1369)
