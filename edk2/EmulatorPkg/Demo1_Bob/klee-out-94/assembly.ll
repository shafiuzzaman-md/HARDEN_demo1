...
define hidden void @read_bobkey_addr_through_Demo1BobDataProvider() #0 !dbg !1314 {
  ...
  %4 = bitcast %struct._DEMO1_ACCESS_KEY** %2 to i8**, !dbg !1323
  %5 = load i64, i64* %1, align 8, !dbg !1325
  %6 = call i64 @Demo1BobDataProvider(%struct._Demo1_Bob_PROTOCOL* noundef null, i8* noundef bitcast (%struct._DEMO1_ACCESS_KEY* @bobKey to i8*), i8** noundef %4, i64 noundef %5), !dbg !1326
  %7 = icmp ne i64 %6, 0, !dbg !1327
  br i1 %7, label %8, label %11, !dbg !1328

8:                                                ; preds = %0
  %9 = bitcast %struct._DEMO1_ACCESS_KEY** %2 to i8*, !dbg !1329
  %10 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([16 x i8], [16 x i8]* @.str.13, i64 0, i64 0), i8* noundef %9), !dbg !1331
  br label %11, !dbg !1332
...
define hidden i32 @main() #0 !dbg !1334 {
  ...
  %16 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str.15, i64 0, i64 0), i64 noundef %15), !dbg !1350
  ...
  %21 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str.16, i64 0, i64 0), i64 noundef %20), !dbg !1353
  ...
  %24 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([24 x i8], [24 x i8]* @.str.17, i64 0, i64 0), i8* noundef %23), !dbg !1356
  %25 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1357
  %26 = bitcast %struct._DEMO1_ACCESS_KEY* %25 to i8*, !dbg !1358
  %27 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([37 x i8], [37 x i8]* @.str.18, i64 0, i64 0), i8* noundef %26), !dbg !1359
  call void @read_bobkey_addr_through_Demo1BobDataProvider(), !dbg !1360
  ret i32 0, !dbg !1361
}
...
define dso_local i8* @memcpy(i8* noundef %0, i8* noundef %1, i64 noundef %2) #4 !dbg !1362 {
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
  %6 = alloca i64, align 8
  %7 = alloca i8*, align 8
  %8 = alloca i8*, align 8
  store i8* %0, i8** %4, align 8
  call void @llvm.dbg.declare(metadata i8** %4, metadata !1366, metadata !DIExpression()), !dbg !1367
  store i8* %1, i8** %5, align 8
  call void @llvm.dbg.declare(metadata i8** %5, metadata !1368, metadata !DIExpression()), !dbg !1369
  store i64 %2, i64* %6, align 8
  call void @llvm.dbg.declare(metadata i64* %6, metadata !1370, metadata !DIExpression()), !dbg !1371
  call void @llvm.dbg.declare(metadata i8** %7, metadata !1372, metadata !DIExpression()), !dbg !1375
  %9 = load i8*, i8** %4, align 8, !dbg !1376
  store i8* %9, i8** %7, align 8, !dbg !1375
  call void @llvm.dbg.declare(metadata i8** %8, metadata !1377, metadata !DIExpression()), !dbg !1380
  %10 = load i8*, i8** %5, align 8, !dbg !1381
  store i8* %10, i8** %8, align 8, !dbg !1380
  br label %11, !dbg !1382

11:                                               ; preds = %15, %3
  %12 = load i64, i64* %6, align 8, !dbg !1383
  %13 = add i64 %12, -1, !dbg !1383
  store i64 %13, i64* %6, align 8, !dbg !1383
  %14 = icmp ugt i64 %12, 0, !dbg !1384
  br i1 %14, label %15, label %21, !dbg !1382

15:                                               ; preds = %11
  %16 = load i8*, i8** %8, align 8, !dbg !1385
  %17 = getelementptr inbounds i8, i8* %16, i32 1, !dbg !1385
  store i8* %17, i8** %8, align 8, !dbg !1385
  %18 = load i8, i8* %16, align 1, !dbg !1386
  %19 = load i8*, i8** %7, align 8, !dbg !1387
  %20 = getelementptr inbounds i8, i8* %19, i32 1, !dbg !1387
  store i8* %20, i8** %7, align 8, !dbg !1387
  store i8 %18, i8* %19, align 1, !dbg !1388
  br label %11, !dbg !1382, !llvm.loop !1389

21:                                               ; preds = %11
  %22 = load i8*, i8** %4, align 8, !dbg !1390
  ret i8* %22, !dbg !1391
}
...
!3 = !DIFile(filename: "Demo1_Bob.c", directory: "/home/hira/Research/HARDEN/repositories/HARDEN_demo1/edk2/EmulatorPkg/Demo1_Bob", checksumkind: CSK_MD5, checksum: "59952833be011d7cc93ecc32d6d1e057")
!4 = !{!5, !13, !20, !38, !43, !46}
...
!1323 = !DILocation(line: 392, column: 52, scope: !1324)
!1324 = distinct !DILexicalBlock(scope: !1314, file: !3, line: 392, column: 8)
!1325 = !DILocation(line: 392, column: 68, scope: !1324)
!1326 = !DILocation(line: 392, column: 8, scope: !1324)
!1327 = !DILocation(line: 392, column: 74, scope: !1324)
!1328 = !DILocation(line: 392, column: 8, scope: !1314)
!1329 = !DILocation(line: 393, column: 35, scope: !1330)
!1330 = distinct !DILexicalBlock(scope: !1324, file: !3, line: 392, column: 89)
!1331 = !DILocation(line: 393, column: 8, scope: !1330)
!1332 = !DILocation(line: 397, column: 5, scope: !1330)
!1333 = !DILocation(line: 398, column: 1, scope: !1314)
!1334 = distinct !DISubprogram(name: "main", scope: !3, file: !3, line: 400, type: !1335, scopeLine: 401, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !714)
!1335 = !DISubroutineType(types: !1336)
!1336 = !{!196}
!1337 = !DILocalVariable(name: "AccessKeyPtr", scope: !1334, file: !3, line: 402, type: !310)
!1338 = !DILocation(line: 402, column: 23, scope: !1334)
!1339 = !DILocation(line: 403, column: 3, scope: !1334)
!1340 = !DILocation(line: 404, column: 16, scope: !1334)
!1341 = !DILocation(line: 406, column: 37, scope: !1334)
!1342 = !DILocation(line: 406, column: 3, scope: !1334)
!1343 = !DILocation(line: 406, column: 17, scope: !1334)
!1344 = !DILocation(line: 406, column: 36, scope: !1334)
!1345 = !DILocation(line: 407, column: 3, scope: !1334)
!1346 = !DILocation(line: 407, column: 17, scope: !1334)
!1347 = !DILocation(line: 407, column: 37, scope: !1334)
!1348 = !DILocation(line: 408, column: 36, scope: !1334)
!1349 = !DILocation(line: 408, column: 50, scope: !1334)
!1350 = !DILocation(line: 408, column: 3, scope: !1334)
!1351 = !DILocation(line: 409, column: 36, scope: !1334)
!1352 = !DILocation(line: 409, column: 50, scope: !1334)
!1353 = !DILocation(line: 409, column: 3, scope: !1334)
!1354 = !DILocation(line: 410, column: 46, scope: !1334)
!1355 = !DILocation(line: 410, column: 38, scope: !1334)
!1356 = !DILocation(line: 410, column: 3, scope: !1334)
!1357 = !DILocation(line: 411, column: 59, scope: !1334)
!1358 = !DILocation(line: 411, column: 51, scope: !1334)
!1359 = !DILocation(line: 411, column: 3, scope: !1334)
!1360 = !DILocation(line: 412, column: 3, scope: !1334)
!1361 = !DILocation(line: 413, column: 3, scope: !1334)
!1362 = distinct !DISubprogram(name: "memcpy", scope: !1363, file: !1363, line: 12, type: !1364, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !703, retainedNodes: !714)
!1363 = !DIFile(filename: "klee/runtime/Freestanding/memcpy.c", directory: "/home/hira/Research", checksumkind: CSK_MD5, checksum: "8fb9a7164e167db005d7d002570068bc")
!1364 = !DISubroutineType(types: !1365)
!1365 = !{!52, !52, !605, !1278}
!1366 = !DILocalVariable(name: "destaddr", arg: 1, scope: !1362, file: !1363, line: 12, type: !52)
!1367 = !DILocation(line: 12, column: 20, scope: !1362)
!1368 = !DILocalVariable(name: "srcaddr", arg: 2, scope: !1362, file: !1363, line: 12, type: !605)
!1369 = !DILocation(line: 12, column: 42, scope: !1362)
!1370 = !DILocalVariable(name: "len", arg: 3, scope: !1362, file: !1363, line: 12, type: !1278)
!1371 = !DILocation(line: 12, column: 58, scope: !1362)
!1372 = !DILocalVariable(name: "dest", scope: !1362, file: !1363, line: 13, type: !1373)
!1373 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1374, size: 64)
!1374 = !DIBasicType(name: "char", size: 8, encoding: DW_ATE_signed_char)
!1375 = !DILocation(line: 13, column: 9, scope: !1362)
!1376 = !DILocation(line: 13, column: 16, scope: !1362)
!1377 = !DILocalVariable(name: "src", scope: !1362, file: !1363, line: 14, type: !1378)
!1378 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1379, size: 64)
!1379 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1374)
!1380 = !DILocation(line: 14, column: 15, scope: !1362)
!1381 = !DILocation(line: 14, column: 21, scope: !1362)
!1382 = !DILocation(line: 16, column: 3, scope: !1362)
!1383 = !DILocation(line: 16, column: 13, scope: !1362)
!1384 = !DILocation(line: 16, column: 16, scope: !1362)
!1385 = !DILocation(line: 17, column: 19, scope: !1362)
!1386 = !DILocation(line: 17, column: 15, scope: !1362)
!1387 = !DILocation(line: 17, column: 10, scope: !1362)
!1388 = !DILocation(line: 17, column: 13, scope: !1362)
!1389 = distinct !{!1389, !1382, !1385, !851}
!1390 = !DILocation(line: 18, column: 10, scope: !1362)
!1391 = !DILocation(line: 18, column: 3, scope: !1362)
