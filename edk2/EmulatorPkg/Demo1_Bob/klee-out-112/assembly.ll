...
define hidden void @read_bobkey_addr_through_Demo1BobDataProvider() #0 !dbg !1318 {
  ...
  br i1 %9, label %10, label %16, !dbg !1337
...
10:                                               ; preds = %0
  ...
  %15 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str.15, i64 0, i64 0), i64 noundef %14), !dbg !1341
...
define hidden i32 @main() #0 !dbg !1344 {
  ...
  %16 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str.15, i64 0, i64 0), i64 noundef %15), !dbg !1360
  ...
  %21 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str.17, i64 0, i64 0), i64 noundef %20), !dbg !1363
  ...
  %24 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([24 x i8], [24 x i8]* @.str.18, i64 0, i64 0), i8* noundef %23), !dbg !1366
  ...
  %27 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([37 x i8], [37 x i8]* @.str.19, i64 0, i64 0), i8* noundef %26), !dbg !1369
...
!3 = !DIFile(filename: "Demo1_Bob.c", directory: "/home/hira/Research/HARDEN/repositories/HARDEN_demo1/edk2/EmulatorPkg/Demo1_Bob", checksumkind: CSK_MD5, checksum: "8acb6e4d2d48bdc6c7860ca42bdcb8ec")
!4 = !{!5, !13, !20, !38, !43, !46}
...
!1338 = !DILocation(line: 398, column: 41, scope: !1339)
!1339 = distinct !DILexicalBlock(scope: !1332, file: !3, line: 395, column: 85)
!1340 = !DILocation(line: 398, column: 47, scope: !1339)
!1341 = !DILocation(line: 398, column: 8, scope: !1339)
!1342 = !DILocation(line: 401, column: 5, scope: !1339)
...
!1383 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1327, size: 64)
...
!1388 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1327)
