...
@.str.13 = private unnamed_addr constant [16 x i8] c"dest != &bobKey\00", align 1
...
define hidden void @read_bobkey_through_Demo1BobDataProvider() #0 !dbg !1265 {
  ...
  %3 = alloca i64, align 8
  %4 = alloca i8*, align 8
  call void @llvm.dbg.declare(metadata %struct._Demo1_Bob_PROTOCOL** %1, metadata !1268, metadata !DIExpression()), !dbg !1269
  call void @llvm.dbg.declare(metadata %struct._DEMO1_ACCESS_KEY** %2, metadata !1270, metadata !DIExpression()), !dbg !1271
  %5 = call i8* @malloc(i64 noundef 16), !dbg !1272
  %6 = bitcast i8* %5 to %struct._DEMO1_ACCESS_KEY*, !dbg !1272
  store %struct._DEMO1_ACCESS_KEY* %6, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1271
  ...
  call void @llvm.dbg.declare(metadata i8** %4, metadata !1275, metadata !DIExpression()), !dbg !1276
  %7 = call i8* @malloc(i64 noundef 1), !dbg !1277
  store i8* %7, i8** %4, align 8, !dbg !1276
  %8 = load i8*, i8** %4, align 8, !dbg !1278
  call void @klee_make_symbolic(i8* noundef %8, i64 noundef 1, i8* noundef getelementptr inbounds ([5 x i8], [5 x i8]* @.str.12, i64 0, i64 0)), !dbg !1279
  %9 = load %struct._Demo1_Bob_PROTOCOL*, %struct._Demo1_Bob_PROTOCOL** %1, align 8, !dbg !1280
  %10 = load i8*, i8** %4, align 8, !dbg !1282
  %11 = bitcast %struct._DEMO1_ACCESS_KEY** %2 to i8**, !dbg !1283
  %12 = load i64, i64* %3, align 8, !dbg !1284
  %13 = call i64 @Demo1BobDataProvider(%struct._Demo1_Bob_PROTOCOL* noundef %9, i8* noundef %10, i8** noundef %11, i64 noundef %12), !dbg !1285
  %14 = icmp eq i64 %13, 0, !dbg !1286
  br i1 %14, label %15, label %22, !dbg !1287

15:                                               ; preds = %0
  %16 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1288
  %17 = icmp ne %struct._DEMO1_ACCESS_KEY* %16, @bobKey, !dbg !1288
...
19:                                               ; preds = %15
  %20 = call i32 (i8*, i8*, i32, i8*, ...) bitcast (i32 (...)* @__assert_fail to i32 (i8*, i8*, i32, i8*, ...)*)(i8* noundef getelementptr inbounds ([16 x i8], [16 x i8]* @.str.13, i64 0, i64 0), i8* noundef getelementptr inbounds ([12 x i8], [12 x i8]* @.str.14, i64 0, i64 0), i32 noundef 380, i8* noundef getelementptr inbounds ([48 x i8], [48 x i8]* @__PRETTY_FUNCTION__.read_bobkey_through_Demo1BobDataProvider, i64 0, i64 0)), !dbg !1288
  br label %21, !dbg !1288

21:                                               ; preds = %19, %18
  br label %22, !dbg !1290
...
define dso_local i8* @memcpy(i8* noundef %0, i8* noundef %1, i64 noundef %2) #5 !dbg !1297 {
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
  %6 = alloca i64, align 8
  %7 = alloca i8*, align 8
  ...
  call void @llvm.dbg.declare(metadata i8** %5, metadata !1306, metadata !DIExpression()), !dbg !1307
  store i64 %2, i64* %6, align 8
  call void @llvm.dbg.declare(metadata i64* %6, metadata !1308, metadata !DIExpression()), !dbg !1309
  call void @llvm.dbg.declare(metadata i8** %7, metadata !1310, metadata !DIExpression()), !dbg !1313
  %9 = load i8*, i8** %4, align 8, !dbg !1314
  store i8* %9, i8** %7, align 8, !dbg !1313
  call void @llvm.dbg.declare(metadata i8** %8, metadata !1315, metadata !DIExpression()), !dbg !1318
  %10 = load i8*, i8** %5, align 8, !dbg !1319
  store i8* %10, i8** %8, align 8, !dbg !1318
  br label %11, !dbg !1320

11:                                               ; preds = %15, %3
  %12 = load i64, i64* %6, align 8, !dbg !1321
  %13 = add i64 %12, -1, !dbg !1321
  store i64 %13, i64* %6, align 8, !dbg !1321
  %14 = icmp ugt i64 %12, 0, !dbg !1322
  br i1 %14, label %15, label %21, !dbg !1320

15:                                               ; preds = %11
  %16 = load i8*, i8** %8, align 8, !dbg !1323
  %17 = getelementptr inbounds i8, i8* %16, i32 1, !dbg !1323
  store i8* %17, i8** %8, align 8, !dbg !1323
  %18 = load i8, i8* %16, align 1, !dbg !1324
  %19 = load i8*, i8** %7, align 8, !dbg !1325
  %20 = getelementptr inbounds i8, i8* %19, i32 1, !dbg !1325
  store i8* %20, i8** %7, align 8, !dbg !1325
  store i8 %18, i8* %19, align 1, !dbg !1326
  br label %11, !dbg !1320, !llvm.loop !1327

21:                                               ; preds = %11
  %22 = load i8*, i8** %4, align 8, !dbg !1328
  ret i8* %22, !dbg !1329
}
...
!3 = !DIFile(filename: "Demo1_Bob.c", directory: "/home/hira/Research/HARDEN/repositories/HARDEN_demo1/edk2/EmulatorPkg/Demo1_Bob", checksumkind: CSK_MD5, checksum: "247bdebba63163ac0859da66a5ff5969")
!4 = !{!5, !13, !20, !38, !43, !46}
...
!1265 = distinct !DISubprogram(name: "read_bobkey_through_Demo1BobDataProvider", scope: !3, file: !3, line: 368, type: !1266, scopeLine: 369, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !707)
!1266 = !DISubroutineType(types: !1267)
!1267 = !{null}
!1268 = !DILocalVariable(name: "BobProtocol", scope: !1265, file: !3, line: 370, type: !661)
!1269 = !DILocation(line: 370, column: 23, scope: !1265)
!1270 = !DILocalVariable(name: "dest", scope: !1265, file: !3, line: 371, type: !303)
!1271 = !DILocation(line: 371, column: 21, scope: !1265)
!1272 = !DILocation(line: 371, column: 27, scope: !1265)
!1273 = !DILocalVariable(name: "size", scope: !1265, file: !3, line: 372, type: !70)
!1274 = !DILocation(line: 372, column: 9, scope: !1265)
!1275 = !DILocalVariable(name: "addr", scope: !1265, file: !3, line: 373, type: !52)
!1276 = !DILocation(line: 373, column: 9, scope: !1265)
!1277 = !DILocation(line: 373, column: 15, scope: !1265)
!1278 = !DILocation(line: 374, column: 22, scope: !1265)
!1279 = !DILocation(line: 374, column: 3, scope: !1265)
!1280 = !DILocation(line: 379, column: 27, scope: !1281)
!1281 = distinct !DILexicalBlock(scope: !1265, file: !3, line: 379, column: 6)
!1282 = !DILocation(line: 379, column: 48, scope: !1281)
!1283 = !DILocation(line: 379, column: 54, scope: !1281)
!1284 = !DILocation(line: 379, column: 70, scope: !1281)
!1285 = !DILocation(line: 379, column: 6, scope: !1281)
!1286 = !DILocation(line: 379, column: 76, scope: !1281)
!1287 = !DILocation(line: 379, column: 6, scope: !1265)
!1288 = !DILocation(line: 380, column: 5, scope: !1289)
!1289 = distinct !DILexicalBlock(scope: !1281, file: !3, line: 379, column: 91)
!1290 = !DILocation(line: 381, column: 3, scope: !1289)
!1291 = !DILocation(line: 382, column: 1, scope: !1265)
!1292 = distinct !DISubprogram(name: "main", scope: !3, file: !3, line: 385, type: !1293, scopeLine: 385, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !707)
!1293 = !DISubroutineType(types: !1294)
!1294 = !{!189}
!1295 = !DILocation(line: 386, column: 3, scope: !1292)
!1296 = !DILocation(line: 387, column: 3, scope: !1292)
!1297 = distinct !DISubprogram(name: "memcpy", scope: !1298, file: !1298, line: 12, type: !1299, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !696, retainedNodes: !707)
!1298 = !DIFile(filename: "klee/runtime/Freestanding/memcpy.c", directory: "/home/hira/Research", checksumkind: CSK_MD5, checksum: "8fb9a7164e167db005d7d002570068bc")
...
!1304 = !DILocalVariable(name: "destaddr", arg: 1, scope: !1297, file: !1298, line: 12, type: !52)
!1305 = !DILocation(line: 12, column: 20, scope: !1297)
!1306 = !DILocalVariable(name: "srcaddr", arg: 2, scope: !1297, file: !1298, line: 12, type: !598)
!1307 = !DILocation(line: 12, column: 42, scope: !1297)
!1308 = !DILocalVariable(name: "len", arg: 3, scope: !1297, file: !1298, line: 12, type: !1301)
!1309 = !DILocation(line: 12, column: 58, scope: !1297)
!1310 = !DILocalVariable(name: "dest", scope: !1297, file: !1298, line: 13, type: !1311)
!1311 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1312, size: 64)
!1312 = !DIBasicType(name: "char", size: 8, encoding: DW_ATE_signed_char)
!1313 = !DILocation(line: 13, column: 9, scope: !1297)
!1314 = !DILocation(line: 13, column: 16, scope: !1297)
!1315 = !DILocalVariable(name: "src", scope: !1297, file: !1298, line: 14, type: !1316)
!1316 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1317, size: 64)
!1317 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1312)
!1318 = !DILocation(line: 14, column: 15, scope: !1297)
!1319 = !DILocation(line: 14, column: 21, scope: !1297)
!1320 = !DILocation(line: 16, column: 3, scope: !1297)
!1321 = !DILocation(line: 16, column: 13, scope: !1297)
!1322 = !DILocation(line: 16, column: 16, scope: !1297)
!1323 = !DILocation(line: 17, column: 19, scope: !1297)
!1324 = !DILocation(line: 17, column: 15, scope: !1297)
!1325 = !DILocation(line: 17, column: 10, scope: !1297)
!1326 = !DILocation(line: 17, column: 13, scope: !1297)
!1327 = distinct !{!1327, !1320, !1323, !844}
!1328 = !DILocation(line: 18, column: 10, scope: !1297)
!1329 = !DILocation(line: 18, column: 3, scope: !1297)
