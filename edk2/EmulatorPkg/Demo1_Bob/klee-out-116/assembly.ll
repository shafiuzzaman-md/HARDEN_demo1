...
define hidden void @read_bobkey_addr_through_Demo1BobDataProvider() #0 !dbg !1318 {
  ...
  call void @llvm.dbg.declare(metadata i8** %2, metadata !1323, metadata !DIExpression()), !dbg !1324
  store i8* bitcast (%struct._DEMO1_ACCESS_KEY* @bobKey to i8*), i8** %2, align 8, !dbg !1324
  call void @llvm.dbg.declare(metadata i8* %3, metadata !1325, metadata !DIExpression()), !dbg !1328
  call void @llvm.dbg.declare(metadata i64* %4, metadata !1329, metadata !DIExpression()), !dbg !1330
  store i64 8, i64* %4, align 8, !dbg !1330
  %5 = load i8*, i8** %2, align 8, !dbg !1331
  %6 = bitcast %struct._DEMO1_ACCESS_KEY** %1 to i8**, !dbg !1333
  %7 = load i64, i64* %4, align 8, !dbg !1334
  %8 = call i64 @Demo1BobDataProvider(%struct._Demo1_Bob_PROTOCOL* noundef null, i8* noundef %5, i8** noundef %6, i64 noundef %7), !dbg !1335
  %9 = icmp ne i64 %8, 0, !dbg !1336
  br i1 %9, label %10, label %13, !dbg !1337

10:                                               ; preds = %0
  %11 = bitcast %struct._DEMO1_ACCESS_KEY** %1 to i8*, !dbg !1338
  %12 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([10 x i8], [10 x i8]* @.str.15, i64 0, i64 0), i8* noundef %11), !dbg !1340
  br label %13, !dbg !1341
...
; Function Attrs: noinline nounwind optnone uwtable
define hidden i32 @main() #0 !dbg !1343 {
  %1 = alloca i32, align 4
  %2 = alloca %struct._DEMO1_ACCESS_KEY*, align 8
  store i32 0, i32* %1, align 4
  call void @llvm.dbg.declare(metadata %struct._DEMO1_ACCESS_KEY** %2, metadata !1346, metadata !DIExpression()), !dbg !1347
  %3 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([20 x i8], [20 x i8]* @.str.16, i64 0, i64 0), %struct._DEMO1_ACCESS_KEY* noundef @bobKey), !dbg !1348
  store %struct._DEMO1_ACCESS_KEY* @bobKey, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1349
  %4 = call i32 (...) @rand(), !dbg !1350
  %5 = sext i32 %4 to i64, !dbg !1350
  %6 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1351
  %7 = getelementptr inbounds %struct._DEMO1_ACCESS_KEY, %struct._DEMO1_ACCESS_KEY* %6, i32 0, i32 0, !dbg !1352
  %8 = getelementptr inbounds [2 x i64], [2 x i64]* %7, i64 0, i64 0, !dbg !1351
  store i64 %5, i64* %8, align 8, !dbg !1353
  %9 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1354
  %10 = getelementptr inbounds %struct._DEMO1_ACCESS_KEY, %struct._DEMO1_ACCESS_KEY* %9, i32 0, i32 0, !dbg !1355
  %11 = getelementptr inbounds [2 x i64], [2 x i64]* %10, i64 0, i64 1, !dbg !1354
  store i64 -2395670108176482799, i64* %11, align 8, !dbg !1356
  %12 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1357
  %13 = getelementptr inbounds %struct._DEMO1_ACCESS_KEY, %struct._DEMO1_ACCESS_KEY* %12, i32 0, i32 0, !dbg !1358
  %14 = getelementptr inbounds [2 x i64], [2 x i64]* %13, i64 0, i64 0, !dbg !1357
  %15 = load i64, i64* %14, align 8, !dbg !1357
  %16 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str.17, i64 0, i64 0), i64 noundef %15), !dbg !1359
  %17 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1360
  %18 = getelementptr inbounds %struct._DEMO1_ACCESS_KEY, %struct._DEMO1_ACCESS_KEY* %17, i32 0, i32 0, !dbg !1361
  %19 = getelementptr inbounds [2 x i64], [2 x i64]* %18, i64 0, i64 1, !dbg !1360
  %20 = load i64, i64* %19, align 8, !dbg !1360
  %21 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str.18, i64 0, i64 0), i64 noundef %20), !dbg !1362
  %22 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1363
  %23 = bitcast %struct._DEMO1_ACCESS_KEY* %22 to i8*, !dbg !1364
  %24 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([24 x i8], [24 x i8]* @.str.19, i64 0, i64 0), i8* noundef %23), !dbg !1365
  %25 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1366
  %26 = bitcast %struct._DEMO1_ACCESS_KEY* %25 to i8*, !dbg !1367
  %27 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([37 x i8], [37 x i8]* @.str.20, i64 0, i64 0), i8* noundef %26), !dbg !1368
  call void @read_bobkey_addr_through_Demo1BobDataProvider(), !dbg !1369
  ret i32 0, !dbg !1370
}
...
define dso_local i8* @memcpy(i8* noundef %0, i8* noundef %1, i64 noundef %2) #4 !dbg !1371 {
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
  %6 = alloca i64, align 8
  %7 = alloca i8*, align 8
  %8 = alloca i8*, align 8
  store i8* %0, i8** %4, align 8
  call void @llvm.dbg.declare(metadata i8** %4, metadata !1375, metadata !DIExpression()), !dbg !1376
  store i8* %1, i8** %5, align 8
  call void @llvm.dbg.declare(metadata i8** %5, metadata !1377, metadata !DIExpression()), !dbg !1378
  store i64 %2, i64* %6, align 8
  call void @llvm.dbg.declare(metadata i64* %6, metadata !1379, metadata !DIExpression()), !dbg !1380
  call void @llvm.dbg.declare(metadata i8** %7, metadata !1381, metadata !DIExpression()), !dbg !1383
  %9 = load i8*, i8** %4, align 8, !dbg !1384
  store i8* %9, i8** %7, align 8, !dbg !1383
  call void @llvm.dbg.declare(metadata i8** %8, metadata !1385, metadata !DIExpression()), !dbg !1388
  %10 = load i8*, i8** %5, align 8, !dbg !1389
  store i8* %10, i8** %8, align 8, !dbg !1388
  br label %11, !dbg !1390

11:                                               ; preds = %15, %3
  %12 = load i64, i64* %6, align 8, !dbg !1391
  %13 = add i64 %12, -1, !dbg !1391
  store i64 %13, i64* %6, align 8, !dbg !1391
  %14 = icmp ugt i64 %12, 0, !dbg !1392
  br i1 %14, label %15, label %21, !dbg !1390

15:                                               ; preds = %11
  %16 = load i8*, i8** %8, align 8, !dbg !1393
  %17 = getelementptr inbounds i8, i8* %16, i32 1, !dbg !1393
  store i8* %17, i8** %8, align 8, !dbg !1393
  %18 = load i8, i8* %16, align 1, !dbg !1394
  %19 = load i8*, i8** %7, align 8, !dbg !1395
  %20 = getelementptr inbounds i8, i8* %19, i32 1, !dbg !1395
  store i8* %20, i8** %7, align 8, !dbg !1395
  store i8 %18, i8* %19, align 1, !dbg !1396
  br label %11, !dbg !1390, !llvm.loop !1397

21:                                               ; preds = %11
  %22 = load i8*, i8** %4, align 8, !dbg !1398
  ret i8* %22, !dbg !1399
}
...
!3 = !DIFile(filename: "Demo1_Bob.c", directory: "/home/hira/Research/HARDEN/repositories/HARDEN_demo1/edk2/EmulatorPkg/Demo1_Bob", checksumkind: CSK_MD5, checksum: "5304ca5a5562b3f7bf4eb1372f1d02db")
!4 = !{!5, !13, !20, !38, !43, !46}
...
!1323 = !DILocalVariable(name: "searchValue", scope: !1318, file: !3, line: 391, type: !52)
!1324 = !DILocation(line: 391, column: 11, scope: !1318)
!1325 = !DILocalVariable(name: "readValue", scope: !1318, file: !3, line: 392, type: !1326)
...
!1328 = !DILocation(line: 392, column: 12, scope: !1318)
!1329 = !DILocalVariable(name: "size", scope: !1318, file: !3, line: 394, type: !70)
!1330 = !DILocation(line: 394, column: 11, scope: !1318)
!1331 = !DILocation(line: 395, column: 35, scope: !1332)
!1332 = distinct !DILexicalBlock(scope: !1318, file: !3, line: 395, column: 8)
!1333 = !DILocation(line: 395, column: 48, scope: !1332)
!1334 = !DILocation(line: 395, column: 64, scope: !1332)
!1335 = !DILocation(line: 395, column: 8, scope: !1332)
!1336 = !DILocation(line: 395, column: 70, scope: !1332)
!1337 = !DILocation(line: 395, column: 8, scope: !1318)
!1338 = !DILocation(line: 398, column: 29, scope: !1339)
!1339 = distinct !DILexicalBlock(scope: !1332, file: !3, line: 395, column: 85)
!1340 = !DILocation(line: 398, column: 8, scope: !1339)
!1341 = !DILocation(line: 401, column: 5, scope: !1339)
!1342 = !DILocation(line: 402, column: 1, scope: !1318)
!1343 = distinct !DISubprogram(name: "main", scope: !3, file: !3, line: 404, type: !1344, scopeLine: 405, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !714)
!1344 = !DISubroutineType(types: !1345)
!1345 = !{!196}
!1346 = !DILocalVariable(name: "AccessKeyPtr", scope: !1343, file: !3, line: 406, type: !310)
!1347 = !DILocation(line: 406, column: 23, scope: !1343)
!1348 = !DILocation(line: 407, column: 3, scope: !1343)
!1349 = !DILocation(line: 408, column: 16, scope: !1343)
!1350 = !DILocation(line: 410, column: 37, scope: !1343)
!1351 = !DILocation(line: 410, column: 3, scope: !1343)
!1352 = !DILocation(line: 410, column: 17, scope: !1343)
!1353 = !DILocation(line: 410, column: 36, scope: !1343)
!1354 = !DILocation(line: 411, column: 3, scope: !1343)
!1355 = !DILocation(line: 411, column: 17, scope: !1343)
!1356 = !DILocation(line: 411, column: 37, scope: !1343)
!1357 = !DILocation(line: 412, column: 36, scope: !1343)
!1358 = !DILocation(line: 412, column: 50, scope: !1343)
!1359 = !DILocation(line: 412, column: 3, scope: !1343)
!1360 = !DILocation(line: 413, column: 36, scope: !1343)
!1361 = !DILocation(line: 413, column: 50, scope: !1343)
!1362 = !DILocation(line: 413, column: 3, scope: !1343)
!1363 = !DILocation(line: 414, column: 46, scope: !1343)
!1364 = !DILocation(line: 414, column: 38, scope: !1343)
!1365 = !DILocation(line: 414, column: 3, scope: !1343)
!1366 = !DILocation(line: 415, column: 59, scope: !1343)
!1367 = !DILocation(line: 415, column: 51, scope: !1343)
!1368 = !DILocation(line: 415, column: 3, scope: !1343)
!1369 = !DILocation(line: 416, column: 3, scope: !1343)
!1370 = !DILocation(line: 417, column: 3, scope: !1343)
!1371 = distinct !DISubprogram(name: "memcpy", scope: !1372, file: !1372, line: 12, type: !1373, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !703, retainedNodes: !714)
!1372 = !DIFile(filename: "klee/runtime/Freestanding/memcpy.c", directory: "/home/hira/Research", checksumkind: CSK_MD5, checksum: "8fb9a7164e167db005d7d002570068bc")
!1373 = !DISubroutineType(types: !1374)
!1374 = !{!52, !52, !605, !1282}
!1375 = !DILocalVariable(name: "destaddr", arg: 1, scope: !1371, file: !1372, line: 12, type: !52)
!1376 = !DILocation(line: 12, column: 20, scope: !1371)
!1377 = !DILocalVariable(name: "srcaddr", arg: 2, scope: !1371, file: !1372, line: 12, type: !605)
!1378 = !DILocation(line: 12, column: 42, scope: !1371)
!1379 = !DILocalVariable(name: "len", arg: 3, scope: !1371, file: !1372, line: 12, type: !1282)
!1380 = !DILocation(line: 12, column: 58, scope: !1371)
!1381 = !DILocalVariable(name: "dest", scope: !1371, file: !1372, line: 13, type: !1382)
!1382 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1327, size: 64)
!1383 = !DILocation(line: 13, column: 9, scope: !1371)
!1384 = !DILocation(line: 13, column: 16, scope: !1371)
!1385 = !DILocalVariable(name: "src", scope: !1371, file: !1372, line: 14, type: !1386)
!1386 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1387, size: 64)
!1387 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1327)
!1388 = !DILocation(line: 14, column: 15, scope: !1371)
!1389 = !DILocation(line: 14, column: 21, scope: !1371)
!1390 = !DILocation(line: 16, column: 3, scope: !1371)
!1391 = !DILocation(line: 16, column: 13, scope: !1371)
!1392 = !DILocation(line: 16, column: 16, scope: !1371)
!1393 = !DILocation(line: 17, column: 19, scope: !1371)
!1394 = !DILocation(line: 17, column: 15, scope: !1371)
!1395 = !DILocation(line: 17, column: 10, scope: !1371)
!1396 = !DILocation(line: 17, column: 13, scope: !1371)
!1397 = distinct !{!1397, !1390, !1393, !851}
!1398 = !DILocation(line: 18, column: 10, scope: !1371)
!1399 = !DILocation(line: 18, column: 3, scope: !1371)
