...
@.str.16 = private unnamed_addr constant [18 x i8] c"bobkey value: %d\0A\00", align 1
@.str.17 = private unnamed_addr constant [21 x i8] c"Pointer address: %p\0A\00", align 1
@.str.18 = private unnamed_addr constant [22 x i8] c"Value pointed to: %x\0A\00", align 1
...
define hidden i32 @main() #0 !dbg !1338 {
  ...
  %4 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1344
  %5 = bitcast %struct._DEMO1_ACCESS_KEY* %4 to { i64, i64 }*, !dbg !1345
  %6 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %5, i32 0, i32 0, !dbg !1345
  %7 = load i64, i64* %6, align 8, !dbg !1345
  %8 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %5, i32 0, i32 1, !dbg !1345
  %9 = load i64, i64* %8, align 8, !dbg !1345
  %10 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([18 x i8], [18 x i8]* @.str.16, i64 0, i64 0), i64 %7, i64 %9), !dbg !1345
  store %struct._DEMO1_ACCESS_KEY* @bobKey, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1346
  %11 = call i32 (...) @rand(), !dbg !1347
  %12 = sext i32 %11 to i64, !dbg !1347
  %13 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1348
  %14 = getelementptr inbounds %struct._DEMO1_ACCESS_KEY, %struct._DEMO1_ACCESS_KEY* %13, i32 0, i32 0, !dbg !1349
  %15 = getelementptr inbounds [2 x i64], [2 x i64]* %14, i64 0, i64 0, !dbg !1348
  store i64 %12, i64* %15, align 8, !dbg !1350
  %16 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1351
  %17 = getelementptr inbounds %struct._DEMO1_ACCESS_KEY, %struct._DEMO1_ACCESS_KEY* %16, i32 0, i32 0, !dbg !1352
  %18 = getelementptr inbounds [2 x i64], [2 x i64]* %17, i64 0, i64 1, !dbg !1351
  store i64 -2395670108176482799, i64* %18, align 8, !dbg !1353
  %19 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1354
  %20 = bitcast %struct._DEMO1_ACCESS_KEY* %19 to i8*, !dbg !1355
  %21 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([21 x i8], [21 x i8]* @.str.17, i64 0, i64 0), i8* noundef %20), !dbg !1356
  %22 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1357
  %23 = bitcast %struct._DEMO1_ACCESS_KEY* %22 to { i64, i64 }*, !dbg !1358
  %24 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %23, i32 0, i32 0, !dbg !1358
  %25 = load i64, i64* %24, align 8, !dbg !1358
  %26 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %23, i32 0, i32 1, !dbg !1358
  %27 = load i64, i64* %26, align 8, !dbg !1358
  %28 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str.18, i64 0, i64 0), i64 %25, i64 %27), !dbg !1358
  call void @read_bobkey_addr_through_Demo1BobDataProvider(), !dbg !1359
  ret i32 0, !dbg !1360
}
...
define dso_local i8* @memcpy(i8* noundef %0, i8* noundef %1, i64 noundef %2) #5 !dbg !1361 {
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
  %6 = alloca i64, align 8
  %7 = alloca i8*, align 8
  ...
  store i64 %2, i64* %6, align 8
  call void @llvm.dbg.declare(metadata i64* %6, metadata !1369, metadata !DIExpression()), !dbg !1370
  call void @llvm.dbg.declare(metadata i8** %7, metadata !1371, metadata !DIExpression()), !dbg !1373
  %9 = load i8*, i8** %4, align 8, !dbg !1374
  store i8* %9, i8** %7, align 8, !dbg !1373
  call void @llvm.dbg.declare(metadata i8** %8, metadata !1375, metadata !DIExpression()), !dbg !1378
  %10 = load i8*, i8** %5, align 8, !dbg !1379
  store i8* %10, i8** %8, align 8, !dbg !1378
  br label %11, !dbg !1380

11:                                               ; preds = %15, %3
  %12 = load i64, i64* %6, align 8, !dbg !1381
  %13 = add i64 %12, -1, !dbg !1381
  store i64 %13, i64* %6, align 8, !dbg !1381
  %14 = icmp ugt i64 %12, 0, !dbg !1382
  br i1 %14, label %15, label %21, !dbg !1380

15:                                               ; preds = %11
  %16 = load i8*, i8** %8, align 8, !dbg !1383
  %17 = getelementptr inbounds i8, i8* %16, i32 1, !dbg !1383
  store i8* %17, i8** %8, align 8, !dbg !1383
  %18 = load i8, i8* %16, align 1, !dbg !1384
  %19 = load i8*, i8** %7, align 8, !dbg !1385
  %20 = getelementptr inbounds i8, i8* %19, i32 1, !dbg !1385
  store i8* %20, i8** %7, align 8, !dbg !1385
  store i8 %18, i8* %19, align 1, !dbg !1386
  br label %11, !dbg !1380, !llvm.loop !1387

21:                                               ; preds = %11
  %22 = load i8*, i8** %4, align 8, !dbg !1388
  ret i8* %22, !dbg !1389
}
...
!3 = !DIFile(filename: "Demo1_Bob.c", directory: "/home/hira/Research/HARDEN/repositories/HARDEN_demo1/edk2/EmulatorPkg/Demo1_Bob", checksumkind: CSK_MD5, checksum: "3135bba0d78c79f417ffbeb58b90c7af")
!4 = !{!5, !13, !20, !38, !43, !46}
...
!1344 = !DILocation(line: 400, column: 33, scope: !1338)
!1345 = !DILocation(line: 400, column: 3, scope: !1338)
!1346 = !DILocation(line: 401, column: 16, scope: !1338)
!1347 = !DILocation(line: 403, column: 37, scope: !1338)
!1348 = !DILocation(line: 403, column: 3, scope: !1338)
!1349 = !DILocation(line: 403, column: 17, scope: !1338)
!1350 = !DILocation(line: 403, column: 36, scope: !1338)
!1351 = !DILocation(line: 404, column: 3, scope: !1338)
!1352 = !DILocation(line: 404, column: 17, scope: !1338)
!1353 = !DILocation(line: 404, column: 37, scope: !1338)
!1354 = !DILocation(line: 405, column: 43, scope: !1338)
!1355 = !DILocation(line: 405, column: 35, scope: !1338)
!1356 = !DILocation(line: 405, column: 3, scope: !1338)
!1357 = !DILocation(line: 406, column: 37, scope: !1338)
!1358 = !DILocation(line: 406, column: 3, scope: !1338)
!1359 = !DILocation(line: 407, column: 3, scope: !1338)
!1360 = !DILocation(line: 408, column: 3, scope: !1338)
!1361 = distinct !DISubprogram(name: "memcpy", scope: !1362, file: !1362, line: 12, type: !1363, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !703, retainedNodes: !714)
!1362 = !DIFile(filename: "klee/runtime/Freestanding/memcpy.c", directory: "/home/hira/Research", checksumkind: CSK_MD5, checksum: "8fb9a7164e167db005d7d002570068bc")
!1363 = !DISubroutineType(types: !1364)
!1364 = !{!52, !52, !605, !1275}
!1365 = !DILocalVariable(name: "destaddr", arg: 1, scope: !1361, file: !1362, line: 12, type: !52)
!1366 = !DILocation(line: 12, column: 20, scope: !1361)
!1367 = !DILocalVariable(name: "srcaddr", arg: 2, scope: !1361, file: !1362, line: 12, type: !605)
!1368 = !DILocation(line: 12, column: 42, scope: !1361)
!1369 = !DILocalVariable(name: "len", arg: 3, scope: !1361, file: !1362, line: 12, type: !1275)
!1370 = !DILocation(line: 12, column: 58, scope: !1361)
!1371 = !DILocalVariable(name: "dest", scope: !1361, file: !1362, line: 13, type: !1372)
!1372 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1323, size: 64)
!1373 = !DILocation(line: 13, column: 9, scope: !1361)
!1374 = !DILocation(line: 13, column: 16, scope: !1361)
!1375 = !DILocalVariable(name: "src", scope: !1361, file: !1362, line: 14, type: !1376)
!1376 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1377, size: 64)
!1377 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1323)
!1378 = !DILocation(line: 14, column: 15, scope: !1361)
!1379 = !DILocation(line: 14, column: 21, scope: !1361)
!1380 = !DILocation(line: 16, column: 3, scope: !1361)
!1381 = !DILocation(line: 16, column: 13, scope: !1361)
!1382 = !DILocation(line: 16, column: 16, scope: !1361)
!1383 = !DILocation(line: 17, column: 19, scope: !1361)
!1384 = !DILocation(line: 17, column: 15, scope: !1361)
!1385 = !DILocation(line: 17, column: 10, scope: !1361)
!1386 = !DILocation(line: 17, column: 13, scope: !1361)
!1387 = distinct !{!1387, !1380, !1383, !851}
!1388 = !DILocation(line: 18, column: 10, scope: !1361)
!1389 = !DILocation(line: 18, column: 3, scope: !1361)
