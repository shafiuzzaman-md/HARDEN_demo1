...
define hidden i32 @main() #0 !dbg !1265 {
  ...
  %10 = bitcast %struct._DEMO1_ACCESS_KEY** %4 to i8**, !dbg !1277
  %11 = load i64, i64* %3, align 8, !dbg !1279
  %12 = call i64 @Demo1BobDataProvider(%struct._Demo1_Bob_PROTOCOL* noundef null, i8* noundef bitcast (%struct._DEMO1_ACCESS_KEY* @bobKey to i8*), i8** noundef %10, i64 noundef %11), !dbg !1280
  %13 = icmp eq i64 %12, 0, !dbg !1281
  br i1 %13, label %14, label %31, !dbg !1282

14:                                               ; preds = %0
  call void @llvm.dbg.declare(metadata %struct._DEMO1_ACCESS_KEY* %5, metadata !1283, metadata !DIExpression()), !dbg !1285
  %15 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %4, align 8, !dbg !1286
  %16 = bitcast %struct._DEMO1_ACCESS_KEY* %5 to i8*, !dbg !1287
  %17 = bitcast %struct._DEMO1_ACCESS_KEY* %15 to i8*, !dbg !1287
  %18 = call i8* @memcpy(i8* %16, i8* %17, i64 16), !dbg !1287
  %19 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %4, align 8, !dbg !1288
  %20 = getelementptr inbounds %struct._DEMO1_ACCESS_KEY, %struct._DEMO1_ACCESS_KEY* %19, i32 0, i32 0, !dbg !1289
  %21 = getelementptr inbounds [2 x i64], [2 x i64]* %20, i64 0, i64 0, !dbg !1288
  %22 = load i64, i64* %21, align 8, !dbg !1288
  %23 = inttoptr i64 %22 to i8*, !dbg !1290
  %24 = bitcast %struct._DEMO1_ACCESS_KEY* %5 to { i64, i64 }*, !dbg !1291
  %25 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %24, i32 0, i32 0, !dbg !1291
  %26 = load i64, i64* %25, align 8, !dbg !1291
  %27 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %24, i32 0, i32 1, !dbg !1291
  %28 = load i64, i64* %27, align 8, !dbg !1291
  %29 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([27 x i8], [27 x i8]* @.str.13, i64 0, i64 0), i8* noundef %23, i64 %26, i64 %28), !dbg !1291
  %30 = call i32 (i8*, i8*, i32, i8*, ...) bitcast (i32 (...)* @__assert_fail to i32 (i8*, i8*, i32, i8*, ...)*)(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str.14, i64 0, i64 0), i8* noundef getelementptr inbounds ([12 x i8], [12 x i8]* @.str.15, i64 0, i64 0), i32 noundef 383, i8* noundef getelementptr inbounds ([11 x i8], [11 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)), !dbg !1292
  br label %31, !dbg !1293
...
!3 = !DIFile(filename: "Demo1_Bob.c", directory: "/home/hira/Research/HARDEN/repositories/HARDEN_demo1/edk2/EmulatorPkg/Demo1_Bob", checksumkind: CSK_MD5, checksum: "575c24f6f21d5f0f943d553797449b46")
!4 = !{!5, !13, !20, !38, !43, !46}
...
!1289 = !DILocation(line: 379, column: 57, scope: !1284)
!1290 = !DILocation(line: 379, column: 43, scope: !1284)
!1291 = !DILocation(line: 379, column: 5, scope: !1284)
!1292 = !DILocation(line: 383, column: 7, scope: !1284)
!1293 = !DILocation(line: 384, column: 5, scope: !1284)
!1294 = !DILocation(line: 387, column: 3, scope: !1265)
