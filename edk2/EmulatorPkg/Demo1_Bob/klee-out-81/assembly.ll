...
define hidden i32 @main() #0 !dbg !1338 {
  ...
  %13 = bitcast %struct._DEMO1_ACCESS_KEY* %12 to i8*, !dbg !1353
  %14 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([21 x i8], [21 x i8]* @.str.16, i64 0, i64 0), i8* noundef %13), !dbg !1354
  %15 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1355
  %16 = bitcast %struct._DEMO1_ACCESS_KEY* %15 to { i64, i64 }*, !dbg !1356
  %17 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %16, i32 0, i32 0, !dbg !1356
  %18 = load i64, i64* %17, align 8, !dbg !1356
  %19 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %16, i32 0, i32 1, !dbg !1356
  %20 = load i64, i64* %19, align 8, !dbg !1356
  %21 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str.17, i64 0, i64 0), i64 %18, i64 %20), !dbg !1356
...
!3 = !DIFile(filename: "Demo1_Bob.c", directory: "/home/hira/Research/HARDEN/repositories/HARDEN_demo1/edk2/EmulatorPkg/Demo1_Bob", checksumkind: CSK_MD5, checksum: "b5162d714da12ea9941541ab1d032267")
!4 = !{!5, !13, !20, !38, !43, !46}
