...
@.str.14 = private unnamed_addr constant [22 x i8] c"Rand part bobkey: %x\0A\00", align 1
...
define hidden void @read_bobkey_addr_through_Demo1BobDataProvider() #0 !dbg !1314 {
  ...
  call void @llvm.dbg.declare(metadata i8* %4, metadata !1323, metadata !DIExpression()), !dbg !1326
  %5 = load i8*, i8** %3, align 8, !dbg !1327
  %6 = bitcast %struct._DEMO1_ACCESS_KEY** %2 to i8**, !dbg !1329
  %7 = load i64, i64* %1, align 8, !dbg !1330
  %8 = call i64 @Demo1BobDataProvider(%struct._Demo1_Bob_PROTOCOL* noundef null, i8* noundef %5, i8** noundef %6, i64 noundef %7), !dbg !1331
  %9 = icmp ne i64 %8, 0, !dbg !1332
  br i1 %9, label %10, label %22, !dbg !1333

10:                                               ; preds = %0
  %11 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1334
  %12 = getelementptr inbounds %struct._DEMO1_ACCESS_KEY, %struct._DEMO1_ACCESS_KEY* %11, i32 0, i32 0, !dbg !1336
  %13 = getelementptr inbounds [2 x i64], [2 x i64]* %12, i64 0, i64 0, !dbg !1334
  %14 = load i64, i64* %13, align 8, !dbg !1334
  %15 = inttoptr i64 %14 to i8*, !dbg !1337
  %16 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([16 x i8], [16 x i8]* @.str.13, i64 0, i64 0), i8* noundef %15), !dbg !1338
  %17 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1339
  %18 = getelementptr inbounds %struct._DEMO1_ACCESS_KEY, %struct._DEMO1_ACCESS_KEY* %17, i32 0, i32 0, !dbg !1340
  %19 = getelementptr inbounds [2 x i64], [2 x i64]* %18, i64 0, i64 0, !dbg !1339
  %20 = load i64, i64* %19, align 8, !dbg !1339
  %21 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str.14, i64 0, i64 0), i64 noundef %20), !dbg !1341
  br label %22, !dbg !1342
...
define hidden i32 @main() #0 !dbg !1344 {
  ...
  %3 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([20 x i8], [20 x i8]* @.str.15, i64 0, i64 0), %struct._DEMO1_ACCESS_KEY* noundef @bobKey), !dbg !1349
  ...
  %16 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str.14, i64 0, i64 0), i64 noundef %15), !dbg !1360
  ...
  %21 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str.16, i64 0, i64 0), i64 noundef %20), !dbg !1363
  ...
  %24 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([24 x i8], [24 x i8]* @.str.17, i64 0, i64 0), i8* noundef %23), !dbg !1366
  ...
  %27 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([37 x i8], [37 x i8]* @.str.18, i64 0, i64 0), i8* noundef %26), !dbg !1369
...
!3 = !DIFile(filename: "Demo1_Bob.c", directory: "/home/hira/Research/HARDEN/repositories/HARDEN_demo1/edk2/EmulatorPkg/Demo1_Bob", checksumkind: CSK_MD5, checksum: "073c8e75759c2d0f99d0ea087ddd7b8d")
!4 = !{!5, !13, !20, !38, !43, !46}
...
!1323 = !DILocalVariable(name: "readValue", scope: !1314, file: !3, line: 391, type: !1324)
...
!1326 = !DILocation(line: 391, column: 12, scope: !1314)
!1327 = !DILocation(line: 393, column: 35, scope: !1328)
!1328 = distinct !DILexicalBlock(scope: !1314, file: !3, line: 393, column: 8)
!1329 = !DILocation(line: 393, column: 48, scope: !1328)
!1330 = !DILocation(line: 393, column: 64, scope: !1328)
!1331 = !DILocation(line: 393, column: 8, scope: !1328)
!1332 = !DILocation(line: 393, column: 70, scope: !1328)
!1333 = !DILocation(line: 393, column: 8, scope: !1314)
!1334 = !DILocation(line: 395, column: 43, scope: !1335)
!1335 = distinct !DILexicalBlock(scope: !1328, file: !3, line: 393, column: 85)
!1336 = !DILocation(line: 395, column: 49, scope: !1335)
!1337 = !DILocation(line: 395, column: 35, scope: !1335)
!1338 = !DILocation(line: 395, column: 8, scope: !1335)
!1339 = !DILocation(line: 396, column: 41, scope: !1335)
!1340 = !DILocation(line: 396, column: 47, scope: !1335)
!1341 = !DILocation(line: 396, column: 8, scope: !1335)
!1342 = !DILocation(line: 399, column: 5, scope: !1335)
!1343 = !DILocation(line: 400, column: 1, scope: !1314)
!1344 = distinct !DISubprogram(name: "main", scope: !3, file: !3, line: 402, type: !1345, scopeLine: 403, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !714)
!1345 = !DISubroutineType(types: !1346)
!1346 = !{!196}
!1347 = !DILocalVariable(name: "AccessKeyPtr", scope: !1344, file: !3, line: 404, type: !310)
!1348 = !DILocation(line: 404, column: 23, scope: !1344)
!1349 = !DILocation(line: 405, column: 3, scope: !1344)
!1350 = !DILocation(line: 406, column: 16, scope: !1344)
!1351 = !DILocation(line: 408, column: 37, scope: !1344)
!1352 = !DILocation(line: 408, column: 3, scope: !1344)
!1353 = !DILocation(line: 408, column: 17, scope: !1344)
!1354 = !DILocation(line: 408, column: 36, scope: !1344)
!1355 = !DILocation(line: 409, column: 3, scope: !1344)
!1356 = !DILocation(line: 409, column: 17, scope: !1344)
!1357 = !DILocation(line: 409, column: 37, scope: !1344)
!1358 = !DILocation(line: 410, column: 36, scope: !1344)
!1359 = !DILocation(line: 410, column: 50, scope: !1344)
!1360 = !DILocation(line: 410, column: 3, scope: !1344)
!1361 = !DILocation(line: 411, column: 36, scope: !1344)
!1362 = !DILocation(line: 411, column: 50, scope: !1344)
!1363 = !DILocation(line: 411, column: 3, scope: !1344)
!1364 = !DILocation(line: 412, column: 46, scope: !1344)
!1365 = !DILocation(line: 412, column: 38, scope: !1344)
!1366 = !DILocation(line: 412, column: 3, scope: !1344)
!1367 = !DILocation(line: 413, column: 59, scope: !1344)
!1368 = !DILocation(line: 413, column: 51, scope: !1344)
!1369 = !DILocation(line: 413, column: 3, scope: !1344)
!1370 = !DILocation(line: 414, column: 3, scope: !1344)
!1371 = !DILocation(line: 415, column: 3, scope: !1344)
...
!1380 = !DILocalVariable(name: "len", arg: 3, scope: !1372, file: !1373, line: 12, type: !1278)
!1381 = !DILocation(line: 12, column: 58, scope: !1372)
!1382 = !DILocalVariable(name: "dest", scope: !1372, file: !1373, line: 13, type: !1383)
!1383 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1325, size: 64)
...
!1388 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1325)
