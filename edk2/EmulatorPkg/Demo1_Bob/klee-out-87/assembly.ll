...
@.str.12 = private unnamed_addr constant [28 x i8] c"searchValue != (VOID*) data\00", align 1
...
@.str.17 = private unnamed_addr constant [37 x i8] c"Address where bobkey is written: %p\0A\00", align 1
...
define hidden void @read_bobkey_addr_through_Demo1BobDataProvider() #0 !dbg !1311 {
  ...
  call void @llvm.dbg.declare(metadata i8** %2, metadata !1316, metadata !DIExpression()), !dbg !1320
  ...
  %4 = load i64, i64* %1, align 8, !dbg !1323
  %5 = call i64 @Demo1BobDataProvider(%struct._Demo1_Bob_PROTOCOL* noundef null, i8* noundef bitcast (%struct._DEMO1_ACCESS_KEY* @bobKey to i8*), i8** noundef %2, i64 noundef %4), !dbg !1325
  %6 = icmp ne i64 %5, 0, !dbg !1326
  br i1 %6, label %7, label %15, !dbg !1327

7:                                                ; preds = %0
  %8 = load i8*, i8** %3, align 8, !dbg !1328
  %9 = load i8*, i8** %2, align 8, !dbg !1328
  %10 = icmp ne i8* %8, %9, !dbg !1328
  br i1 %10, label %11, label %12, !dbg !1328

11:                                               ; preds = %7
  br label %14, !dbg !1328

12:                                               ; preds = %7
  %13 = call i32 (i8*, i8*, i32, i8*, ...) bitcast (i32 (...)* @__assert_fail to i32 (i8*, i8*, i32, i8*, ...)*)(i8* noundef getelementptr inbounds ([28 x i8], [28 x i8]* @.str.12, i64 0, i64 0), i8* noundef getelementptr inbounds ([12 x i8], [12 x i8]* @.str.13, i64 0, i64 0), i32 noundef 392, i8* noundef getelementptr inbounds ([53 x i8], [53 x i8]* @__PRETTY_FUNCTION__.read_bobkey_addr_through_Demo1BobDataProvider, i64 0, i64 0)), !dbg !1328
  br label %14, !dbg !1328
...
; Function Attrs: noinline nounwind optnone uwtable
define hidden i32 @main() #0 !dbg !1332 {
  %1 = alloca i32, align 4
  %2 = alloca %struct._DEMO1_ACCESS_KEY*, align 8
  store i32 0, i32* %1, align 4
  call void @llvm.dbg.declare(metadata %struct._DEMO1_ACCESS_KEY** %2, metadata !1335, metadata !DIExpression()), !dbg !1336
  %3 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([20 x i8], [20 x i8]* @.str.14, i64 0, i64 0), %struct._DEMO1_ACCESS_KEY* noundef @bobKey), !dbg !1337
  store %struct._DEMO1_ACCESS_KEY* @bobKey, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1338
  %4 = call i32 (...) @rand(), !dbg !1339
  %5 = sext i32 %4 to i64, !dbg !1339
  %6 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1340
  %7 = getelementptr inbounds %struct._DEMO1_ACCESS_KEY, %struct._DEMO1_ACCESS_KEY* %6, i32 0, i32 0, !dbg !1341
  %8 = getelementptr inbounds [2 x i64], [2 x i64]* %7, i64 0, i64 0, !dbg !1340
  store i64 %5, i64* %8, align 8, !dbg !1342
  %9 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1343
  %10 = getelementptr inbounds %struct._DEMO1_ACCESS_KEY, %struct._DEMO1_ACCESS_KEY* %9, i32 0, i32 0, !dbg !1344
  %11 = getelementptr inbounds [2 x i64], [2 x i64]* %10, i64 0, i64 1, !dbg !1343
  store i64 -2395670108176482799, i64* %11, align 8, !dbg !1345
  %12 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1346
  %13 = getelementptr inbounds %struct._DEMO1_ACCESS_KEY, %struct._DEMO1_ACCESS_KEY* %12, i32 0, i32 0, !dbg !1347
  %14 = getelementptr inbounds [2 x i64], [2 x i64]* %13, i64 0, i64 0, !dbg !1346
  %15 = load i64, i64* %14, align 8, !dbg !1346
  %16 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str.15, i64 0, i64 0), i64 noundef %15), !dbg !1348
  %17 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1349
  %18 = getelementptr inbounds %struct._DEMO1_ACCESS_KEY, %struct._DEMO1_ACCESS_KEY* %17, i32 0, i32 0, !dbg !1350
  %19 = getelementptr inbounds [2 x i64], [2 x i64]* %18, i64 0, i64 1, !dbg !1349
  %20 = load i64, i64* %19, align 8, !dbg !1349
  %21 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str.16, i64 0, i64 0), i64 noundef %20), !dbg !1351
  %22 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %2, align 8, !dbg !1352
  %23 = bitcast %struct._DEMO1_ACCESS_KEY* %22 to i8*, !dbg !1353
  %24 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([37 x i8], [37 x i8]* @.str.17, i64 0, i64 0), i8* noundef %23), !dbg !1354
  call void @read_bobkey_addr_through_Demo1BobDataProvider(), !dbg !1355
  ret i32 0, !dbg !1356
}
...
define dso_local i8* @memcpy(i8* noundef %0, i8* noundef %1, i64 noundef %2) #5 !dbg !1357 {
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
  %6 = alloca i64, align 8
  %7 = alloca i8*, align 8
  %8 = alloca i8*, align 8
  store i8* %0, i8** %4, align 8
  call void @llvm.dbg.declare(metadata i8** %4, metadata !1361, metadata !DIExpression()), !dbg !1362
  store i8* %1, i8** %5, align 8
  call void @llvm.dbg.declare(metadata i8** %5, metadata !1363, metadata !DIExpression()), !dbg !1364
  store i64 %2, i64* %6, align 8
  call void @llvm.dbg.declare(metadata i64* %6, metadata !1365, metadata !DIExpression()), !dbg !1366
  call void @llvm.dbg.declare(metadata i8** %7, metadata !1367, metadata !DIExpression()), !dbg !1369
  %9 = load i8*, i8** %4, align 8, !dbg !1370
  store i8* %9, i8** %7, align 8, !dbg !1369
  call void @llvm.dbg.declare(metadata i8** %8, metadata !1371, metadata !DIExpression()), !dbg !1374
  %10 = load i8*, i8** %5, align 8, !dbg !1375
  store i8* %10, i8** %8, align 8, !dbg !1374
  br label %11, !dbg !1376

11:                                               ; preds = %15, %3
  %12 = load i64, i64* %6, align 8, !dbg !1377
  %13 = add i64 %12, -1, !dbg !1377
  store i64 %13, i64* %6, align 8, !dbg !1377
  %14 = icmp ugt i64 %12, 0, !dbg !1378
  br i1 %14, label %15, label %21, !dbg !1376

15:                                               ; preds = %11
  %16 = load i8*, i8** %8, align 8, !dbg !1379
  %17 = getelementptr inbounds i8, i8* %16, i32 1, !dbg !1379
  store i8* %17, i8** %8, align 8, !dbg !1379
  %18 = load i8, i8* %16, align 1, !dbg !1380
  %19 = load i8*, i8** %7, align 8, !dbg !1381
  %20 = getelementptr inbounds i8, i8* %19, i32 1, !dbg !1381
  store i8* %20, i8** %7, align 8, !dbg !1381
  store i8 %18, i8* %19, align 1, !dbg !1382
  br label %11, !dbg !1376, !llvm.loop !1383

21:                                               ; preds = %11
  %22 = load i8*, i8** %4, align 8, !dbg !1384
  ret i8* %22, !dbg !1385
}
...
!3 = !DIFile(filename: "Demo1_Bob.c", directory: "/home/hira/Research/HARDEN/repositories/HARDEN_demo1/edk2/EmulatorPkg/Demo1_Bob", checksumkind: CSK_MD5, checksum: "5a437c940172ebe54239b2a0f71bf985")
!4 = !{!5, !13, !20, !38, !43, !46}
...
!1316 = !DILocalVariable(name: "data", scope: !1311, file: !3, line: 387, type: !1317)
!1317 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1318, size: 64)
!1318 = !DIDerivedType(tag: DW_TAG_typedef, name: "CHAR8", file: !54, line: 218, baseType: !1319)
!1319 = !DIBasicType(name: "char", size: 8, encoding: DW_ATE_signed_char)
!1320 = !DILocation(line: 387, column: 12, scope: !1311)
!1321 = !DILocalVariable(name: "searchValue", scope: !1311, file: !3, line: 389, type: !52)
!1322 = !DILocation(line: 389, column: 11, scope: !1311)
!1323 = !DILocation(line: 391, column: 68, scope: !1324)
!1324 = distinct !DILexicalBlock(scope: !1311, file: !3, line: 391, column: 8)
!1325 = !DILocation(line: 391, column: 8, scope: !1324)
!1326 = !DILocation(line: 391, column: 74, scope: !1324)
!1327 = !DILocation(line: 391, column: 8, scope: !1311)
!1328 = !DILocation(line: 392, column: 7, scope: !1329)
!1329 = distinct !DILexicalBlock(scope: !1324, file: !3, line: 391, column: 89)
!1330 = !DILocation(line: 393, column: 5, scope: !1329)
!1331 = !DILocation(line: 394, column: 1, scope: !1311)
!1332 = distinct !DISubprogram(name: "main", scope: !3, file: !3, line: 396, type: !1333, scopeLine: 397, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !714)
!1333 = !DISubroutineType(types: !1334)
!1334 = !{!196}
!1335 = !DILocalVariable(name: "AccessKeyPtr", scope: !1332, file: !3, line: 398, type: !310)
!1336 = !DILocation(line: 398, column: 23, scope: !1332)
!1337 = !DILocation(line: 399, column: 3, scope: !1332)
!1338 = !DILocation(line: 400, column: 16, scope: !1332)
!1339 = !DILocation(line: 402, column: 37, scope: !1332)
!1340 = !DILocation(line: 402, column: 3, scope: !1332)
!1341 = !DILocation(line: 402, column: 17, scope: !1332)
!1342 = !DILocation(line: 402, column: 36, scope: !1332)
!1343 = !DILocation(line: 403, column: 3, scope: !1332)
!1344 = !DILocation(line: 403, column: 17, scope: !1332)
!1345 = !DILocation(line: 403, column: 37, scope: !1332)
!1346 = !DILocation(line: 404, column: 36, scope: !1332)
!1347 = !DILocation(line: 404, column: 50, scope: !1332)
!1348 = !DILocation(line: 404, column: 3, scope: !1332)
!1349 = !DILocation(line: 405, column: 36, scope: !1332)
!1350 = !DILocation(line: 405, column: 50, scope: !1332)
!1351 = !DILocation(line: 405, column: 3, scope: !1332)
!1352 = !DILocation(line: 407, column: 59, scope: !1332)
!1353 = !DILocation(line: 407, column: 51, scope: !1332)
!1354 = !DILocation(line: 407, column: 3, scope: !1332)
!1355 = !DILocation(line: 408, column: 3, scope: !1332)
!1356 = !DILocation(line: 409, column: 3, scope: !1332)
!1357 = distinct !DISubprogram(name: "memcpy", scope: !1358, file: !1358, line: 12, type: !1359, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !703, retainedNodes: !714)
!1358 = !DIFile(filename: "klee/runtime/Freestanding/memcpy.c", directory: "/home/hira/Research", checksumkind: CSK_MD5, checksum: "8fb9a7164e167db005d7d002570068bc")
!1359 = !DISubroutineType(types: !1360)
!1360 = !{!52, !52, !605, !1275}
!1361 = !DILocalVariable(name: "destaddr", arg: 1, scope: !1357, file: !1358, line: 12, type: !52)
!1362 = !DILocation(line: 12, column: 20, scope: !1357)
!1363 = !DILocalVariable(name: "srcaddr", arg: 2, scope: !1357, file: !1358, line: 12, type: !605)
!1364 = !DILocation(line: 12, column: 42, scope: !1357)
!1365 = !DILocalVariable(name: "len", arg: 3, scope: !1357, file: !1358, line: 12, type: !1275)
!1366 = !DILocation(line: 12, column: 58, scope: !1357)
!1367 = !DILocalVariable(name: "dest", scope: !1357, file: !1358, line: 13, type: !1368)
!1368 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1319, size: 64)
!1369 = !DILocation(line: 13, column: 9, scope: !1357)
!1370 = !DILocation(line: 13, column: 16, scope: !1357)
!1371 = !DILocalVariable(name: "src", scope: !1357, file: !1358, line: 14, type: !1372)
!1372 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1373, size: 64)
!1373 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1319)
!1374 = !DILocation(line: 14, column: 15, scope: !1357)
!1375 = !DILocation(line: 14, column: 21, scope: !1357)
!1376 = !DILocation(line: 16, column: 3, scope: !1357)
!1377 = !DILocation(line: 16, column: 13, scope: !1357)
!1378 = !DILocation(line: 16, column: 16, scope: !1357)
!1379 = !DILocation(line: 17, column: 19, scope: !1357)
!1380 = !DILocation(line: 17, column: 15, scope: !1357)
!1381 = !DILocation(line: 17, column: 10, scope: !1357)
!1382 = !DILocation(line: 17, column: 13, scope: !1357)
!1383 = distinct !{!1383, !1376, !1379, !851}
!1384 = !DILocation(line: 18, column: 10, scope: !1357)
!1385 = !DILocation(line: 18, column: 3, scope: !1357)
