...
; Function Attrs: noinline nounwind optnone uwtable
define hidden void @read_through_Demo1BobDataProvider(i8* noundef %0) #0 !dbg !1265 {
  %2 = alloca i8*, align 8
  %3 = alloca i64, align 8
  %4 = alloca i64, align 8
  %5 = alloca %struct._DEMO1_ACCESS_KEY*, align 8
  store i8* %0, i8** %2, align 8
  call void @llvm.dbg.declare(metadata i8** %2, metadata !1268, metadata !DIExpression()), !dbg !1269
  call void @llvm.dbg.declare(metadata i64* %3, metadata !1270, metadata !DIExpression()), !dbg !1271
  call void @llvm.dbg.declare(metadata i64* %4, metadata !1272, metadata !DIExpression()), !dbg !1273
  store i64 16, i64* %4, align 8, !dbg !1273
  call void @llvm.dbg.declare(metadata %struct._DEMO1_ACCESS_KEY** %5, metadata !1274, metadata !DIExpression()), !dbg !1275
  %6 = call i8* @malloc(i64 noundef 16), !dbg !1276
  %7 = bitcast i8* %6 to %struct._DEMO1_ACCESS_KEY*, !dbg !1276
  store %struct._DEMO1_ACCESS_KEY* %7, %struct._DEMO1_ACCESS_KEY** %5, align 8, !dbg !1275
  %8 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %5, align 8, !dbg !1277
  %9 = bitcast %struct._DEMO1_ACCESS_KEY* %8 to i8*, !dbg !1277
  call void @klee_make_symbolic(i8* noundef %9, i64 noundef 16, i8* noundef getelementptr inbounds ([5 x i8], [5 x i8]* @.str.12, i64 0, i64 0)), !dbg !1278
  %10 = load i64, i64* %3, align 8, !dbg !1279
  %11 = inttoptr i64 %10 to i8*, !dbg !1279
  %12 = bitcast %struct._DEMO1_ACCESS_KEY** %5 to i8**, !dbg !1279
  %13 = load i64, i64* %4, align 8, !dbg !1279
  %14 = call i64 @Demo1BobDataProvider(%struct._Demo1_Bob_PROTOCOL* noundef null, i8* noundef %11, i8** noundef %12, i64 noundef %13), !dbg !1279
  %15 = icmp ne i64 %14, 0, !dbg !1279
  br i1 %15, label %16, label %17, !dbg !1279

16:                                               ; preds = %1
  br label %19, !dbg !1279

17:                                               ; preds = %1
  %18 = call i32 (i8*, i8*, i32, i8*, ...) bitcast (i32 (...)* @__assert_fail to i32 (i8*, i8*, i32, i8*, ...)*)(i8* noundef getelementptr inbounds ([81 x i8], [81 x i8]* @.str.13, i64 0, i64 0), i8* noundef getelementptr inbounds ([12 x i8], [12 x i8]* @.str.14, i64 0, i64 0), i32 noundef 374, i8* noundef getelementptr inbounds ([47 x i8], [47 x i8]* @__PRETTY_FUNCTION__.read_through_Demo1BobDataProvider, i64 0, i64 0)), !dbg !1279
  br label %19, !dbg !1279
...
; Function Attrs: noinline nounwind optnone uwtable
define hidden i32 @main() #0 !dbg !1281 {
  %1 = alloca i32, align 4
  %2 = alloca i8*, align 8
  store i32 0, i32* %1, align 4
  call void @llvm.dbg.declare(metadata i8** %2, metadata !1284, metadata !DIExpression()), !dbg !1285
  store i8* bitcast (%struct._DEMO1_ACCESS_KEY* @bobKey to i8*), i8** %2, align 8, !dbg !1285
  %3 = load i8*, i8** %2, align 8, !dbg !1286
  call void @read_through_Demo1BobDataProvider(i8* noundef %3), !dbg !1287
  ret i32 0, !dbg !1288
}

; Function Attrs: noinline nounwind uwtable
define dso_local i8* @memcpy(i8* noundef %0, i8* noundef %1, i64 noundef %2) #5 !dbg !1289 {
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
  %6 = alloca i64, align 8
  %7 = alloca i8*, align 8
  %8 = alloca i8*, align 8
  store i8* %0, i8** %4, align 8
  call void @llvm.dbg.declare(metadata i8** %4, metadata !1296, metadata !DIExpression()), !dbg !1297
  store i8* %1, i8** %5, align 8
  call void @llvm.dbg.declare(metadata i8** %5, metadata !1298, metadata !DIExpression()), !dbg !1299
  store i64 %2, i64* %6, align 8
  call void @llvm.dbg.declare(metadata i64* %6, metadata !1300, metadata !DIExpression()), !dbg !1301
  call void @llvm.dbg.declare(metadata i8** %7, metadata !1302, metadata !DIExpression()), !dbg !1305
  %9 = load i8*, i8** %4, align 8, !dbg !1306
  store i8* %9, i8** %7, align 8, !dbg !1305
  call void @llvm.dbg.declare(metadata i8** %8, metadata !1307, metadata !DIExpression()), !dbg !1310
  %10 = load i8*, i8** %5, align 8, !dbg !1311
  store i8* %10, i8** %8, align 8, !dbg !1310
  br label %11, !dbg !1312

11:                                               ; preds = %15, %3
  %12 = load i64, i64* %6, align 8, !dbg !1313
  %13 = add i64 %12, -1, !dbg !1313
  store i64 %13, i64* %6, align 8, !dbg !1313
  %14 = icmp ugt i64 %12, 0, !dbg !1314
  br i1 %14, label %15, label %21, !dbg !1312

15:                                               ; preds = %11
  %16 = load i8*, i8** %8, align 8, !dbg !1315
  %17 = getelementptr inbounds i8, i8* %16, i32 1, !dbg !1315
  store i8* %17, i8** %8, align 8, !dbg !1315
  %18 = load i8, i8* %16, align 1, !dbg !1316
  %19 = load i8*, i8** %7, align 8, !dbg !1317
  %20 = getelementptr inbounds i8, i8* %19, i32 1, !dbg !1317
  store i8* %20, i8** %7, align 8, !dbg !1317
  store i8 %18, i8* %19, align 1, !dbg !1318
  br label %11, !dbg !1312, !llvm.loop !1319

21:                                               ; preds = %11
  %22 = load i8*, i8** %4, align 8, !dbg !1320
  ret i8* %22, !dbg !1321
}
...
!3 = !DIFile(filename: "Demo1_Bob.c", directory: "/home/hira/Research/HARDEN/repositories/HARDEN_demo1/edk2/EmulatorPkg/Demo1_Bob", checksumkind: CSK_MD5, checksum: "eb37217c678bc7011354cab042db4995")
!4 = !{!5, !13, !20, !38, !43, !46}
...
!1265 = distinct !DISubprogram(name: "read_through_Demo1BobDataProvider", scope: !3, file: !3, line: 369, type: !1266, scopeLine: 369, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !707)
!1266 = !DISubroutineType(types: !1267)
!1267 = !{null, !52}
!1268 = !DILocalVariable(name: "search_address", arg: 1, scope: !1265, file: !3, line: 369, type: !52)
!1269 = !DILocation(line: 369, column: 46, scope: !1265)
!1270 = !DILocalVariable(name: "address", scope: !1265, file: !3, line: 370, type: !70)
!1271 = !DILocation(line: 370, column: 11, scope: !1265)
!1272 = !DILocalVariable(name: "size", scope: !1265, file: !3, line: 371, type: !70)
!1273 = !DILocation(line: 371, column: 11, scope: !1265)
!1274 = !DILocalVariable(name: "dest", scope: !1265, file: !3, line: 372, type: !303)
!1275 = !DILocation(line: 372, column: 23, scope: !1265)
!1276 = !DILocation(line: 372, column: 29, scope: !1265)
!1277 = !DILocation(line: 373, column: 24, scope: !1265)
!1278 = !DILocation(line: 373, column: 5, scope: !1265)
!1279 = !DILocation(line: 374, column: 5, scope: !1265)
!1280 = !DILocation(line: 375, column: 1, scope: !1265)
!1281 = distinct !DISubprogram(name: "main", scope: !3, file: !3, line: 377, type: !1282, scopeLine: 378, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !707)
!1282 = !DISubroutineType(types: !1283)
!1283 = !{!189}
!1284 = !DILocalVariable(name: "search_address", scope: !1281, file: !3, line: 379, type: !52)
!1285 = !DILocation(line: 379, column: 9, scope: !1281)
!1286 = !DILocation(line: 380, column: 37, scope: !1281)
!1287 = !DILocation(line: 380, column: 3, scope: !1281)
!1288 = !DILocation(line: 381, column: 3, scope: !1281)
!1289 = distinct !DISubprogram(name: "memcpy", scope: !1290, file: !1290, line: 12, type: !1291, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !696, retainedNodes: !707)
!1290 = !DIFile(filename: "klee/runtime/Freestanding/memcpy.c", directory: "/home/hira/Research", checksumkind: CSK_MD5, checksum: "8fb9a7164e167db005d7d002570068bc")
!1291 = !DISubroutineType(types: !1292)
!1292 = !{!52, !52, !598, !1293}
!1293 = !DIDerivedType(tag: DW_TAG_typedef, name: "size_t", file: !1294, line: 46, baseType: !1295)
!1294 = !DIFile(filename: "/usr/lib/llvm-14/lib/clang/14.0.6/include/stddef.h", directory: "", checksumkind: CSK_MD5, checksum: "2499dd2361b915724b073282bea3a7bc")
!1295 = !DIBasicType(name: "unsigned long", size: 64, encoding: DW_ATE_unsigned)
!1296 = !DILocalVariable(name: "destaddr", arg: 1, scope: !1289, file: !1290, line: 12, type: !52)
!1297 = !DILocation(line: 12, column: 20, scope: !1289)
!1298 = !DILocalVariable(name: "srcaddr", arg: 2, scope: !1289, file: !1290, line: 12, type: !598)
!1299 = !DILocation(line: 12, column: 42, scope: !1289)
!1300 = !DILocalVariable(name: "len", arg: 3, scope: !1289, file: !1290, line: 12, type: !1293)
!1301 = !DILocation(line: 12, column: 58, scope: !1289)
!1302 = !DILocalVariable(name: "dest", scope: !1289, file: !1290, line: 13, type: !1303)
!1303 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1304, size: 64)
!1304 = !DIBasicType(name: "char", size: 8, encoding: DW_ATE_signed_char)
!1305 = !DILocation(line: 13, column: 9, scope: !1289)
!1306 = !DILocation(line: 13, column: 16, scope: !1289)
!1307 = !DILocalVariable(name: "src", scope: !1289, file: !1290, line: 14, type: !1308)
!1308 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1309, size: 64)
!1309 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1304)
!1310 = !DILocation(line: 14, column: 15, scope: !1289)
!1311 = !DILocation(line: 14, column: 21, scope: !1289)
!1312 = !DILocation(line: 16, column: 3, scope: !1289)
!1313 = !DILocation(line: 16, column: 13, scope: !1289)
!1314 = !DILocation(line: 16, column: 16, scope: !1289)
!1315 = !DILocation(line: 17, column: 19, scope: !1289)
!1316 = !DILocation(line: 17, column: 15, scope: !1289)
!1317 = !DILocation(line: 17, column: 10, scope: !1289)
!1318 = !DILocation(line: 17, column: 13, scope: !1289)
!1319 = distinct !{!1319, !1312, !1315, !844}
!1320 = !DILocation(line: 18, column: 10, scope: !1289)
!1321 = !DILocation(line: 18, column: 3, scope: !1289)
