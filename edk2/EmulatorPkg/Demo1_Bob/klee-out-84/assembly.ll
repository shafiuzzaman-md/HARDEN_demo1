...
@.str.16 = private unnamed_addr constant [22 x i8] c"Generated bobkey: %x\0A\00", align 1
...
define hidden i32 @main() #0 !dbg !1338 {
  ...
  %13 = bitcast %struct._DEMO1_ACCESS_KEY* %12 to { i64, i64 }*, !dbg !1353
  %14 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %13, i32 0, i32 0, !dbg !1353
  %15 = load i64, i64* %14, align 8, !dbg !1353
  %16 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %13, i32 0, i32 1, !dbg !1353
  %17 = load i64, i64* %16, align 8, !dbg !1353
  %18 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str.16, i64 0, i64 0), i64 %15, i64 %17), !dbg !1353
  ...
  %21 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([37 x i8], [37 x i8]* @.str.17, i64 0, i64 0), i8* noundef %20), !dbg !1356
...
!3 = !DIFile(filename: "Demo1_Bob.c", directory: "/home/hira/Research/HARDEN/repositories/HARDEN_demo1/edk2/EmulatorPkg/Demo1_Bob", checksumkind: CSK_MD5, checksum: "454edc84be091c41e822ff4761418883")
!4 = !{!5, !13, !20, !38, !43, !46}
...
!1352 = !DILocation(line: 404, column: 37, scope: !1338)
!1353 = !DILocation(line: 404, column: 3, scope: !1338)
!1354 = !DILocation(line: 405, column: 59, scope: !1338)
!1355 = !DILocation(line: 405, column: 51, scope: !1338)
