...
@.str.13 = private unnamed_addr constant [10 x i8] c"bobskey: \00", align 1
...
define hidden i32 @main() #0 !dbg !1265 {
  ...
  br i1 %12, label %13, label %21, !dbg !1282

13:                                               ; preds = %0
  %14 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %4, align 8, !dbg !1283
  %15 = bitcast %struct._DEMO1_ACCESS_KEY* %14 to { i64, i64 }*, !dbg !1285
  %16 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %15, i32 0, i32 0, !dbg !1285
  %17 = load i64, i64* %16, align 8, !dbg !1285
  %18 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %15, i32 0, i32 1, !dbg !1285
  %19 = load i64, i64* %18, align 8, !dbg !1285
  call void (i8*, ...) @klee_print_expr(i8* noundef getelementptr inbounds ([10 x i8], [10 x i8]* @.str.13, i64 0, i64 0), i64 %17, i64 %19), !dbg !1285
  %20 = call i32 (i8*, i8*, i32, i8*, ...) bitcast (i32 (...)* @__assert_fail to i32 (i8*, i8*, i32, i8*, ...)*)(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str.14, i64 0, i64 0), i8* noundef getelementptr inbounds ([12 x i8], [12 x i8]* @.str.15, i64 0, i64 0), i32 noundef 379, i8* noundef getelementptr inbounds ([11 x i8], [11 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)), !dbg !1286
  br label %21, !dbg !1287
...
!3 = !DIFile(filename: "Demo1_Bob.c", directory: "/home/hira/Research/HARDEN/repositories/HARDEN_demo1/edk2/EmulatorPkg/Demo1_Bob", checksumkind: CSK_MD5, checksum: "cc46954c5a4a4fd3f8583a9181c2f310")
!4 = !{!5, !13, !20, !38, !43, !46}
...
!1283 = !DILocation(line: 376, column: 37, scope: !1284)
!1284 = distinct !DILexicalBlock(scope: !1278, file: !3, line: 375, column: 89)
!1285 = !DILocation(line: 376, column: 7, scope: !1284)
!1286 = !DILocation(line: 379, column: 7, scope: !1284)
!1287 = !DILocation(line: 380, column: 5, scope: !1284)
!1288 = !DILocation(line: 383, column: 3, scope: !1265)
