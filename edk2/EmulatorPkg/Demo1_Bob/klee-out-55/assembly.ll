...
define hidden i32 @main() #0 !dbg !1265 {
  ...
  br i1 %12, label %13, label %16, !dbg !1282

13:                                               ; preds = %0
  %14 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %4, align 8, !dbg !1283
  call void (i8*, ...) @klee_print_expr(i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str.13, i64 0, i64 0), %struct._DEMO1_ACCESS_KEY* noundef %14), !dbg !1285
  %15 = call i32 (i8*, i8*, i32, i8*, ...) bitcast (i32 (...)* @__assert_fail to i32 (i8*, i8*, i32, i8*, ...)*)(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str.14, i64 0, i64 0), i8* noundef getelementptr inbounds ([12 x i8], [12 x i8]* @.str.15, i64 0, i64 0), i32 noundef 379, i8* noundef getelementptr inbounds ([11 x i8], [11 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)), !dbg !1286
...
!3 = !DIFile(filename: "Demo1_Bob.c", directory: "/home/hira/Research/HARDEN/repositories/HARDEN_demo1/edk2/EmulatorPkg/Demo1_Bob", checksumkind: CSK_MD5, checksum: "4eed5f03c6b847d183b17461be9b5735")
!4 = !{!5, !13, !20, !38, !43, !46}
...
!1283 = !DILocation(line: 376, column: 34, scope: !1284)
