...
define hidden void @read_bobkey_addr_through_Demo1BobDataProvider() #0 !dbg !1320 {
  ...
  %10 = add i64 %9, 100, !dbg !1338
  %11 = call i64 @Demo1BobDataProvider(%struct._Demo1_Bob_PROTOCOL* noundef null, i8* noundef %7, i8** noundef %8, i64 noundef %10), !dbg !1339
  %12 = icmp eq i64 %11, 0, !dbg !1340
  br i1 %12, label %13, label %16, !dbg !1341

13:                                               ; preds = %0
  %14 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %1, align 8, !dbg !1342
  %15 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([10 x i8], [10 x i8]* @.str.16, i64 0, i64 0), %struct._DEMO1_ACCESS_KEY* noundef %14), !dbg !1344
...
!3 = !DIFile(filename: "Demo1_Bob.c", directory: "/home/hira/Research/HARDEN/repositories/HARDEN_demo1/edk2/EmulatorPkg/Demo1_Bob", checksumkind: CSK_MD5, checksum: "25511e2b13ea80ca73a66bc26074bf5b")
!4 = !{!5, !13, !20, !38, !43, !46}
...
!1338 = !DILocation(line: 396, column: 68, scope: !1335)
!1339 = !DILocation(line: 396, column: 8, scope: !1335)
!1340 = !DILocation(line: 396, column: 74, scope: !1335)
!1341 = !DILocation(line: 396, column: 8, scope: !1320)
!1342 = !DILocation(line: 399, column: 29, scope: !1343)
!1343 = distinct !DILexicalBlock(scope: !1335, file: !3, line: 396, column: 89)
!1344 = !DILocation(line: 399, column: 8, scope: !1343)
!1345 = !DILocation(line: 402, column: 5, scope: !1343)
!1346 = !DILocation(line: 403, column: 1, scope: !1320)
!1347 = distinct !DISubprogram(name: "main", scope: !3, file: !3, line: 405, type: !1348, scopeLine: 406, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !714)
...
!1383 = !DILocalVariable(name: "len", arg: 3, scope: !1375, file: !1376, line: 12, type: !1284)
!1384 = !DILocation(line: 12, column: 58, scope: !1375)
!1385 = !DILocalVariable(name: "dest", scope: !1375, file: !1376, line: 13, type: !1386)
!1386 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1330, size: 64)
...
!1391 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1330)
