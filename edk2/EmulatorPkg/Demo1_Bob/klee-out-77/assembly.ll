...
@.str.13 = private unnamed_addr constant [25 x i8] c"*data != (VOID *)&bobKey\00", align 1
...
define hidden void @read_bobkey_addr_through_Demo1BobDataProvider() #0 !dbg !1311 {
  ...
  %6 = inttoptr i64 %5 to i8*, !dbg !1327
  %7 = load i64, i64* %2, align 8, !dbg !1328
  %8 = call i64 @Demo1BobDataProvider(%struct._Demo1_Bob_PROTOCOL* noundef null, i8* noundef %6, i8** noundef %3, i64 noundef %7), !dbg !1329
  %9 = icmp ne i64 %8, 0, !dbg !1330
  br i1 %9, label %10, label %20, !dbg !1331

10:                                               ; preds = %0
  %11 = load i8*, i8** %3, align 8, !dbg !1332
  %12 = load i8, i8* %11, align 1, !dbg !1332
  %13 = sext i8 %12 to i64, !dbg !1332
  %14 = inttoptr i64 %13 to i8*, !dbg !1332
  %15 = icmp ne i8* %14, bitcast (%struct._DEMO1_ACCESS_KEY* @bobKey to i8*), !dbg !1332
  br i1 %15, label %16, label %17, !dbg !1332

16:                                               ; preds = %10
  br label %19, !dbg !1332

17:                                               ; preds = %10
  %18 = call i32 (i8*, i8*, i32, i8*, ...) bitcast (i32 (...)* @__assert_fail to i32 (i8*, i8*, i32, i8*, ...)*)(i8* noundef getelementptr inbounds ([25 x i8], [25 x i8]* @.str.13, i64 0, i64 0), i8* noundef getelementptr inbounds ([12 x i8], [12 x i8]* @.str.14, i64 0, i64 0), i32 noundef 390, i8* noundef getelementptr inbounds ([53 x i8], [53 x i8]* @__PRETTY_FUNCTION__.read_bobkey_addr_through_Demo1BobDataProvider, i64 0, i64 0)), !dbg !1332
  br label %19, !dbg !1332
...
; Function Attrs: noinline nounwind optnone uwtable
define hidden i32 @main() #0 !dbg !1336 {
  %1 = alloca i32, align 4
  store i32 0, i32* %1, align 4
  call void @read_bobkey_addr_through_Demo1BobDataProvider(), !dbg !1339
  ret i32 0, !dbg !1340
}

; Function Attrs: noinline nounwind uwtable
define dso_local i8* @memcpy(i8* noundef %0, i8* noundef %1, i64 noundef %2) #5 !dbg !1341 {
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
  %6 = alloca i64, align 8
  %7 = alloca i8*, align 8
  ...
  store i8* %1, i8** %5, align 8
  call void @llvm.dbg.declare(metadata i8** %5, metadata !1347, metadata !DIExpression()), !dbg !1348
  store i64 %2, i64* %6, align 8
  call void @llvm.dbg.declare(metadata i64* %6, metadata !1349, metadata !DIExpression()), !dbg !1350
  call void @llvm.dbg.declare(metadata i8** %7, metadata !1351, metadata !DIExpression()), !dbg !1353
...
!3 = !DIFile(filename: "Demo1_Bob.c", directory: "/home/hira/Research/HARDEN/repositories/HARDEN_demo1/edk2/EmulatorPkg/Demo1_Bob", checksumkind: CSK_MD5, checksum: "cdc25fc8dc7689ccef91bef89933cc9d")
!4 = !{!5, !13, !20, !38, !43, !46}
...
!1325 = !DILocation(line: 389, column: 43, scope: !1326)
!1326 = distinct !DILexicalBlock(scope: !1311, file: !3, line: 389, column: 8)
!1327 = !DILocation(line: 389, column: 35, scope: !1326)
!1328 = !DILocation(line: 389, column: 68, scope: !1326)
!1329 = !DILocation(line: 389, column: 8, scope: !1326)
!1330 = !DILocation(line: 389, column: 74, scope: !1326)
!1331 = !DILocation(line: 389, column: 8, scope: !1311)
!1332 = !DILocation(line: 390, column: 7, scope: !1333)
!1333 = distinct !DILexicalBlock(scope: !1326, file: !3, line: 389, column: 89)
!1334 = !DILocation(line: 391, column: 5, scope: !1333)
!1335 = !DILocation(line: 392, column: 1, scope: !1311)
!1336 = distinct !DISubprogram(name: "main", scope: !3, file: !3, line: 394, type: !1337, scopeLine: 395, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !714)
!1337 = !DISubroutineType(types: !1338)
!1338 = !{!196}
!1339 = !DILocation(line: 396, column: 3, scope: !1336)
!1340 = !DILocation(line: 397, column: 3, scope: !1336)
!1341 = distinct !DISubprogram(name: "memcpy", scope: !1342, file: !1342, line: 12, type: !1343, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !703, retainedNodes: !714)
!1342 = !DIFile(filename: "klee/runtime/Freestanding/memcpy.c", directory: "/home/hira/Research", checksumkind: CSK_MD5, checksum: "8fb9a7164e167db005d7d002570068bc")
!1343 = !DISubroutineType(types: !1344)
!1344 = !{!52, !52, !605, !1275}
!1345 = !DILocalVariable(name: "destaddr", arg: 1, scope: !1341, file: !1342, line: 12, type: !52)
!1346 = !DILocation(line: 12, column: 20, scope: !1341)
!1347 = !DILocalVariable(name: "srcaddr", arg: 2, scope: !1341, file: !1342, line: 12, type: !605)
!1348 = !DILocation(line: 12, column: 42, scope: !1341)
!1349 = !DILocalVariable(name: "len", arg: 3, scope: !1341, file: !1342, line: 12, type: !1275)
!1350 = !DILocation(line: 12, column: 58, scope: !1341)
!1351 = !DILocalVariable(name: "dest", scope: !1341, file: !1342, line: 13, type: !1352)
!1352 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1323, size: 64)
!1353 = !DILocation(line: 13, column: 9, scope: !1341)
!1354 = !DILocation(line: 13, column: 16, scope: !1341)
!1355 = !DILocalVariable(name: "src", scope: !1341, file: !1342, line: 14, type: !1356)
!1356 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1357, size: 64)
!1357 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1323)
!1358 = !DILocation(line: 14, column: 15, scope: !1341)
!1359 = !DILocation(line: 14, column: 21, scope: !1341)
!1360 = !DILocation(line: 16, column: 3, scope: !1341)
!1361 = !DILocation(line: 16, column: 13, scope: !1341)
!1362 = !DILocation(line: 16, column: 16, scope: !1341)
!1363 = !DILocation(line: 17, column: 19, scope: !1341)
!1364 = !DILocation(line: 17, column: 15, scope: !1341)
!1365 = !DILocation(line: 17, column: 10, scope: !1341)
!1366 = !DILocation(line: 17, column: 13, scope: !1341)
!1367 = distinct !{!1367, !1360, !1363, !851}
!1368 = !DILocation(line: 18, column: 10, scope: !1341)
!1369 = !DILocation(line: 18, column: 3, scope: !1341)
