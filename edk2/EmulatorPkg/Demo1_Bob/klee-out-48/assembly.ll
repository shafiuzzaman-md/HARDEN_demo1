...
@.str.13 = private unnamed_addr constant [7 x i8] c"bobKey\00", align 1
...
define hidden i32 @main() #0 !dbg !1265 {
  ...
  %6 = call i8* @malloc(i64 noundef 16), !dbg !1274
  %7 = bitcast i8* %6 to %struct._DEMO1_ACCESS_KEY*, !dbg !1274
  store %struct._DEMO1_ACCESS_KEY* %7, %struct._DEMO1_ACCESS_KEY** %4, align 8, !dbg !1273
  %8 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %4, align 8, !dbg !1275
  %9 = bitcast %struct._DEMO1_ACCESS_KEY* %8 to i8*, !dbg !1275
  call void @klee_make_symbolic(i8* noundef %9, i64 noundef 16, i8* noundef getelementptr inbounds ([5 x i8], [5 x i8]* @.str.12, i64 0, i64 0)), !dbg !1276
  call void @llvm.dbg.declare(metadata %struct._DEMO1_ACCESS_KEY** %5, metadata !1277, metadata !DIExpression()), !dbg !1278
  %10 = call i8* @malloc(i64 noundef 16), !dbg !1279
  %11 = bitcast i8* %10 to %struct._DEMO1_ACCESS_KEY*, !dbg !1279
  store %struct._DEMO1_ACCESS_KEY* %11, %struct._DEMO1_ACCESS_KEY** %5, align 8, !dbg !1278
  %12 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %5, align 8, !dbg !1280
  %13 = bitcast %struct._DEMO1_ACCESS_KEY* %12 to i8*, !dbg !1280
  call void @klee_make_symbolic(i8* noundef %13, i64 noundef 16, i8* noundef getelementptr inbounds ([7 x i8], [7 x i8]* @.str.13, i64 0, i64 0)), !dbg !1281
  %14 = bitcast %struct._DEMO1_ACCESS_KEY** %5 to i8*, !dbg !1282
  %15 = bitcast %struct._DEMO1_ACCESS_KEY** %4 to i8**, !dbg !1284
  %16 = load i64, i64* %3, align 8, !dbg !1285
  %17 = call i64 @Demo1BobDataProvider(%struct._Demo1_Bob_PROTOCOL* noundef null, i8* noundef %14, i8** noundef %15, i64 noundef %16), !dbg !1286
  %18 = icmp eq i64 %17, 0, !dbg !1287
  br i1 %18, label %19, label %24, !dbg !1288

19:                                               ; preds = %0
  %20 = load %struct._DEMO1_ACCESS_KEY*, %struct._DEMO1_ACCESS_KEY** %4, align 8, !dbg !1289
  %21 = getelementptr inbounds %struct._DEMO1_ACCESS_KEY, %struct._DEMO1_ACCESS_KEY* %20, i32 0, i32 0, !dbg !1291
  %22 = getelementptr inbounds [2 x i64], [2 x i64]* %21, i64 0, i64 1, !dbg !1289
  store i64 -2395670108176482799, i64* %22, align 8, !dbg !1292
  %23 = call i32 (i8*, i8*, i32, i8*, ...) bitcast (i32 (...)* @__assert_fail to i32 (i8*, i8*, i32, i8*, ...)*)(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str.14, i64 0, i64 0), i8* noundef getelementptr inbounds ([12 x i8], [12 x i8]* @.str.15, i64 0, i64 0), i32 noundef 379, i8* noundef getelementptr inbounds ([11 x i8], [11 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)), !dbg !1293
...
define dso_local i8* @memcpy(i8* noundef %0, i8* noundef %1, i64 noundef %2) #5 !dbg !1296 {
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
  %6 = alloca i64, align 8
  %7 = alloca i8*, align 8
  ...
  call void @llvm.dbg.declare(metadata i8** %5, metadata !1305, metadata !DIExpression()), !dbg !1306
  store i64 %2, i64* %6, align 8
  call void @llvm.dbg.declare(metadata i64* %6, metadata !1307, metadata !DIExpression()), !dbg !1308
  call void @llvm.dbg.declare(metadata i8** %7, metadata !1309, metadata !DIExpression()), !dbg !1312
  %9 = load i8*, i8** %4, align 8, !dbg !1313
  store i8* %9, i8** %7, align 8, !dbg !1312
  call void @llvm.dbg.declare(metadata i8** %8, metadata !1314, metadata !DIExpression()), !dbg !1317
  %10 = load i8*, i8** %5, align 8, !dbg !1318
  store i8* %10, i8** %8, align 8, !dbg !1317
  br label %11, !dbg !1319

11:                                               ; preds = %15, %3
  %12 = load i64, i64* %6, align 8, !dbg !1320
  %13 = add i64 %12, -1, !dbg !1320
  store i64 %13, i64* %6, align 8, !dbg !1320
  %14 = icmp ugt i64 %12, 0, !dbg !1321
  br i1 %14, label %15, label %21, !dbg !1319

15:                                               ; preds = %11
  %16 = load i8*, i8** %8, align 8, !dbg !1322
  %17 = getelementptr inbounds i8, i8* %16, i32 1, !dbg !1322
  store i8* %17, i8** %8, align 8, !dbg !1322
  %18 = load i8, i8* %16, align 1, !dbg !1323
  %19 = load i8*, i8** %7, align 8, !dbg !1324
  %20 = getelementptr inbounds i8, i8* %19, i32 1, !dbg !1324
  store i8* %20, i8** %7, align 8, !dbg !1324
  store i8 %18, i8* %19, align 1, !dbg !1325
  br label %11, !dbg !1319, !llvm.loop !1326

21:                                               ; preds = %11
  %22 = load i8*, i8** %4, align 8, !dbg !1327
  ret i8* %22, !dbg !1328
}
...
!3 = !DIFile(filename: "Demo1_Bob.c", directory: "/home/hira/Research/HARDEN/repositories/HARDEN_demo1/edk2/EmulatorPkg/Demo1_Bob", checksumkind: CSK_MD5, checksum: "ff4864ef4cb034bae73a050b58c6a21b")
!4 = !{!5, !13, !20, !38, !43, !46}
...
!1277 = !DILocalVariable(name: "bobKey", scope: !1265, file: !3, line: 374, type: !303)
!1278 = !DILocation(line: 374, column: 23, scope: !1265)
!1279 = !DILocation(line: 374, column: 31, scope: !1265)
!1280 = !DILocation(line: 375, column: 24, scope: !1265)
!1281 = !DILocation(line: 375, column: 5, scope: !1265)
!1282 = !DILocation(line: 377, column: 35, scope: !1283)
!1283 = distinct !DILexicalBlock(scope: !1265, file: !3, line: 377, column: 8)
!1284 = !DILocation(line: 377, column: 52, scope: !1283)
!1285 = !DILocation(line: 377, column: 68, scope: !1283)
!1286 = !DILocation(line: 377, column: 8, scope: !1283)
!1287 = !DILocation(line: 377, column: 74, scope: !1283)
!1288 = !DILocation(line: 377, column: 8, scope: !1265)
!1289 = !DILocation(line: 378, column: 7, scope: !1290)
!1290 = distinct !DILexicalBlock(scope: !1283, file: !3, line: 377, column: 89)
!1291 = !DILocation(line: 378, column: 13, scope: !1290)
!1292 = !DILocation(line: 378, column: 33, scope: !1290)
!1293 = !DILocation(line: 379, column: 7, scope: !1290)
!1294 = !DILocation(line: 380, column: 5, scope: !1290)
!1295 = !DILocation(line: 383, column: 3, scope: !1265)
!1296 = distinct !DISubprogram(name: "memcpy", scope: !1297, file: !1297, line: 12, type: !1298, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !696, retainedNodes: !707)
!1297 = !DIFile(filename: "klee/runtime/Freestanding/memcpy.c", directory: "/home/hira/Research", checksumkind: CSK_MD5, checksum: "8fb9a7164e167db005d7d002570068bc")
!1298 = !DISubroutineType(types: !1299)
!1299 = !{!52, !52, !598, !1300}
!1300 = !DIDerivedType(tag: DW_TAG_typedef, name: "size_t", file: !1301, line: 46, baseType: !1302)
!1301 = !DIFile(filename: "/usr/lib/llvm-14/lib/clang/14.0.6/include/stddef.h", directory: "", checksumkind: CSK_MD5, checksum: "2499dd2361b915724b073282bea3a7bc")
!1302 = !DIBasicType(name: "unsigned long", size: 64, encoding: DW_ATE_unsigned)
!1303 = !DILocalVariable(name: "destaddr", arg: 1, scope: !1296, file: !1297, line: 12, type: !52)
!1304 = !DILocation(line: 12, column: 20, scope: !1296)
!1305 = !DILocalVariable(name: "srcaddr", arg: 2, scope: !1296, file: !1297, line: 12, type: !598)
!1306 = !DILocation(line: 12, column: 42, scope: !1296)
!1307 = !DILocalVariable(name: "len", arg: 3, scope: !1296, file: !1297, line: 12, type: !1300)
!1308 = !DILocation(line: 12, column: 58, scope: !1296)
!1309 = !DILocalVariable(name: "dest", scope: !1296, file: !1297, line: 13, type: !1310)
!1310 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1311, size: 64)
!1311 = !DIBasicType(name: "char", size: 8, encoding: DW_ATE_signed_char)
!1312 = !DILocation(line: 13, column: 9, scope: !1296)
!1313 = !DILocation(line: 13, column: 16, scope: !1296)
!1314 = !DILocalVariable(name: "src", scope: !1296, file: !1297, line: 14, type: !1315)
!1315 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1316, size: 64)
!1316 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1311)
!1317 = !DILocation(line: 14, column: 15, scope: !1296)
!1318 = !DILocation(line: 14, column: 21, scope: !1296)
!1319 = !DILocation(line: 16, column: 3, scope: !1296)
!1320 = !DILocation(line: 16, column: 13, scope: !1296)
!1321 = !DILocation(line: 16, column: 16, scope: !1296)
!1322 = !DILocation(line: 17, column: 19, scope: !1296)
!1323 = !DILocation(line: 17, column: 15, scope: !1296)
!1324 = !DILocation(line: 17, column: 10, scope: !1296)
!1325 = !DILocation(line: 17, column: 13, scope: !1296)
!1326 = distinct !{!1326, !1319, !1322, !844}
!1327 = !DILocation(line: 18, column: 10, scope: !1296)
!1328 = !DILocation(line: 18, column: 3, scope: !1296)
